...
export default function ExplorerMainSection() {
    const { draftExploreState, submittedExploreState, exploreData, loading, handleUpdateGraph, hasPendingChanges } = useExplorerContext();
        ...
        <Flex direction="column" px="2" py="3" gap="3">
            <Flex justify="between" align="center">
                <Flex align="center" gap="3">
                    ...
                    <Flex align="center" gap="1" display={submittedExploreState?.dataset?.values.length === 0 ? "none" : undefined} >
