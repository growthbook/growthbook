...
describe("backend", () => {
  ...
  it("checks power", () => {
    ...
    const powerSolution = [
      0.65596, 0.0541, 0.91614, 0.05821, 0.98342, 0.06235, 0.99713, 0.0665,
      0.99955, 0.07067, 0.99993, 0.07486, 0.99999, 0.07906, 1.0, 0.08328, 1.0,
      0.08752,
    ];
    const mdeSolution = [
  ...
  it("checks sequential power", () => {
    ...
    const powerSolution = [
      0.32738, 0.05168, 0.57751, 0.05341, 0.74687, 0.05506, 0.85299, 0.05666,
      0.91653, 0.05822, 0.95341, 0.05976, 0.97435, 0.06127, 0.98603, 0.06277,
      0.99247, 0.06424,
    ];
    const mdeSolution = [
