...
import { PiArrowsDownUp, PiPencilSimpleFill, PiGitDiff } from "react-icons/pi";
    ...
    <>
          ...
          return (
            ...
            >
              <RevisionDetail<SavedGroupInterface>
                ...
                allRevisions={allRevisions}
                canReview={permissionsUtil.canUpdateSavedGroup(savedGroup, {})}
      ...
      <div className="container-fluid pagecontents">
        ...
        <RevisionStatusPanel
          ...
          fallbackAuthorId={savedGroup.owner}
          fallbackCreatedDate={savedGroup.dateCreated}
          selectFlow={selectFlow}
