...
import { GBCircleArrowLeft, GBCuped, GBSequential } from "@/components/Icons";
...
const ProjectPage: FC = () => {
  ...
  const form = useForm<ProjectSettings>({
    defaultValues: {
      ...
      maxPercentageChange: settings?.maxPercentageChange,
      minPercentageChange: settings?.minPercentageChange,
    }
  });
    ...
    if (settings) {
      ...
      Object.keys(newVal).forEach((k) => {
        ...
        if (k === "metrics" && hasExistingMetrics) {
          newVal = {
            ...newVal,
            maxPercentageChange: newVal.maxPercentageChange * 100,
            minPercentageChange: newVal.minPercentageChange * 100,
          };
        }
          ...
          <div className="col-sm-9">
            <>
              ...
              <p>
                ...
                when configuring metrics. You can always change these values on
                a per-metric basis.
              </p>
              ...
              <div>
                <div className="form-inline">
                  <Field
                    ...
                    containerClassName="mt-2"
                    disabled={hasFileConfig()}
                    {...form.register("metrics.maxPercentageChange", {
                      valueAsNumber: true,
                    })}
                  />
                </div>
              ...
              <div>
                <div className="form-inline">
                  <Field
                    ...
                    containerClassName="mt-2"
                    disabled={hasFileConfig()}
                    {...form.register("metrics.minPercentageChange", {
                      valueAsNumber: true,
                    })}
                  />
                </div>
