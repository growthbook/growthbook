                  ...
                  {Math.ceil(byStatus.running.length / experimentsPerPage) >
                    ...
                    <div className="pagination-area">
                      <ReactPaginate
                        ...
                        pageCount={Math.ceil(
                          byStatus.running.length / experimentsPerPage
                        )}
                        marginPagesDisplayed={2}
                        pageRangeDisplayed={5}
                        initialPage={currentPage.draft - 1}
                        onPageChange={(d) => {
                          const tmp = { ...currentPage };
                          tmp.running = parseInt(d.selected) + 1;
                          setCurrentPage(tmp);
                        }}
                        containerClassName={
                  ...
                  <table className="table experiment-table appbox">
                    ...
                    <tbody>
                      {byStatus.draft
                        ...
                        .filter((e, i) => {
                          if (
                            i >= (currentPage.draft - 1) * experimentsPerPage &&
                  ...
                  {Math.ceil(byStatus.draft.length / experimentsPerPage) >
                    ...
                    <div className="pagination-area">
                      <ReactPaginate
                        ...
                        breakClassName={"break-me"}
                        pageCount={Math.ceil(
                          byStatus.draft.length / experimentsPerPage
                        )}
                        marginPagesDisplayed={2}
                        pageRangeDisplayed={5}
                        initialPage={currentPage.draft - 1}
                        onPageChange={(d) => {
                          const tmp = { ...currentPage };
                          tmp.draft = parseInt(d.selected) + 1;
                          setCurrentPage(tmp);
                        }}
                        containerClassName={
                          "pagination justify-content-center mb-0"
                  ...
                  {Math.ceil(byStatus.stopped.length / experimentsPerPage) >
                    ...
                    <div className="pagination-area">
                      <ReactPaginate
                        ...
                        breakClassName={"break-me"}
                        pageCount={Math.ceil(
                          byStatus.stopped.length / experimentsPerPage
                        )}
                        marginPagesDisplayed={2}
                        pageRangeDisplayed={5}
                        initialPage={currentPage.stopped - 1}
                        onPageChange={(d) => {
                          const tmp = { ...currentPage };
                          tmp.stopped = parseInt(d.selected) + 1;
                          setCurrentPage(tmp);
                        }}
                        containerClassName={
                          "pagination justify-content-center mb-0"
                  ...
                  {Math.ceil(byStatus.archived.length / experimentsPerPage) >
                    ...
                    <div className="pagination-area">
                      <ReactPaginate
                        ...
                        breakClassName={"break-me"}
                        pageCount={Math.ceil(
                          byStatus.archived.length / experimentsPerPage
                        )}
                        marginPagesDisplayed={2}
                        pageRangeDisplayed={5}
                        initialPage={currentPage.archived - 1}
                        onPageChange={(d) => {
                          const tmp = { ...currentPage };
                          tmp.archived = parseInt(d.selected) + 1;
                          setCurrentPage(tmp);
                        }}
                        containerClassName={
                          "pagination justify-content-center mb-0"
