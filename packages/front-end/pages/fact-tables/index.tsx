...
export default function FactTablesPage() {
  ...
  const dataSourcesThatSupportAutoFactTables = datasources.filter(
    (ds) => ds.properties?.supportsAutoGeneratedFactTables
  );
    ...
    <div className="pagecontents container-fluid">
      ...
      {discoverFactOpen && (
        <AutoGenerateFactTableModal
          ...
          supportedDatasources={dataSourcesThatSupportAutoFactTables}
        />
      )}
          ...
          <Tooltip
            body={
              !canCreate
                ...
                : !dataSourcesThatSupportAutoFactTables.length
                ? "Generating Fact Tables automatically is only available for GA4, Segment, Amplitude, and Rudderstack Data Sources"
                : ""
            }
          >
            <button
