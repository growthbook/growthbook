...
export function GBLibrary({ className = "" }): React.ReactElement {
  return (
    <svg
      id="uuid-63985eca-a43d-421d-85af-0974871c2304"
      data-name="˜àð_1"
      xmlns="http://www.w3.org/2000/svg"
    ...
    >
      <rect
        className="uuid-441a5531-fa22-46ec-899b-191347fc1726"
        width="1200"
        height="1200"
        fill="none"
      />
      <g>
        <path
          className="uuid-ab7539ad-f913-4984-91ec-5c9b347a557a"
          d="m257.35,863.9c-3.9,0-7.77-1.15-11.1-3.4-5.48-3.7-8.74-9.85-8.74-16.46v-403.93c0-8.11,4.85-15.32,12.35-18.38,21.44-8.74,42.34-16.6,62.11-23.35l8.08,23.66c-18.33,6.26-37.67,13.5-57.54,21.54v392.88c95.86-37.92,174.92-55.47,235.08-52.15,45.8,2.52,73.5,16.84,89.92,31.07v-379.19c0,.52.08,1.03.23,1.52l23.87-7.43c.6,1.92.9,3.91.9,5.91v391.53c0,8.34-5.04,15.63-12.84,18.56-7.84,2.95-16.48.77-22.01-5.55-11.33-12.94-34.65-28.9-81.44-31.47-57.95-3.19-135.82,14.71-231.45,53.2-2.39.96-4.91,1.44-7.41,1.44Z"
          fill="currentColor"
        />
        <path
          className="uuid-ab7539ad-f913-4984-91ec-5c9b347a557a"
          d="m942.65,863.9c-2.5,0-5.02-.47-7.41-1.44-95.63-38.49-173.51-56.39-231.45-53.2-46.8,2.58-70.12,18.54-81.44,31.47-5.53,6.32-14.17,8.49-22.01,5.55-7.8-2.93-12.84-10.22-12.84-18.56v-391.53c0-2,.3-3.99.9-5.91l23.87,7.43c.15-.49.23-1,.23-1.52v379.19c16.42-14.23,44.12-28.55,89.92-31.07,60.15-3.32,139.22,14.23,235.08,52.15v-392.88c-19.87-8.04-39.21-15.28-57.54-21.54l8.08-23.66c19.77,6.75,40.67,14.61,62.11,23.35,7.5,3.06,12.35,10.27,12.35,18.38v403.93c0,6.61-3.27,12.76-8.75,16.46-3.33,2.25-7.2,3.4-11.1,3.4Z"
          fill="currentColor"
        />
        <path
          className="uuid-ab7539ad-f913-4984-91ec-5c9b347a557a"
          d="m590.83,832.36c-6.41,0-12.6-2.69-16.79-7.62-31.75-37.41-105.88-95.45-245.66-63.9-6.08,1.37-12.35-.07-17.22-3.97-4.87-3.89-7.66-9.7-7.66-15.93v-374.52c0-9.52,6.48-17.69,15.75-19.87,45.23-10.6,87.91-13.15,126.83-7.57,32.11,4.61,61.86,14.74,88.42,30.12,46.29,26.81,69.23,61.51,75.15,71.51,1.86,3.13,2.84,6.73,2.84,10.39v360.93c0,8.49-5.39,15.95-13.74,19.02-2.59.95-5.28,1.41-7.93,1.41Zm-186.22-105.55c35.38,0,68.31,5.96,98.48,17.86,39.8,15.7,67.24,38.9,84.4,57.55v-349.93c-5.05-8.2-25.46-38.34-65.52-61.54-53.03-30.71-118.11-37.66-193.48-20.66v365.14c26.45-5.61,51.86-8.41,76.12-8.41Z"
          fill="currentColor"
        />
        <path
          className="uuid-ab7539ad-f913-4984-91ec-5c9b347a557a"
          d="m609.17,832.36c-2.65,0-5.33-.46-7.93-1.41-8.34-3.06-13.74-10.53-13.74-19.02v-360.93c0-3.66.98-7.25,2.84-10.38,5.93-10,28.86-44.7,75.15-71.51,26.56-15.38,56.31-25.52,88.42-30.12,38.93-5.58,81.6-3.04,126.83,7.57,9.28,2.17,15.75,10.34,15.75,19.87v374.52c0,6.23-2.79,12.04-7.66,15.93-4.87,3.89-11.14,5.34-17.22,3.97-139.78-31.55-213.92,26.49-245.66,63.9-4.19,4.93-10.38,7.62-16.79,7.62Zm3.33-380.07v349.93c17.16-18.65,44.6-41.85,84.4-57.55,50.85-20.06,109.57-23.24,174.6-9.45v-365.14c-75.36-17-140.44-10.05-193.48,20.66-40.06,23.2-60.48,53.34-65.52,61.54Z"
          fill="currentColor"
        />
      </g>
    </svg>
