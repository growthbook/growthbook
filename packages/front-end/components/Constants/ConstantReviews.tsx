...
import { buildConstantRevisionUrl } from "@/components/Revision/revisionUtils";
...
const ConstantReviews: FC = () => {
  ...
  const {
    ...
    items: reviewItems,
    localStorageKey: "constantReviewsList",
    defaultSortField: "dateUpdated",
    defaultSortDir: -1,
    searchFields: ["constantName", "authorId", "title", "authorDisplay"],
    searchTermFilters: {
  ...
  return (
    <Box mt="4">
      ...
      {isLoading ? (
        ...
        <Callout status="info">No drafts for constants.</Callout>
      ) : (
        <>
          <Table variant="list" stickyHeader roundedCorners>
            <TableHeader>
              <TableRow>
                <SortableTableColumnHeader field="constantName">
                  Constant
                </SortableTableColumnHeader>
                <TableColumnHeader
...
export default ConstantReviews;
