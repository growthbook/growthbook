...
export default function AutoGenerateMetricsModal({
  ...
  const form = useForm<{
    ...
    metricsToCreate: AutoMetricTrackedEvent[];
  }>({
    defaultValues: {
  ...
  const metricsToCreate = form.watch("metricsToCreate");
  ...
  const submit = form.handleSubmit(async (data) => {
    ...
    data.metricsToCreate.forEach((metricToCreate) => {
    ...
    async (datasourceObj: DataSourceInterfaceWithParams | undefined) => {
      ...
      try {
        ...
        const res = await apiCall<{
          autoMetricsToCreate: AutoMetricTrackedEvent[];
          message?: string;
        ...
        form.setValue("metricsToCreate", res.autoMetricsToCreate);
      } catch (e) {
        track("Generate Auto Metrics Error", {
          error: e.message,
          source,
        ...
        {metricsToCreate.length > 0 ? (
          <div>
            ...
            <div className="d-flex justify-content-end">
              <Button
                ...
                onClick={async () => {
                  ...
                  form.setValue("metricsToCreate", updates);
                }}
              >
                Check All
              </Button>
            ...
            <table className="appbox table experiment-table gbtable">
              ...
              <tbody>
                {metricsToCreate.map((event, i) => {
                  return (
                    <AutoMetricCard
                      key={`${event}-${i}`}
                      event={event}
                      form={form}
                      trackedEvents={metricsToCreate}
                      setValue={(value: AutoMetricTrackedEvent[]) =>
                        form.setValue("metricsToCreate", value)
                      }
                      i={i}
                      dataSourceId={selectedDatasource?.id || ""}
                    />
