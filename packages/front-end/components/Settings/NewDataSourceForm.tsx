...
const NewDataSourceForm: FC<{
  ...
  const [metricsToCreate, setMetricsToCreate] = useState<AutoGeneratedMetric[]>(
    []
  );
                      ...
                      <div className="d-flex justify-content-end">
                        <Button
                          ...
                          onClick={async () => {
                            const updatedMetrics = metricsToCreate.map((m) => ({
                              ...m,
                              createBinomialFromEvent: true,
                              createCountFromEvent: true,
                            }));
                            setMetricsToCreate(updatedMetrics);
                          }}
                        >
                          Check All
                        </Button>
                        <Button
                          ...
                          onClick={async () => {
                            const updatedMetrics = metricsToCreate.map((m) => ({
                              ...m,
                              createBinomialFromEvent: false,
                              createCountFromEvent: false,
                            }));
                            setMetricsToCreate(updatedMetrics);
                          }}
                        >
