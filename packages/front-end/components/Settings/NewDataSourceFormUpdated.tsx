...
const NewDataSourceForm: FC<{
  ...
  if (step === 0) {
    stepContents = (
      // What do we want to do here - prime users about what a data source is, and give them an out to either use the sample data or invite a teammate with credentials
      <div>
        ...
        <h4>Choose your event tracker</h4>
        <p>
          Knowing which event tracker your organization uses helps us generate
          the initial SQL queries needed to create metrics and analyze
          experiments.
        </p>
        <EventSourceList
          onSelect={(s) => {
      ...
      // <div>
      //   <h4>How GrowthBook Works</h4>
      //   <p>
      //     GrowthBook is warehouse native, which means we don&apos;t store a copy
      //     of your data and instead connect directly to your data warehouse via
      //     minimal <code>read-only</code> permissions. Once connected, we can
      //     fetch aggregate data to build metrics and analyze experiments, all
      //     while ensuring your user&apos;s Personally Identifiable Information
      ...
      //         }}
      //       >
      //         <h4>Setup A Data Source</h4>
      //         <p className="mb-0 text-dark">
      //           Connect GrowthBook to your data warehouse.
      //         </p>
      //       </a>
      //     </div>
      //     {!importSampleData && (
      ...
      //         <p className="mb-0 text-dark">
      //           If you don't have access to your data warehouse, invite a team
      //           member who does.
      //         </p>
      //       </a>
      //     </div>
    ...
    stepContents = (
      <div>
        ...
        <SelectField
          label="Choose the warehouse where your data is stored"
          // @ts-expect-error TS(2322) If you come across this, please fix it!: Type 'string | undefined' is not assignable to typ... Remove this comment to see the full error message
