...
export default function RevisionLabel({
  ...
  // Follow the surrounding text's colour, e.g. on a dark tooltip.
  inheritNumberColor?: boolean;
}) {
  return (
    <>
      {numbered && (
        ...
        >
          <Text
            as="span"
            color={inheritNumberColor ? undefined : "text-mid"}
            size={numberSize}
          >
            {version}.
          </Text>
