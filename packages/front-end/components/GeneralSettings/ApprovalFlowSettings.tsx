          ...
          <Box className="appbox p-4">
            ...
            {metricSettings.length === 0 && (
              <Text size="2" color="gray" as="p">
                No metric approval settings configured. Click &quot;Add
                Setting&quot; to create one.
              </Text>
            )}
                      ...
                      <Box mt="4">
                        <Box mb="4">
                          ...
                          <Text as="p" size="1" color="gray" className="mb-3">
                            Define which metrics require approval based on their
                            properties
                          </Text>
        ...
        <Box mb="6" width="100%">
          <Box className="appbox p-4">
            ...
            {factTableSettings.length === 0 && (
              <Text size="2" color="gray" as="p">
                No fact table approval settings configured. Click &quot;Add
                Setting&quot; to create one.
              </Text>
            )}
