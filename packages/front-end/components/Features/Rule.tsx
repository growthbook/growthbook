...
export const Rule = forwardRef<HTMLDivElement, Props & {handle?: React.HTMLAttributes<HTMLDivElement>} & React.HTMLAttributes<HTMLDivElement>>(
...
export function SortableRule(props: Props) {
  const {
    attributes,
    listeners,
    setNodeRef,
