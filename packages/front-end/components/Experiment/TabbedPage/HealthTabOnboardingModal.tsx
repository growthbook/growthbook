        ...
        >
          <div className="my-2 ml-3 mr-3">
            <div className="row mb-2">
              Use automatic dimensions to pre-bin dimensions in the most common
              values. These dimensions will then display on your Health Tab for
              traffic and experiment balance checks.{" "}
            </div>
            <div className="row">
              <DimensionSlicesRunner
    ...
    <>
      ...
      >
        <div>
          ...
          experiment to automatically provide data about traffic over time and
