    ...
    <div className="mt-1 overflow-auto">
      ...
      >
        ...
        <tr>
          ...
          <th className="border-0 p-0 text-center" colSpan={variations.length || 0}>
            Actual Units
        ...
        <tr>
          <th className="border-top-0 pt-1" style={{minWidth: 150}}>{dimension}</th>
          {variations.map((v, i) => (
            <th key={i} className={`border-top-0 pt-1 variation with-variation-label variation${i}`}
                style={{minWidth: 150}}>
          ...
          <th className="border-top-0 pt-1" style={{minWidth: 150}}>Actual</th>
          <th className="border-top-0 pt-1" style={{minWidth: 150}}>Expected</th>
          <th className="border-top-0 pt-1" style={{minWidth: 120}}>SRM P-Value</th>
        </tr>
        </thead>
        <tbody>
        {(results || []).map((r, i) => (
