          ...
          {srm >= srmThreshold ? (
            <>
              <div className="alert alert-secondary">
                ...
                in the percentages you see may be due to change and aren’t cause
            ...
            <>
              <div className="alert alert-secondary">
                ...
                experiment is <b>{srm}</b>. This is a strong indicator that your
                traffic is imbalanced and there is a problem with your traffic
                assignment.
              </div>
              <VariationUsersTable
                variations={variations}
