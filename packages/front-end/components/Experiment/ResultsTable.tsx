...
import { CursorTooltipProvider } from "@/hooks/useCursorTooltip";
          ...
          <div className="position-relative">
            <div ref={tableContainerRef} className="experiment-results-wrapper">
              <div className="w-100" style={{ minWidth: 700 }}>
                <table
                  id="main-results"
                  className="experiment-results table-sm"
                >
                  <thead>
                  ...
                  {rows.map((row, i) => {
                    ...
                    const includedLabelColumns = columnsToDisplay.filter(
                      (col) =>
                        [
                          "Metric & Variation Names",
                          "Baseline Average",
                                        ...
                                        className: clsx(
                                          "results-variation-row align-items-center error-row",
                                          {
                                            "last-before-slice-header":
                                              ...
                                              j ===
                                                orderedVariations.length - 1,
                                          },
                                        ),
                                        labelColSpan:
                                          includedLabelColumns.length,
                                        renderLabel:
