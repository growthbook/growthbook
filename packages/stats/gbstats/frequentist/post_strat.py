...
from typing import Union, List, Optional, Literal, Tuple, Sequence
from gbstats.models.tests import sum_stats, EffectMomentsConfig, EffectMomentsResult
import numpy as np
...
class PostStratification:
    def __init__(
        self,
        stats: Sequence[Tuple[TestStatistic, TestStatistic]],
