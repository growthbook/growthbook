...
GrowthBook just needs a couple SQL queries to get started. Writing this SQL is a (mostly) one-time setup task. After building out this library of queries, they can easily be reused across many experiments.
