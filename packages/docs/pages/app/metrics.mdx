...
The number of days the user has to convert after first being put into an experiment (default = `3`). Any conversions that happens after this time will be ignored.  As always there's a tradeoff here.
