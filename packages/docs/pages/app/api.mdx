...
When you first start setting up features in GrowthBook, we create a "production" environment for you with a Publishable API Key. This key provides limited readonly access to your features and is safe to use from any of our SDKs - client-side, server-side, or mobile.

You can add new environments by going to **Features -> Environments**. You can manage your API keys by going to **Settings -> API Keys**.
