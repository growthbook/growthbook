...
When you make changes to a feature's default value or override rules, the changes are not published immediately. This allows you to make multiple changes and then review them all at once before publishing. Ubpublished changes will not be included in API responses nor will they fire webhooks.
