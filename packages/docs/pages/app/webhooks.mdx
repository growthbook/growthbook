...
You can optionally scope your webhook to a specific environment and/or project. If specified, only features which match the scope will trigger the webhook and be included in the payload.
