...
### Encrypting Features list

When creating an API key, you have the option to enable encryption. When enabled, GrowthBook will encrypt the list of features in the API response.
