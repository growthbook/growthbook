...
There are many test cases for the Javascript SDK in [mongrule.test.ts](https://github.com/growthbook/growthbook/blob/main/packages/sdk-js/test/mongrule.test.ts). Make sure your implementation passes all of these.
...
2. Loop through items in `attributeValue`
  1. If `isOperatorValue(condition)`
