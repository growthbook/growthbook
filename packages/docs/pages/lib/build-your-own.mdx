...
Here are a number of important data structures in GrowthBook client libraries, listed alphabetically.
...
2. Loop through the feature rules (if any)
   ...
   3. Otherwise, convert the rule to an Experiment object
      ...
      const exp = {
        ...
        key: rule.trackingKey || featureKey,
      };
