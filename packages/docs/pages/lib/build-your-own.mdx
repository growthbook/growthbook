...
Join our [Slack community](https://join.slack.com/t/growthbookusers/shared_invite/zt-oiq9s1qd-TN6QehOB2y6yyRgfpJ4geg) if you need help or want to chat. We're also happy to hop on a call and do some pair programming.
