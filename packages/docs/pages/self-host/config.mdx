...
# The minimum change required for a result to be considered inconclusive. If the percent
# change for a variation is below this, we hide the result and label it inconclusive.
# Default 0.5 = 50% change
