...
Once these queries are defined, you can use GrowthBook to analyze the results of any experiment data that exists in your
data warehouse. GrowthBook creates a combined query to pull aggregate experiment information from your data source.
