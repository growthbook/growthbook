# A/B Testing with Rudderstack and NextJS

This document is a guide on how to add GrowthBook feature flags and A/B testing to your existing NextJS application using Rudderstack for event tracking.
...
## 2. Integrate Rudderstack into your Next.js application
...
<div class="bg-blue-50 py-3 mb-5 px-4 text-gray-600 border-l-8 border-blue-200 dark:bg-blue-800 dark:text-gray-50">
  Note: the names `experiment Viewed`, `experimentId` and `variationId` will be
