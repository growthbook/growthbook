...
GrowthBook supports Rudderstack as an event source for easily adding A/B testing to your application. This document outlines how to integrate Rudderstack with your Next.js application with data going to BigQuery, but is applicable if you have Rudderstack on other tech stacks.
...
From the data source section of the GrowthBook Platform, you can add a data source, and then choose Mixpanel from the
drop down.
...
The values you add here can be any you choose, although if you have already implemented experiment event tracking, you
should use the values you chose there. We suggest you use `Experiment Viewed`, `Experiment Id` and `Variation Id` as
in the example below.

<img
  src="/images/guides/mixpanel-6-add-exp-event-names.png"
...
<img
  src="/images/guides/mixpanel-8-successful-connection.png"
