...
GrowthBook supports using your existing Google Analytics UA as a data source for your experiment analysis.
Keep in mind, however, that there are some limitations with using GA as data source, namely it only supports
running one experiment at a time. Using GA4 as a data source provides more flexibility and has no limits.
...
you pass for this dimension is in the format of `[experiment key][divider][variation id]`. In this example
we’ll use dimension `1`, and a colon as a delimiter. You set the custom dimension you’re going to use as
well as the divider string when you connect GrowthBook to your GA data source:

<img
  src="/images/docs/GA-datasource.png"
  alt="GA Data Source"
...
<img
  src="/images/docs/GA-admin-add-dimension.png"
  alt="GA add custom dimension"
  style={{ margin: "0 auto 2em" }}
/>

<img
  src="/images/docs/GA-edit-custom-dimension.png"
...
<img
  src="/images/docs/GA-dimension-result.png"
  alt="GA edit dimension"
  style={{ margin: "0 auto" }}
/>
