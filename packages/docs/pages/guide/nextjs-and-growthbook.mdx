# GrowthBook and NextJS

This document is a guide on how to add GrowthBook feature flags to your NextJS application. It assumes you are starting from scratch, so if you already have a NextJS application, you can skip to step 2.
