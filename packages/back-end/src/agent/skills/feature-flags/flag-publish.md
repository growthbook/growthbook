...
>
> **B. Per-token bypass** — use credentials whose role grants `bypassApprovalFlags` on this project, then re-run."
...
>
> **D. Per-token bypass** — use credentials whose role grants `bypassApprovalFlags` on this project, then re-run."
