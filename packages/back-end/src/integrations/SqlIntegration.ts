...
export default abstract class SqlIntegration
  ...
  generateTablePath(tableName: string, schema?: string, database?: string) {
    console.log("schema in generateTablePath", schema);
    let path = "";
    ...
    if (this.requiresSchema) {
      ...
      console.log("schema in requiresSchema check", schema);
      if (!schema) {
  ...
  getAutoGeneratedMetricSqlQuery(
    ...
    console.log("made it to getAutoGeneratedMetricSqlQuery", schema);
...
`;
  ...
  getMetricsToCreate(
    ...
    console.log("made it to getMetricsToCreate");
    console.log("schema in metricsToCreate", schema);
  ...
  > {
    ...
    const sevenDaysAgo = formatDate(subDays(new Date(), 700), dateFormat);

    console.log("schema in SqlIntegration", schema);
