          ...
          SELECT
            ...
            ${metricData
              .map((m) => {
                ...
                , ${m.numeratorAggFns.reAggregationFunction(`${m.alias}_value`)} AS ${m.alias}_value
              ${m.ratioMetric ? `, ${m.denominatorAggFns.reAggregationFunction(`${m.alias}_denominator`)} AS ${m.alias}_denominator` : ""}
              `;
              })
              .join("\n")}
          FROM
