...
import { getPluralizedMetricName } from "../util/autoGeneratedMetrics";
...
export default abstract class SqlIntegration
  ...
  async getEventsTrackedByDatasource(
    ...
    return results.map((result) => {
      ...
      result.binomialSqlQuery = this.getAutoGeneratedMetricSqlQuery(
        result,
        schemaFormat,
        "binomial"
      );
      result.countSqlQuery = this.getAutoGeneratedMetricSqlQuery(
        result,
        schemaFormat,
        "count"
      );
      result.countDisplayName = getPluralizedMetricName(result.displayName);
      return result;
    });
  }
