import {
  ...
  deleteExperimentScheduleStopValidator,
} from "shared/validators";
import { getExperimentById } from "back-end/src/models/ExperimentModel";
import { clearExperimentScheduledStop } from "back-end/src/services/experimentScheduling";
import { auditDetailsUpdate } from "back-end/src/services/audit";
import { createApiRequestHandler } from "back-end/src/util/handler";
import { toEnhancedExperimentApiResponse } from "./enhancedExperimentResponse";

export const deleteExperimentScheduleStop = createApiRequestHandler(
  deleteExperimentScheduleStopValidator,
)(async (req) => {
  ...
  const { experiment: updated } = await clearExperimentScheduledStop({
    context: req.context,
    experiment,
  });
