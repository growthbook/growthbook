...
import { PostSavedGroupRemoveMemberResponse } from "../../../types/openapi";
import {
  getSavedGroupById,
  updateSavedGroupById,
} from "../../models/SavedGroupModel";
import { createApiRequestHandler } from "../../util/handler";
import { postSavedGroupRemoveMemberValidator } from "../../validators/openapi";

export const postSavedGroupRemoveMember = createApiRequestHandler(
  postSavedGroupRemoveMemberValidator
)(
  async (req): Promise<PostSavedGroupRemoveMemberResponse> => {
