import { postSavedGroupRevisionRecallReviewValidator } from "shared/validators";
...
export const postSavedGroupRevisionRecallReview = createApiRequestHandler(
  postSavedGroupRevisionRecallReviewValidator,
)(async (req) => {
  ...
  return { revision: await toApiSavedGroupRevision(recalled, req.context) };
});
