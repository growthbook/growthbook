import { searchTablesValidator } from "shared/validators";
import { getDataSourceById } from "back-end/src/models/DataSourceModel";
import { searchWarehouseTables } from "back-end/src/agent/ask-data-tools";
import { createApiRequestHandler } from "back-end/src/util/handler";

export const searchTables = createApiRequestHandler(searchTablesValidator)(
  async (req) => {
    ...
    const result = await searchWarehouseTables(req.context, datasource, {
