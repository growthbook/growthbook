import { postConstantRevisionReopenValidator } from "shared/validators";
...
export const postConstantRevisionReopen = createApiRequestHandler(
  postConstantRevisionReopenValidator,
)(async (req) => {
  ...
  return { revision: await toApiConstantRevision(reopened, req.context) };
});
