...
export type CreateSafeRolloutInterface = Pick<
  ...
  "datasourceId" | "exposureQueryId" | "maxDurationDays" | "guardrailMetricIds"
>;
...
export async function validateCreateSafeRolloutFields(
  ...
  if (
    safeRolloutFields.maxDurationDays === undefined ||
    safeRolloutFields.maxDurationDays < 1
  ) {
  ...
  return safeRolloutFields as CreateSafeRolloutInterface;
}
