...
export const apiPaginationFieldsValidator = z
  .object({
...
export const apiMetricValidator = z
  .object({
    id: z.string(),
    managedBy: z
      .enum(["", "api", "config"])
    ...
    behavior: z.object({
      ...
      capping: z.enum(["absolute", "percentile"]).nullable().optional(),
      capValue: z.coerce.number().optional(),
      windowSettings: z
        .object({
          ...
          delayHours: z.coerce
            .number()
            .describe(
              "Wait this many hours after experiment exposure before counting conversions"
            )
            .optional(),
          windowValue: z.coerce.number().optional(),
          windowUnit: z.enum(["hours", "days", "weeks"]).optional(),
        })
      ...
      priorSettings: z
        ...
        .optional(),
      conversionWindowStart: z.coerce.number().optional(),
      conversionWindowEnd: z.coerce.number().optional(),
    ...
    sqlBuilder: z
      .object({
        identifierTypeColumns: z.array(
          z.object({ identifierType: z.string(), columnName: z.string() })
        ),
        tableName: z.string(),
...
export const apiProjectValidator = z
  .object({
    ...
    settings: z.object({ statsEngine: z.string().optional() }).optional(),
  })
  .strict();
...
export const apiFeatureValidator = z
  .object({
        ...
        rules: z.array(
          z.union([
            ...
            z.object({
              ...
              variations: z.array(
                z.object({ value: z.string(), variationId: z.string() })
              ),
    ...
    prerequisites: z
      .array(z.object({ parentId: z.string(), parentCondition: z.string() }))
      .optional(),
    revision: z.object({
      ...
      .array(
        z.object({
          force: z
            ...
            .optional(),
          weights: z.array(z.any()).optional(),
          variations: z
            .array(
              z.union([
                z.string(),
...
export const apiFeatureForceRuleValidator = z
  .object({
    description: z.string(),
    condition: z.string(),
    savedGroupTargeting: z
...
export const apiFeatureRolloutRuleValidator = z
  .object({
    description: z.string(),
    condition: z.string(),
    savedGroupTargeting: z
...
export const apiFeatureExperimentRuleValidator = z
  .object({
    description: z.string(),
    condition: z.string(),
    id: z.string(),
...
export const apiFeatureExperimentRefRuleValidator = z
  .object({
    description: z.string(),
    id: z.string(),
    enabled: z.boolean(),
    ...
    phases: z.array(
      z.object({
        ...
        trafficSplit: z.array(
          z.object({ variationId: z.string(), weight: z.coerce.number() })
        ),
        namespace: z
          .object({ namespaceId: z.string(), range: z.array(z.any()) })
          .optional(),
...
export const apiExperimentSnapshotValidator = z
  .object({ id: z.string(), experiment: z.string(), status: z.string() })
  .strict();
...
export const apiExperimentResultsValidator = z
  .object({
    ...
    dateStart: z.string(),
    dateEnd: z.string(),
    dimension: z.object({ type: z.string(), id: z.string().optional() }),
    settings: z.object({
      datasourceId: z.string(),
      assignmentQueryId: z.string(),
      experimentId: z.string(),
    ...
    results: z.array(
      z.object({
        ...
        checks: z.object({ srm: z.coerce.number() }),
        metrics: z.array(
          z.object({
            metricId: z.string(),
            variations: z.array(
...
export const apiDataSourceValidator = z
  .object({
    ...
    identifierJoinQueries: z.array(
      z.object({ identifierTypes: z.array(z.string()), sql: z.string() })
    ),
    mixpanelSettings: z
      .object({
...
export const apiFactMetricValidator = z
  .object({
    ...
    tags: z.array(z.string()),
    datasource: z.string(),
    metricType: z.enum(["proportion", "mean", "quantile", "ratio"]),
    numerator: z.object({
      factTableId: z.string(),
      column: z.string(),
      filters: z.array(z.string()).describe("Array of Fact Table Filter Ids"),
    }),
    denominator: z
      .object({
        factTableId: z.string(),
...
export const postFeatureValidator = {
  bodySchema: z
    .object({
      ...
      owner: z
        .string()
        .describe("Email of the person who owns this experiment"),
...
export const getExperimentResultsValidator = {
  bodySchema: z.never(),
  querySchema: z
    .object({ phase: z.string().optional(), dimension: z.string().optional() })
    .strict(),
  paramsSchema: z.object({ id: z.string() }).strict(),
};
...
export const postMetricValidator = {
  bodySchema: z
    .object({
      ...
      owner: z
        .string()
        .describe("Name of the person who owns this metric")
        .optional(),
...
export const getVisualChangesetValidator = {
  bodySchema: z.never(),
  querySchema: z
    .object({ includeExperiment: z.coerce.number().int().optional() })
    .strict(),
  paramsSchema: z.object({ id: z.string() }).strict(),
};
...
export const putVisualChangeValidator = {
  ...
  querySchema: z.never(),
  paramsSchema: z
    .object({ id: z.string(), visualChangeId: z.string() })
    .strict(),
};
...
export const postFactTableValidator = {
  bodySchema: z
    .object({
      ...
      owner: z
        .string()
        .describe("The person who is responsible for this fact table")
        .optional(),
      projects: z
        .array(z.string())
    ...
    .object({
      ...
      numerator: z.object({
        ...
        column: z
          .string()
          .describe(
            "Must be empty for proportion metrics. Otherwise, the column name or one of the special values: '$$distinctUsers' or '$$count'"
          )
          .optional(),
        filters: z
          .array(z.string())
          .describe("Array of Fact Table Filter Ids")
          .optional(),
      }),
      denominator: z
        .object({
          ...
          column: z
            .string()
            .describe(
              "The column name or one of the special values: '$$distinctUsers' or '$$count'"
            ),
          filters: z
            .array(z.string())
            .describe("Array of Fact Table Filter Ids")
      ...
      denominator: z
        .object({
          ...
          column: z
            .string()
            .describe(
              "Otherwise, the column name or one of the special values: '$$distinctUsers' or '$$count'"
            ),
          filters: z
            .array(z.string())
            .describe("Array of Fact Table Filter Ids")
