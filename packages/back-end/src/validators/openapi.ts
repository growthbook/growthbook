...
export const postFactTableValidator = {
  bodySchema: z.object({"name":z.string(),"description":z.string().describe("Description of the fact table").optional(),"managedBy":z.enum(["","api"]).describe("Leave blank to allow editing this fact table in the UI. Set to \"api\" to prevent editing in the UI.").optional(),"owner":z.string().describe("The person who is responsible for this fact table").optional(),"projects":z.array(z.string()).describe("List of associated project ids").optional(),"tags":z.array(z.string()).describe("List of associated tags").optional(),"datasource":z.string().describe("The datasource id"),"userIdTypes":z.array(z.string()).describe("List of identifier columns in this table. For example, \"id\" or \"anonymous_id\""),"sql":z.string().describe("The SQL query for this fact table")}).strict(),
  querySchema: z.never(),
  paramsSchema: z.never(),
};
...
export const updateFactTableValidator = {
  bodySchema: z.object({"name":z.string().optional(),"description":z.string().describe("Description of the fact table").optional(),"managedBy":z.enum(["","api"]).describe("Leave blank to allow editing this fact table in the UI. Set to \"api\" to prevent editing in the UI.").optional(),"owner":z.string().describe("The person who is responsible for this fact table").optional(),"projects":z.array(z.string()).describe("List of associated project ids").optional(),"tags":z.array(z.string()).describe("List of associated tags").optional(),"userIdTypes":z.array(z.string()).describe("List of identifier columns in this table. For example, \"id\" or \"anonymous_id\"").optional(),"sql":z.string().describe("The SQL query for this fact table").optional()}).strict(),
  querySchema: z.never(),
  paramsSchema: z.object({"id":z.string()}).strict(),
};
...
export const postFactTableFilterValidator = {
  bodySchema: z.object({"name":z.string(),"description":z.string().describe("Description of the fact table filter").optional(),"managedBy":z.enum(["","api"]).describe("Leave blank to allow editing this in the UI. Set to \"api\" to prevent editing in the UI.").optional(),"value":z.string().describe("The SQL expression for this filter.")}).strict(),
  querySchema: z.never(),
  paramsSchema: z.object({"factTableId":z.string()}).strict(),
};
...
export const updateFactTableFilterValidator = {
  bodySchema: z.object({"name":z.string().optional(),"description":z.string().describe("Description of the fact table filter").optional(),"managedBy":z.enum(["","api"]).describe("Leave blank to allow editing this in the UI. Set to \"api\" to prevent editing in the UI.").optional(),"value":z.string().describe("The SQL expression for this filter.").optional()}).strict(),
  querySchema: z.never(),
  paramsSchema: z.object({"factTableId":z.string(),"id":z.string()}).strict(),
};
...
export const postBulkImportValidator = {
  bodySchema: z.object({"factTables":z.array(z.object({"id":z.string(),"data":z.object({"name":z.string(),"description":z.string().describe("Description of the fact table").optional(),"managedBy":z.enum(["","api"]).describe("Leave blank to allow editing this fact table in the UI. Set to \"api\" to prevent editing in the UI.").optional(),"owner":z.string().describe("The person who is responsible for this fact table").optional(),"projects":z.array(z.string()).describe("List of associated project ids").optional(),"tags":z.array(z.string()).describe("List of associated tags").optional(),"datasource":z.string().describe("The datasource id"),"userIdTypes":z.array(z.string()).describe("List of identifier columns in this table. For example, \"id\" or \"anonymous_id\""),"sql":z.string().describe("The SQL query for this fact table")})})).optional(),"factTableFilters":z.array(z.object({"factTableId":z.string(),"id":z.string(),"data":z.object({"name":z.string(),"description":z.string().describe("Description of the fact table filter").optional(),"managedBy":z.enum(["","api"]).describe("Leave blank to allow editing this in the UI. Set to \"api\" to prevent editing in the UI.").optional(),"value":z.string().describe("The SQL expression for this filter.")})})).optional(),"factMetrics":z.array(z.object({"id":z.string(),"data":z.object({"managedBy":z.enum(["","api"]).optional(),"owner":z.string().optional(),"datasource":z.string(),"name":z.string(),"description":z.string().optional(),"tags":z.array(z.string()).optional(),"projects":z.array(z.string()).optional(),"inverse":z.boolean().optional(),"metricType":z.enum(["proportion","mean","ratio"]),"numerator":z.object({"factTableId":z.string(),"column":z.string(),"filters":z.array(z.string())}),"denominator":z.object({"factTableId":z.string(),"column":z.string(),"filters":z.array(z.string())}).optional(),"capping":z.enum(["none","absolute","percentile"]).optional(),"capValue":z.number().optional(),"regressionAdjustmentOverride":z.boolean().optional(),"regressionAdjustmentEnabled":z.boolean().optional(),"regressionAdjustmentDays":z.number().optional(),"conversionDelayHours":z.number().optional(),"hasConversionWindow":z.boolean().optional(),"conversionWindowValue":z.number().optional(),"conversionWindowUnit":z.enum(["hours","days","weeks"]).optional()})})).optional()}).strict(),
  querySchema: z.never(),
  paramsSchema: z.never(),
};