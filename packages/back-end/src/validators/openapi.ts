...
export const apiExperimentAnalysisSettingsValidator = z.object({ "datasourceId": z.string(), "assignmentQueryId": z.string(), "experimentId": z.string(), "segmentId": z.string(), "queryFilter": z.string(), "inProgressConversions": z.enum(["include","exclude"]), "attributionModel": z.enum(["firstExposure","experimentDuration"]).describe("Setting attribution model to `\"experimentDuration\"` is the same as selecting \"Ignore Conversion Windows\" for the Conversion Window Override."), "statsEngine": z.enum(["bayesian","frequentist"]), "regressionAdjustmentEnabled": z.boolean().optional(), "goals": z.array(z.object({ "metricId": z.string(), "overrides": z.object({ "delayHours": z.coerce.number().optional(), "windowHours": z.coerce.number().optional(), "window": z.enum(["conversion","lookback",""]).optional(), "winRiskThreshold": z.coerce.number().optional(), "loseRiskThreshold": z.coerce.number().optional() }) })), "secondaryMetrics": z.array(z.object({ "metricId": z.string(), "overrides": z.object({ "delayHours": z.coerce.number().optional(), "windowHours": z.coerce.number().optional(), "window": z.enum(["conversion","lookback",""]).optional(), "winRiskThreshold": z.coerce.number().optional(), "loseRiskThreshold": z.coerce.number().optional() }) })), "guardrails": z.array(z.object({ "metricId": z.string(), "overrides": z.object({ "delayHours": z.coerce.number().optional(), "windowHours": z.coerce.number().optional(), "window": z.enum(["conversion","lookback",""]).optional(), "winRiskThreshold": z.coerce.number().optional(), "loseRiskThreshold": z.coerce.number().optional() }) })), "activationMetric": z.object({ "metricId": z.string(), "overrides": z.object({ "delayHours": z.coerce.number().optional(), "windowHours": z.coerce.number().optional(), "window": z.enum(["conversion","lookback",""]).optional(), "winRiskThreshold": z.coerce.number().optional(), "loseRiskThreshold": z.coerce.number().optional() }) }).optional() }).strict()

export const apiExperimentResultsValidator = z.object({ "id": z.string(), "dateUpdated": z.string(), "experimentId": z.string(), "phase": z.string(), "dateStart": z.string(), "dateEnd": z.string(), "dimension": z.object({ "type": z.string(), "id": z.string().optional() }), "settings": z.object({ "datasourceId": z.string(), "assignmentQueryId": z.string(), "experimentId": z.string(), "segmentId": z.string(), "queryFilter": z.string(), "inProgressConversions": z.enum(["include","exclude"]), "attributionModel": z.enum(["firstExposure","experimentDuration"]).describe("Setting attribution model to `\"experimentDuration\"` is the same as selecting \"Ignore Conversion Windows\" for the Conversion Window Override."), "statsEngine": z.enum(["bayesian","frequentist"]), "regressionAdjustmentEnabled": z.boolean().optional(), "goals": z.array(z.object({ "metricId": z.string(), "overrides": z.object({ "delayHours": z.coerce.number().optional(), "windowHours": z.coerce.number().optional(), "window": z.enum(["conversion","lookback",""]).optional(), "winRiskThreshold": z.coerce.number().optional(), "loseRiskThreshold": z.coerce.number().optional() }) })), "secondaryMetrics": z.array(z.object({ "metricId": z.string(), "overrides": z.object({ "delayHours": z.coerce.number().optional(), "windowHours": z.coerce.number().optional(), "window": z.enum(["conversion","lookback",""]).optional(), "winRiskThreshold": z.coerce.number().optional(), "loseRiskThreshold": z.coerce.number().optional() }) })), "guardrails": z.array(z.object({ "metricId": z.string(), "overrides": z.object({ "delayHours": z.coerce.number().optional(), "windowHours": z.coerce.number().optional(), "window": z.enum(["conversion","lookback",""]).optional(), "winRiskThreshold": z.coerce.number().optional(), "loseRiskThreshold": z.coerce.number().optional() }) })), "activationMetric": z.object({ "metricId": z.string(), "overrides": z.object({ "delayHours": z.coerce.number().optional(), "windowHours": z.coerce.number().optional(), "window": z.enum(["conversion","lookback",""]).optional(), "winRiskThreshold": z.coerce.number().optional(), "loseRiskThreshold": z.coerce.number().optional() }) }).optional() }), "queryIds": z.array(z.string()), "results": z.array(z.object({ "dimension": z.string(), "totalUsers": z.coerce.number(), "checks": z.object({ "srm": z.coerce.number() }), "metrics": z.array(z.object({ "metricId": z.string(), "variations": z.array(z.object({ "variationId": z.string(), "users": z.coerce.number().optional(), "analyses": z.array(z.object({ "engine": z.enum(["bayesian","frequentist"]), "numerator": z.coerce.number(), "denominator": z.coerce.number(), "mean": z.coerce.number(), "stddev": z.coerce.number(), "percentChange": z.coerce.number(), "ciLow": z.coerce.number(), "ciHigh": z.coerce.number(), "pValue": z.coerce.number().optional(), "risk": z.coerce.number().optional(), "chanceToBeatControl": z.coerce.number().optional() })) })) })) })) }).strict()
...
export const postSdkConnectionValidator = {
  bodySchema: z.object({ "name": z.string(), "language": z.string(), "sdkVersion": z.string().optional(), "environment": z.string(), "projects": z.array(z.string()).optional(), "encryptPayload": z.boolean().optional(), "includeVisualExperiments": z.boolean().optional(), "includeDraftExperiments": z.boolean().optional(), "includeExperimentNames": z.boolean().optional(), "includeRedirectExperiments": z.boolean().optional(), "includeRuleIds": z.boolean().optional(), "proxyEnabled": z.boolean().optional(), "proxyHost": z.string().optional(), "hashSecureAttributes": z.boolean().optional(), "remoteEvalEnabled": z.boolean().optional(), "savedGroupReferencesEnabled": z.boolean().optional() }).strict(),
  querySchema: z.never(),
  paramsSchema: z.never(),
};
...
export const postFactMetricValidator = {
  bodySchema: z.object({ "name": z.string(), "description": z.string().optional(), "owner": z.string().optional(), "projects": z.array(z.string()).optional(), "tags": z.array(z.string()).optional(), "metricType": z.enum(["proportion","retention","mean","quantile","ratio"]), "numerator": z.object({ "factTableId": z.string(), "column": z.string().describe("Must be empty for proportion metrics. Otherwise, the column name or one of the special values: '$$distinctUsers' or '$$count'").optional(), "aggregation": z.enum(["sum","max","count distinct"]).describe("User aggregation of selected column. Either sum or max for numeric columns; count distinct for string columns; ignored for special columns. Default: sum. If you specify a string column you must explicitly specify count distinct. Not used for proportion or event quantile metrics.").optional(), "filters": z.array(z.string()).describe("Array of Fact Table Filter Ids").optional() }), "denominator": z.object({ "factTableId": z.string(), "column": z.string().describe("The column name or one of the special values: '$$distinctUsers' or '$$count'"), "aggregation": z.enum(["sum","max","count distinct"]).describe("User aggregation of selected column. Either sum or max for numeric columns; count distinct for string columns; ignored for special columns. Default: sum. If you specify a string column you must explicitly specify count distinct. Not used for proportion or event quantile metrics.").optional(), "filters": z.array(z.string()).describe("Array of Fact Table Filter Ids").optional() }).describe("Only when metricType is 'ratio'").optional(), "inverse": z.boolean().describe("Set to true for things like Bounce Rate, where you want the metric to decrease").optional(), "quantileSettings": z.object({ "type": z.enum(["event","unit"]).describe("Whether the quantile is over unit aggregations or raw event values"), "ignoreZeros": z.boolean().describe("If true, zero values will be ignored when calculating the quantile"), "quantile": z.number().multipleOf(0.001).gte(0.001).lte(0.999).describe("The quantile value (from 0.001 to 0.999)") }).describe("Controls the settings for quantile metrics (mandatory if metricType is \"quantile\")").optional(), "cappingSettings": z.object({ "type": z.enum(["none","absolute","percentile"]), "value": z.number().describe("When type is absolute, this is the absolute value. When type is percentile, this is the percentile value (from 0.0 to 1.0).").optional(), "ignoreZeros": z.boolean().describe("If true and capping is `percentile`, zeros will be ignored when calculating the percentile.").optional() }).describe("Controls how outliers are handled").optional(), "windowSettings": z.object({ "type": z.enum(["none","conversion","lookback"]), "delayHours": z.number().describe("Wait this many hours after experiment exposure before counting conversions. Ignored if delayValue is set.").optional(), "delayValue": z.number().describe("Wait this long after experiment exposure before counting conversions.").optional(), "delayUnit": z.enum(["minutes","hours","days","weeks"]).describe("Default `hours`.").optional(), "windowValue": z.number().optional(), "windowUnit": z.enum(["minutes","hours","days","weeks"]).describe("Default `hours`.").optional() }).describe("Controls the conversion window for the metric").optional(), "priorSettings": z.object({ "override": z.boolean().describe("If false, the organization default settings will be used instead of the other settings in this object"), "proper": z.boolean().describe("If true, the `mean` and `stddev` will be used, otherwise we will use an improper flat prior."), "mean": z.number().describe("The mean of the prior distribution of relative effects in proportion terms (e.g. 0.01 is 1%)"), "stddev": z.number().gt(0).describe("Must be > 0. The standard deviation of the prior distribution of relative effects in proportion terms.") }).describe("Controls the bayesian prior for the metric. If omitted, organization defaults will be used.").optional(), "regressionAdjustmentSettings": z.object({ "override": z.boolean().describe("If false, the organization default settings will be used"), "enabled": z.boolean().describe("Controls whether or not regression adjustment is applied to the metric").optional(), "days": z.number().describe("Number of pre-exposure days to use for the regression adjustment").optional() }).describe("Controls the regression adjustment (CUPED) settings for the metric").optional(), "riskThresholdSuccess": z.number().gte(0).describe("Threshold for Risk to be considered low enough, as a proportion (e.g. put 0.0025 for 0.25%). <br/> Must be a non-negative number and must not be higher than `riskThresholdDanger`.").optional(), "riskThresholdDanger": z.number().gte(0).describe("Threshold for Risk to be considered too high, as a proportion (e.g. put 0.0125 for 1.25%). <br/> Must be a non-negative number.").optional(), "minPercentChange": z.number().gte(0).describe("Minimum percent change to consider uplift significant, as a proportion (e.g. put 0.005 for 0.5%)").optional(), "maxPercentChange": z.number().gte(0).describe("Maximum percent change to consider uplift significant, as a proportion (e.g. put 0.5 for 50%)").optional(), "minSampleSize": z.number().gte(0).optional(), "targetMDE": z.number().gte(0).describe("The percentage change that you want to reliably detect before ending an experiment, as a proportion (e.g. put 0.1 for 10%). This is used to estimate the \"Days Left\" for running experiments.").optional(), "managedBy": z.enum(["","api"]).describe("Set this to \"api\" to disable editing in the GrowthBook UI").optional() }).strict(),
  querySchema: z.never(),
  paramsSchema: z.never(),
};
...
export const updateFactMetricValidator = {
  bodySchema: z.object({ "name": z.string().optional(), "description": z.string().optional(), "owner": z.string().optional(), "projects": z.array(z.string()).optional(), "tags": z.array(z.string()).optional(), "metricType": z.enum(["proportion","retention","mean","quantile","ratio"]).optional(), "numerator": z.object({ "factTableId": z.string(), "column": z.string().describe("Must be empty for proportion metrics. Otherwise, the column name or one of the special values: '$$distinctUsers' or '$$count'").optional(), "aggregation": z.enum(["sum","max","count distinct"]).describe("User aggregation of selected column. Either sum or max for numeric columns; count distinct for string columns; ignored for special columns. Default: sum. If you specify a string column you must explicitly specify count distinct. Not used for proportion or event quantile metrics.").optional(), "filters": z.array(z.string()).describe("Array of Fact Table Filter Ids").optional() }).optional(), "denominator": z.object({ "factTableId": z.string(), "column": z.string().describe("The column name or one of the special values: '$$distinctUsers' or '$$count'"), "aggregation": z.enum(["sum","max","count distinct"]).describe("User aggregation of selected column. Either sum or max for numeric columns; count distinct for string columns; ignored for special columns. Default: sum. If you specify a string column you must explicitly specify count distinct. Not used for proportion or event quantile metrics.").optional(), "filters": z.array(z.string()).describe("Array of Fact Table Filter Ids").optional() }).describe("Only when metricType is 'ratio'").optional(), "inverse": z.boolean().describe("Set to true for things like Bounce Rate, where you want the metric to decrease").optional(), "quantileSettings": z.object({ "type": z.enum(["event","unit"]).describe("Whether the quantile is over unit aggregations or raw event values"), "ignoreZeros": z.boolean().describe("If true, zero values will be ignored when calculating the quantile"), "quantile": z.number().multipleOf(0.001).gte(0.001).lte(0.999).describe("The quantile value (from 0.001 to 0.999)") }).describe("Controls the settings for quantile metrics (mandatory if metricType is \"quantile\")").optional(), "cappingSettings": z.object({ "type": z.enum(["none","absolute","percentile"]), "value": z.number().describe("When type is absolute, this is the absolute value. When type is percentile, this is the percentile value (from 0.0 to 1.0).").optional(), "ignoreZeros": z.boolean().describe("If true and capping is `percentile`, zeros will be ignored when calculating the percentile.").optional() }).describe("Controls how outliers are handled").optional(), "windowSettings": z.object({ "type": z.enum(["none","conversion","lookback"]), "delayHours": z.number().describe("Wait this many hours after experiment exposure before counting conversions. Ignored if delayValue is set.").optional(), "delayValue": z.number().describe("Wait this long after experiment exposure before counting conversions.").optional(), "delayUnit": z.enum(["minutes","hours","days","weeks"]).describe("Default `hours`.").optional(), "windowValue": z.number().optional(), "windowUnit": z.enum(["minutes","hours","days","weeks"]).describe("Default `hours`.").optional() }).describe("Controls the conversion window for the metric").optional(), "regressionAdjustmentSettings": z.object({ "override": z.boolean().describe("If false, the organization default settings will be used"), "enabled": z.boolean().describe("Controls whether or not regression adjustment is applied to the metric").optional(), "days": z.number().describe("Number of pre-exposure days to use for the regression adjustment").optional() }).describe("Controls the regression adjustment (CUPED) settings for the metric").optional(), "riskThresholdSuccess": z.number().gte(0).describe("Threshold for Risk to be considered low enough, as a proportion (e.g. put 0.0025 for 0.25%). <br/> Must be a non-negative number and must not be higher than `riskThresholdDanger`.").optional(), "riskThresholdDanger": z.number().gte(0).describe("Threshold for Risk to be considered too high, as a proportion (e.g. put 0.0125 for 1.25%). <br/> Must be a non-negative number.").optional(), "minPercentChange": z.number().gte(0).describe("Minimum percent change to consider uplift significant, as a proportion (e.g. put 0.005 for 0.5%)").optional(), "maxPercentChange": z.number().gte(0).describe("Maximum percent change to consider uplift significant, as a proportion (e.g. put 0.5 for 50%)").optional(), "minSampleSize": z.number().gte(0).optional(), "targetMDE": z.number().gte(0).optional(), "managedBy": z.enum(["","api"]).describe("Set this to \"api\" to disable editing in the GrowthBook UI").optional() }).strict(),
  querySchema: z.never(),
  paramsSchema: z.object({ "id": z.string() }).strict(),
};
