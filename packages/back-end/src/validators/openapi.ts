...
export const updateFactMetricValidator = {
  bodySchema: z.object({"owner":z.string().optional(),"name":z.string().optional(),"description":z.string().optional(),"tags":z.array(z.string()).optional(),"projects":z.array(z.string()).optional(),"inverse":z.boolean().optional(),"metricType":z.enum(["proportion","mean","ratio"]).optional(),"numerator":z.object({"factTableId":z.string(),"column":z.string().describe("Must be empty for proportion metrics. Otherwise, the column name or one of the special values: '$$distinctUsers' or '$$count'").optional(),"filters":z.array(z.string()).optional()}).optional(),"denominator":z.object({"factTableId":z.string(),"column":z.string().describe("Otherwise, the column name or one of the special values: '$$distinctUsers' or '$$count'"),"filters":z.array(z.string()).optional()}).describe("Only when metricType is 'ratio'").optional(),"capping":z.enum(["none","absolute","percentile"]).optional(),"capValue":z.number().optional(),"regressionAdjustmentOverride":z.boolean().optional(),"regressionAdjustmentEnabled":z.boolean().optional(),"regressionAdjustmentDays":z.number().optional(),"conversionDelayHours":z.number().optional(),"hasConversionWindow":z.boolean().optional(),"conversionWindowValue":z.number().optional(),"conversionWindowUnit":z.enum(["hours","days","weeks"]).optional()}).strict(),
  querySchema: z.never(),
  paramsSchema: z.object({"id":z.string()}).strict(),
};
