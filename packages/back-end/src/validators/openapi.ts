...
export const postExperimentValidator = {
  bodySchema: z.object({"datasourceId":z.string().describe("ID for the [DataSource](#tag/DataSource_model)"),"exposureQueryId":z.string(),"trackingKey":z.string(),"name":z.string().describe("Name of the experiment"),"project":z.string().describe("Project ID which the experiment belongs to").optional(),"hypothesis":z.string().describe("Hypothesis of the experiment").optional(),"description":z.string().describe("Description of the experiment").optional(),"tags":z.array(z.string()).optional(),"metrics":z.array(z.string()).optional(),"owner":z.string().describe("Email of the person who owns this experiment"),"archived":z.boolean().optional(),"status":z.enum(["draft","running","stopped"]).optional(),"autoRefresh":z.boolean().optional(),"hashAttribute":z.string().optional(),"implementation":z.enum(["visual","code","configuration","custom"]),"variations":z.array(z.object({"id":z.string(),"key":z.string(),"name":z.string(),"description":z.string(),"screenshots":z.array(z.object({"path":z.string(),"width":z.number().optional(),"height":z.number().optional(),"description":z.string().optional()}))})).min(2),"phases":z.array(z.object({"name":z.string(),"dateStarted":z.string(),"dateEnded":z.string().optional(),"reasonForStopping":z.string(),"seed":z.string(),"coverage":z.number(),"trafficSplit":z.array(z.object({"variationId":z.string(),"weight":z.number()})),"namespace":z.object({"namespaceId":z.string(),"range":z.array(z.any())}),"targetingCondition":z.string(),"reason":z.string(),"condition":z.string(),"variationWeights":z.array(z.number()).optional()})).optional()}).strict(),
  querySchema: z.never(),
  paramsSchema: z.never(),
};
