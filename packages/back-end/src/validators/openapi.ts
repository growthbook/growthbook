...
export const listMembersValidator = {
  bodySchema: z.never(),
  querySchema: z.object({ "limit": z.coerce.number().int().default(10), "offset": z.coerce.number().int().default(0), "userName": z.string(), "userEmail": z.string(), "globalRole": z.string() }).strict(),
  paramsSchema: z.never(),
};
