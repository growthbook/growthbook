...
export const postAttributeValidator = {
  bodySchema: z.object({ "property": z.string().describe("The attribute property"), "datatype": z.enum(["boolean","string","number","secureString","enum","string[]","number[]","secureString[]","isoCountryCode"]).describe("The attribute datatype"), "description": z.string().describe("The description of the new attribute").optional(), "hashAttribute": z.boolean().describe("Shall the attribute be hashed").optional(), "enum": z.string().optional(), "format": z.enum(["","version","date"]).describe("The attribute's format").optional(), "projects": z.array(z.string()).optional() }).strict(),
  querySchema: z.never(),
  paramsSchema: z.never(),
};

export const putAttributeValidator = {
  bodySchema: z.object({ "datatype": z.enum(["boolean","string","number","secureString","enum","string[]","number[]","secureString[]","isoCountryCode"]).describe("The attribute datatype").optional(), "description": z.string().describe("The description of the new attribute").optional(), "hashAttribute": z.boolean().describe("Shall the attribute be hashed").optional(), "enum": z.string().optional(), "format": z.enum(["","version","date"]).describe("The attribute's format").optional(), "projects": z.array(z.string()).optional() }).strict(),
  querySchema: z.never(),
