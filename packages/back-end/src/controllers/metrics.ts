...
export async function deleteMetric(
  ...
  permissionsUtil.canCreateMetrics(metric).throwIfError();
...
export async function postAutoGeneratedMetrics(
  ...
  context.permissionsUtil.canCreateMetrics({ projects }).throwIfError();
...
export async function putMetric(
  ...
  context.permissionsUtil.canCreateMetrics(metric).throwIfError();
  ...
  if (updates?.projects?.length) {
    context.permissionsUtil.canCreateMetrics(updates).throwIfError();
  }
