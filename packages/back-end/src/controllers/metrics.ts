...
export async function deleteMetric(
  ...
  if (!context.permissions.canCreateMetrics(metric)) {
    context.permissions.throwPermissionError("createMetrics");
  }
...
export async function getMetricsFromTrackedEvents(
  ...
  if (!context.permissions.canCreateMetrics(dataSourceObj)) {
    context.permissions.throwPermissionError("createMetrics");
  }
...
export async function postAutoGeneratedMetrics(
  ...
  if (!context.permissions.canCreateMetrics({ projects })) {
    context.permissions.throwPermissionError("createMetrics");
  }
...
export async function putMetric(
  ...
  if (
    ...
    !context.permissions.canCreateMetrics(updates)
  ) {
    context.permissions.throwPermissionError("createMetrics");
  }
