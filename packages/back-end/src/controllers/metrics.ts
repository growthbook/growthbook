...
export async function deleteMetric(
  ...
  context.permissions.canCreateMetrics(metric);
...
export async function getMetricsFromTrackedEvents(
  ...
  context.permissions.canCreateMetrics(dataSourceObj).throwIfError();
...
export async function postAutoGeneratedMetrics(
  ...
  context.permissions.canCreateMetrics({ projects }).throwIfError();
...
export async function putMetric(
  ...
  context.permissions.canCreateMetrics(metric).throwIfError();
  ...
  if (updates?.projects?.length) {
    context.permissions.canCreateMetrics(updates).throwIfError();
  }
