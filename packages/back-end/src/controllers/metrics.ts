...
export async function deleteMetric(
  ...
  // pemissions.canCreateMetrics(metric).throwIfError();
  pemissions.canCreateMetrics(metric);
...
export async function getMetricsFromTrackedEvents(
  ...
  context.pemissions.canCreateMetrics(dataSourceObj).throwIfError();
...
export async function postAutoGeneratedMetrics(
  ...
  context.pemissions.canCreateMetrics({ projects }).throwIfError();
...
export async function putMetric(
  ...
  context.pemissions.canCreateMetrics(metric).throwIfError();
  ...
  if (updates?.projects?.length) {
    context.pemissions.canCreateMetrics(updates).throwIfError();
  }
