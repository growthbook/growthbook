...
export async function deleteMetric(
  ...
  if (!context.permissionsUtil.canCreateMetrics(metric)) {
...
export async function getMetricsFromTrackedEvents(
  ...
  if (!context.permissionsUtil.canCreateMetrics(dataSourceObj)) {
    context.permissionsUtil.throwPermissionError("createMetrics");
  }
...
export async function postAutoGeneratedMetrics(
  ...
  if (!context.permissionsUtil.canCreateMetrics({ projects })) {
    context.permissionsUtil.throwPermissionError("createMetrics");
  }
