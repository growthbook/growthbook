...
//MKTODO: Rename this to be more metric focused - it'll eventually be like AutoFactTableTrackedEvent maybe? - should prob rename that too
...
export interface SourceIntegrationInterface {
  ...
  getEventsTrackedByDatasourceUpdated?: (
    schemaFormat: SchemaFormat,
    schema?: string
