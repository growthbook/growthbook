...
if (stringToBoolean(process.env.PYTHON_SERVER_MODE)) {
  ...
  app.post(
    ...
    experimentsController.postSnapshotAnalysis
  );
  ...
  app.post(
    "/feature/:id/:version/rebase",
    featuresController.postFeatureRebase
  );
  app.post(
    "/feature/:id/:version/revert",
    featuresController.postFeatureRevert
  );
  ...
  app.put(
    ...
    featuresController.putRevisionComment
  );
  ...
  app.delete(
    "/feature/:id/:version/rule",
    featuresController.deleteFeatureRule
  );
  ...
  app.delete(
    "/feature/:id/prerequisite",
    featuresController.deletePrerequisite
  );
  app.post(
  ...
  app.post(
    "/feature/:id/:version/eval",
    featuresController.postFeatureEvaluate
  );
  ...
  app.get(
    "/datasource/:id/metrics",
    datasourcesController.getDataSourceMetrics
  );
  app.get(
    "/datasource/:id/queries",
    datasourcesController.getDataSourceQueries
  );
  app.put(
  ...
  app.get(
    ...
    discussionsController.getRecentDiscussions
  );
