...
// increase default max payload json size to 1mb and allow for per-route specific payload sizes
app.use((req, res, next) => {
  // Can add conditional logic on req.path and req.method to set the body limit here if needed
