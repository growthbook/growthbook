...
import { SnapshotResultChunkModel } from "back-end/src/models/SnapshotResultChunkModel";
...
export const modelClasses = {
  ...
  snapshotResultChunks: SnapshotResultChunkModel,
...
export class ReqContextClass {
  ...
  private initModels() {
    this.models = {
      ...
      snapshotResultChunks: new SnapshotResultChunkModel(this),
