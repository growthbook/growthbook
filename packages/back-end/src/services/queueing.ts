...
export const AGENDA_DEFAULT_POLL_INTERVAL_MS = 5000;
...
const createAgendaInstance = (options: AgendaConfig = {}): Agenda => {
  const config: AgendaConfig = {
    ...
    processEvery: `${AGENDA_DEFAULT_POLL_INTERVAL_MS / 1000} seconds`,
...
// Different config than defaultAgenda for performance reasons
