 ...
 * settled first. Wraps the instance's tracking callback, so call it once
 * every plugin has been applied. Browser only.
 */
import type { GrowthBook } from "./GrowthBook";
import type { AutoExperiment, TrackingData } from "./types/growthbook";
import { getAutoExperimentChangeType } from "./util";
import { getLocalStorage } from "./plugins/utils/storage";
...
export function persistRedirectExposures(gb: GrowthBook) {
