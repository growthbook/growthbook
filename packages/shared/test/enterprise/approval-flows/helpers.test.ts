...
describe("enterprise/approval-flows helpers", () => {
  ...
  describe("getApprovalFlowKey", () => {
    it("maps entity types to approval flow keys", () => {
      ...
      expect(getApprovalFlowKey("experiment" as any)).toBe("experiments");
      expect(getApprovalFlowKey("metric" as any)).toBe("metrics");
      expect(getApprovalFlowKey("fact-table" as any)).toBe("factTables");
    });
  ...
  describe("requiresApprovalForEntity", () => {
    it("returns false when no approval flow settings exist", () => {
      ...
      expect(requiresApprovalForEntity("fact-metric", entity, approvalFlowSettings)).toBe(false);
    });
    ...
    it("returns true when condition is empty", () => {
      ...
      expect(requiresApprovalForEntity("fact-metric", entity, approvalFlowSettings)).toBe(true);
  ...
  describe("canAdminBypassApprovalFlow", () => {
    it("returns false when user is not a super admin", () => {
      ...
      expect(canAdminBypassApprovalFlow("fact-metric", entity, approvalFlowSettings, false, "admin")).toBe(false);
    });
    ...
    it("returns false when no approval flow settings exist", () => {
      ...
      expect(canAdminBypassApprovalFlow("fact-metric", entity, approvalFlowSettings, true, "admin")).toBe(false);
    });
    ...
    it("allows bypass when adminCanBypass is true without conditions", () => {
      ...
      expect(canAdminBypassApprovalFlow("fact-metric", entity, approvalFlowSettings, true, "admin")).toBe(true);
    });
