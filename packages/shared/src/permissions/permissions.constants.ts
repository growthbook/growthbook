...
export const POLICY_PERMISSION_MAP: Record<Policy, Permission[]> = {
  ...
  TeamManagementFullAccess: ["readData", "manageGlobalTeams"],
  ProjectTeamManagement: ["readData", "manageProjectTeam"],
  ...
  CustomRolesFullAccess: ["readData", "manageGlobalTeams", "manageCustomRoles"],
...
export const DEFAULT_ROLES: Record<DefaultMemberRole, Role> = {
  ...
  projectAdmin: {
    id: "projectAdmin",
    description:
      "Full access to a specific project (no global admin permissions)",
    policies: [
      "ReadData",
      "Comments",
      "FeaturesFullAccess",
