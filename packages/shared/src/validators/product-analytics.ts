...
export type ProductAnalyticsConfig = z.infer<typeof productAnalyticsConfigValidator>;
...
export type ProductAnalyticsResult = z.infer<typeof productAnalyticsResultValidator>;