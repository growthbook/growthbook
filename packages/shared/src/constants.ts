...
// Sequential Testing:
export const DEFAULT_SEQUENTIAL_TESTING_TYPE = "disabled";
export const DEFAULT_SEQUENTIAL_TESTING_TUNING_PARAMETER = 5000;
export const DEFAULT_SEQUENTIAL_TESTING_RESERVED_ALPHA_PROPORTION = 0.5;

// Query settings
export const DEFAULT_TEST_QUERY_DAYS = 30;
export const MAX_METRIC_SLICE_LEVELS = 20;
