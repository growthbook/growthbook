...
// single-quoted string literals, double-quoted identifiers, or backtick-quoted
// identifiers (MySQL) so we never rewrite text inside a quoted span (e.g.
// `status = 'price'` or a MySQL `` `price` `` column is left alone).
