...
description: Run Visual Editor A/B tests on WordPress: connect the SDK, add the snippet to your site head, and launch experiments without custom code.
---
...
<Frame>![](/static/images/integrations/wordpress/wordpress-sdk-connection.png)</Frame>
...
<Frame>![Add code to header](/static/images/integrations/wordpress/add-code-to-header.png)</Frame>
