...
description: Run Visual Editor A/B tests on a WordPress site by adding a GrowthBook SDK Connection snippet to your theme.
...
![WordPress SDK Connection in GrowthBook](/static/images/integrations/wordpress/wordpress-sdk-connection.png)
