...
og:description: "The GrowthBook Agent Skills for experiments: brainstorm, design, launch, analyze, and stop A/B tests from your AI agent, grounded in your own metrics and past results."
sidebarTitle: Experiment skills
---
...
<Frame caption="GrowthBook's Head of Experimentation, Luke Sonnet, runs an experiment end to end using the skills.">
