...
description: "The GrowthBook Agent Skills for feature flags: create, target, roll out, ramp, monitor, and clean up flags from your AI agent, with draft → review → publish built in."
