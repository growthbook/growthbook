...
description: Store metric definitions in GitHub and sync them automatically into GrowthBook as the source of truth.
sidebarTitle: GitHub (Metric Definitions)
---
...
Read the API Docs on the [bulk-import/facts endpoint](/api/fact-tables/operation/postBulkImportFacts) to see all of the options and fields you can use in your `metrics.yml` file.
