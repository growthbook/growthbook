...
og:description: How to integrate GrowthBook with Jira, making it easy to connect feature flags and experiments with Jira issues.
id: jira
slug: jira
sidebarTitle: Official GrowthBook for Jira Integration
---
...
<Warning>
**Only supported for cloud-hosted GrowthBook accounts**
...
<Frame>![Adding field in project settings](/static/images/integrations/jira/add-field-to-project.png)</Frame>
<Frame>![Adding field to work item](/static/images/integrations/jira/add-field-to-task.png)</Frame>

## Adding Feature Flags and Experiments to Jira Issues

<Frame>![Select menu for GrowthBook for Jira](/static/images/integrations/jira/jira-select-features.jpg)</Frame>

<Info>
**Only existing items will be shown**
...
<Frame>![Feature status in Jira](/static/images/integrations/jira/jira-feature-status.jpg)</Frame>
...
<Frame>![Experiment status in Jira](/static/images/integrations/jira/jira-experiment-status.jpg)</Frame>
