...
description: Run Visual Editor A/B tests on your Shopify store: connect the SDK, add the snippet to theme.liquid, and launch experiments without custom code.
---
...
<Frame>![](/static/images/integrations/shopify/shopify-sdk-connection.png)</Frame>
...
<Frame>![](/static/images/integrations/shopify/growthbook-shopify-edit-code.png)</Frame>
...
<Frame>![](/static/images/integrations/shopify/shopify-theme-editor.png)</Frame>
...
<Frame>![](/static/images/integrations/shopify/growthbook-shopify-open-visual-editor.png)</Frame>
