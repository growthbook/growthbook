...
og:description: "GrowthBook connects to AI coding agents like Claude Code and Cursor in two ways: the MCP server and the Agent Skills library. Learn which to use."
