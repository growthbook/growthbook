...
Skills tell the in-app AI Assistant how to carry out tasks such as creating a Feature Flag or analyzing an experiment. Admins can turn individual skills on or off for their organization under **Settings → General → AI & Prompts**. A skill that's turned off is hidden from the `/` menu in the chat composer, and the Assistant can't use it. New skills start turned on.
