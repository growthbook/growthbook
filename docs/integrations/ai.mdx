...
description: Turn on GrowthBook AI features to generate copy, insights, and experiment variations from your configured model.
---
...
<Frame>
  <img src="/static/images/integrations/ai/ai-settings-cloud.png" alt="AI Settings" width="800" />
</Frame>
...
<Frame>
  <img src="/static/images/integrations/ai/sql-generation.png" alt="SQL Generation" width="800" />
</Frame>
...
<Frame>
  <img src="/static/images/integrations/ai/similar-experiments.png" alt="Similar Experiment Detection" width="600" />
</Frame>
...
Skills tell the in-app AI Assistant how to carry out tasks such as creating a Feature Flag or analyzing an experiment. Admins can turn individual skills on or off for their organization under **Settings → General → AI Settings**. A skill that's turned off is hidden from the `/` menu in the chat composer, and the Assistant can't use it. New skills start turned on.

Self-hosted installs can also add their own skills or replace the built-in ones. See [AI Assistant Skills](/self-host/env#ai-assistant-skills) in the environment variable reference.
...
<Frame>
  <img src="/static/images/integrations/ai/ai-settings-self-hosting.png" alt="AI Settings Self-hosting" width="800" />
</Frame>
