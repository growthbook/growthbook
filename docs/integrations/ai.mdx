...
og:description: Learn about AI integrations with GrowthBook.
---
...
<MaxWidthImage>
  <Frame>![AI Settings](/static/images/integrations/ai/ai-settings-cloud.png)</Frame>
</MaxWidthImage>
...
<MaxWidthImage maxWidth={800}>
  <Frame>![SQL Generation](/static/images/integrations/ai/sql-generation.png)</Frame>
</MaxWidthImage>
...
<Frame>![Similar Experiment Detection](/static/images/integrations/ai/similar-experiments.png)</Frame>
</MaxWidthImage>
...
<MaxWidthImage>
  <Frame>![AI Settings Self-hosting](/static/images/integrations/ai/ai-settings-self-hosting.png)</Frame>
</MaxWidthImage>
