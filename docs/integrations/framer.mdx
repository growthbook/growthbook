...
og:description: How to integrate GrowthBook with Framer, making it easy to connect feature flags and experiments with Framer components for no-code A/B testing.
---
...
<Tip>
**Need help setting up GA4 or BigQuery?**
...
<Frame caption="SDK connection page in GrowthBook">
  <img src="/static/images/integrations/framer/framer-sdk-connection.png" alt="SDK connection page in GrowthBook" width="800" />
</Frame>

<Frame caption="Framer plugin settings">
  <img src="/static/images/integrations/framer/framer-plugin-settings.png" alt="Framer plugin settings" width="400" />
</Frame>
...
<Frame caption="Feature creation page">
  <img src="/static/images/integrations/framer/framer-create-feature.png" alt="Feature creation page" width="800" />
</Frame>

<Frame caption="Feature flag experiment rule setup">
  <img src="/static/images/integrations/framer/framer-gb-experiment.png" alt="GrowthBook experiment setup" width="800" />
</Frame>
...
<Frame>
  <img src="/static/images/integrations/framer/framer-plugin-add-to-canvas.png" alt="Framer add to canvas" width="400" />
</Frame>

<Frame caption="GrowthBook component with variants attached">
  <img src="/static/images/integrations/framer/framer-experiment-setup.png" alt="Framer experiment" width="800" />
</Frame>
...
<Note>
**Other event trackers and data warehouses**
