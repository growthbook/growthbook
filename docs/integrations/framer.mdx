...
<Frame>![SDK connection page in GrowthBook](/static/images/integrations/framer/framer-sdk-connection.png)</Frame>
</MaxWidthImage>

<MaxWidthImage maxWidth={400} border caption="Framer plugin settings">
<Frame>![Framer plugin settings](/static/images/integrations/framer/framer-plugin-settings.png)</Frame>
</MaxWidthImage>
...
<Frame>![Feature creation page](/static/images/integrations/framer/framer-create-feature.png)</Frame>
</MaxWidthImage>

<MaxWidthImage border caption="Feature flag experiment rule setup">
<Frame>![GrowthBook experiment setup](/static/images/integrations/framer/framer-gb-experiment.png)</Frame>
</MaxWidthImage>
...
<Frame>![Framer add to canvas](/static/images/integrations/framer/framer-plugin-add-to-canvas.png)</Frame>
</MaxWidthImage>

<MaxWidthImage caption="GrowthBook component with variants attached">
<Frame>![Framer experiment](/static/images/integrations/framer/framer-experiment-setup.png)</Frame>
</MaxWidthImage>
