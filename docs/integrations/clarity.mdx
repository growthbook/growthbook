...
description: Tag Microsoft Clarity sessions with GrowthBook experiment and variation ids so you can watch recordings by test.
sidebarTitle: Microsoft Clarity (Heatmaps)
---
