---
title: DevTools Browser Extension for Feature Flags and A/B Tests
description: Use GrowthBook DevTools in Chrome or Firefox to inspect, debug, and override feature flags and A/B tests on a live page.
