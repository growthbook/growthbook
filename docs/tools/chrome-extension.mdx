...
og:description: Learn how to use GrowthBook DevTools, a browser extension (Chrome and Firefox) for inspecting, debugging, and modifying feature flags and A/B tests in real time. Improve experiment workflows effortlessly.
...
<video autoPlay loop muted style={{width: '100%', height: "auto", aspectRatio: 16/9, border: "1px solid var(--color-border)"}} width={1920} height={1080}>
    <source src="/static/videos/devtools-demo.mp4" type="video/mp4" />
</video>
</Frame>
...
<Frame>![Quick access devtools](/static/images/devtools-quickaccess.webp)</Frame>
...
<Frame>![Chrome devtools panel](/static/images/devtools-panel.webp)</Frame>
...
<MaxWidthImage>
<Frame>![Feature flags and overrides](/static/images/devtools-features.png)</Frame>
</MaxWidthImage>
...
<video autoPlay loop muted style={{width: '100%', height: "auto", aspectRatio: 16/9, marginBlockEnd: "1.5rem", border: "1px solid var(--color-border)"}} width={1920} height={1080}>
    <source src="/static/videos/devtools-feature-override.mp4" type="video/mp4" />
</video>
</Frame>
...
<MaxWidthImage>
<Frame>![Experiments overview](/static/images/devtools-experiments-overview.png)</Frame>
</MaxWidthImage>
...
<MaxWidthImage>
<Frame>![Attributes overview](/static/images/devtools-attr.webp)</Frame>
</MaxWidthImage>
...
<MaxWidthImage>
<Frame>![SDK overview](/static/images/devtools-sdk-status.webp)</Frame>
</MaxWidthImage>
...
<Frame>![DevTools Access Token](/static/images/devtools-pat.webp)</Frame>
...
<Frame>![Back-end evaluation logging with DevTools](/static/images/devtools-back-end-evaluation.png)</Frame>
