...
og:description: The GrowthBook command-line interface (CLI) for working with the GrowthBook A/B testing, feature flagging, and experimentation platform
slug: cli
...
```bash Yarn
yarn add growthbook --save
```

```bash pnpm
pnpm add growthbook --save
```

```bash bun
bun add growthbook --save
```
</CodeGroup>
