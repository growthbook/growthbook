...
<MaxWidthImage maxWidth={800} border>
    <Frame>![Experiment Impact](/static/images/insights/impact.png)</Frame>
</MaxWidthImage>
...
<MaxWidthImage maxWidth={800}>
    <Frame>![Win Rate and Velocity](/static/images/insights/win-rate.png)</Frame>
</MaxWidthImage>
...
<MaxWidthImage maxWidth={800} border>
    <Frame>![Experiment Learnings](/static/images/insights/learnings.png)</Frame>
</MaxWidthImage>
...
<MaxWidthImage maxWidth={800}>
    <Frame>![Experiment Timeline](/static/images/insights/timeline.png)</Frame>
</MaxWidthImage>
...
<MaxWidthImage maxWidth={800} border>
    <Frame>![Metric Effects](/static/images/insights/effects.png)</Frame>
</MaxWidthImage>
...
<MaxWidthImage maxWidth={800} border>
    <Frame>![Metric Correlations - Positive Correlation](/static/images/insights/correlations.png)</Frame>
</MaxWidthImage>
...
<MaxWidthImage maxWidth={800} border>
    <Frame>![Metric Correlations - Negative Correlation](/static/images/insights/correlations-two.png)</Frame>
</MaxWidthImage>
