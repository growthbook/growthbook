...
og:description: Multiple Testing Corrections
...
<MaxWidthImage border maxWidth={500}>
  <Frame>![Org-level Multiple Testing Correction Settings](/static/images/statistics/pvals-adjustment-org.png)</Frame>
</MaxWidthImage>
...
<MaxWidthImage border maxWidth={500}>
  <Frame>![Demonstrating Correction in Results](/static/images/statistics/pvals-adjusted.png)</Frame>
</MaxWidthImage>
