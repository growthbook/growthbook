...
description: Control false positives when you test many metrics or variations at once using frequentist multiple testing corrections in GrowthBook.
sidebarTitle: Multiple Testing Corrections
...
<Frame>
  <img src="/static/images/statistics/pvals-adjustment-org.png" alt="Org-level Multiple Testing Correction Settings" width="500" />
</Frame>
...
<Tip>
**Adjusted p-values do not have directly analogous confidence intervals**
...
<Tip>
**Adjusted p-values are corrected using all Goal metrics**
...
<Frame>
  <img src="/static/images/statistics/pvals-adjusted.png" alt="Demonstrating Correction in Results" width="500" />
</Frame>
