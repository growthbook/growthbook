...
description: How GrowthBook analyzes experiments with Bayesian and frequentist engines, and how to choose one at the org or project level.
...
Bayesian methods provide a few key advantages over frequentist approaches.
...
<Frame>![Violin plot of a metrics change](/static/images/violin-plot.png)</Frame>
...
Frequentist statistics are familiar to many practitioners, power much of our statistics engine, and have
