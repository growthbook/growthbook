...
og:description: Sequential Testing
...
<Frame>![Effect of Tuning Sequential Statistics on CI Width](/static/images/statistics/sequential-tuning.png)</Frame>
</MaxWidthImage>
...
<MaxWidthImage maxWidth={600}>
<Frame>![Sequential Statistics Organization Settings](/static/images/statistics/sequential-settings.png)</Frame>
</MaxWidthImage>
...
<Frame>![Sequential Statistics Experiment Settings](/static/images/statistics/sequential-exp-settings.png)</Frame>
</MaxWidthImage>
