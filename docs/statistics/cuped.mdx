...
description: Use CUPED regression adjustment and post-stratification to reduce metric variance in experiment results.
sidebarTitle: CUPED + Post-stratification
slug: cuped
---
...
<Frame>
  <img src="/static/images/statistics/cuped-corr.png" alt="Variance Reduction by Correlation" width="600" />
</Frame>
...
<Frame>
  <img src="/static/images/statistics/cuped-org.png" alt="Organization-level CUPED Setting" width="800" />
</Frame>
...
<Frame>
  <img src="/static/images/statistics/cuped-metric.png" alt="Metric-level CUPED Setting" width="700" />
</Frame>
...
<Frame>
  <img src="/static/images/statistics/cuped-results-ratio.png" alt="Experiment Results with CUPED toggle" width="800" />
</Frame>
...
<Frame>
  <img src="/static/images/statistics/cuped-results-ratio-off.png" alt="Experiment Results with CUPED toggle" width="800" />
</Frame>
...
where $\bar{Y}$ is the post-exposure metric average, $\bar{X}$ is the pre-exposure metric average, and $\theta$ is essentially a regression coefficient from a regression of the post-experiment data on the pre-experiment data (pooled across both the control and treatment variation of interest), $\theta = \text{Cov}(Y, X) / \text{Var}(X)$. See [technical CUPED details](/statistics/cuped-technical) for ratio metrics and how we estimate uncertainty.
...
See [technical post-stratification details](/statistics/post-stratification).
