...
og:description: Regression Adjustment (CUPED) + post-stratification
...
<MaxWidthImage maxWidth={600}>
  <Frame>![Variance Reduction by Correlation](/static/images/statistics/cuped-corr.png)</Frame>
</MaxWidthImage>
...
<MaxWidthImage maxWidth={800} border>
  <Frame>![Organization-level CUPED Setting](/static/images/statistics/cuped-org.png)</Frame>
</MaxWidthImage>
...
<MaxWidthImage maxWidth={700}>
  <Frame>![Metric-level CUPED Setting](/static/images/statistics/cuped-metric.png)</Frame>
</MaxWidthImage>
...
<MaxWidthImage maxWidth={800}>
  <Frame>![Experiment Results with CUPED toggle](/static/images/statistics/cuped-results-ratio.png)</Frame>
</MaxWidthImage>
...
<MaxWidthImage maxWidth={800}>
  <Frame>![Experiment Results with CUPED toggle](/static/images/statistics/cuped-results-ratio-off.png)</Frame>
</MaxWidthImage>
