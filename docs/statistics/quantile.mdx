...
description: Run quantile tests in GrowthBook to compare percentiles across variations, such as P90 spend or latency, instead of only comparing means.
sidebarTitle: Quantile Testing
slug: quantile
---
...
<Frame>![User interface for quantile metrics](/static/images/statistics/quantile.png)</Frame>
