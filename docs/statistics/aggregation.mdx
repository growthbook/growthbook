---
title: Aggregate Data and the Statistics Engine
description: How GrowthBook's stats engine analyzes experiments from aggregate warehouse data and never collects user-level events or PII.
sidebarTitle: Aggregate Data
slug: aggregation
---
...
<Frame>![View Query - SQL and aggregate statistics](/static/images/view-query-aggregate.png)</Frame>
