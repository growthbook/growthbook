...
description: How GrowthBook estimates experiment lifts and standard errors, then builds confidence intervals, p-values, and Bayesian risks.
sidebarTitle: Statistical Details
slug: details
---
