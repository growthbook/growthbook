...
description: Gate a feature, rule, or experiment so it only evaluates when another feature is on for that environment.
sidebarTitle: Prerequisite Features
...
<Frame>
  <img src="/static/images/features/feature-top-level-prerequisites.png" alt="Top-level prerequisites" width="800" />
</Frame>
...
<Frame>
  <img src="/static/images/features/feature-inline-prerequisite-targeting-2.png" alt="Inline prerequisite targeting" width="700" />
</Frame>
...
<Frame>
  <img src="/static/images/features/feature-prereq-dependents.png" alt="Prerequisite dependents" width="700" />
</Frame>
