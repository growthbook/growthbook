...
og:description: Gate features, rules, and experiments by a prerequisite feature
...
<MaxWidthImage border>
  <Frame>![Top-level prerequisites](/static/images/features/feature-top-level-prerequisites.png)</Frame>
</MaxWidthImage>
...
<MaxWidthImage maxWidth={700}>
  <Frame>![Inline prerequisite targeting](/static/images/features/feature-inline-prerequisite-targeting-2.png)</Frame>
</MaxWidthImage>
...
<MaxWidthImage maxWidth={700}>
  <Frame>![Prerequisite dependents](/static/images/features/feature-prereq-dependents.png)</Frame>
</MaxWidthImage>
