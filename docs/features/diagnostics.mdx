...
description: Inspect why a user received a feature value, including which rule matched and which attributes were used.
sidebarTitle: Feature Diagnostics
...
<Frame>![Feature Usage Query configuration in data source settings](/static/images/features/feature-diagnostics/datasource-usage-query-block.png)</Frame>
...
<Frame>![Diagnostics tab showing recent feature evaluation events](/static/images/features/feature-diagnostics/diagnostics-tab.png)</Frame>
