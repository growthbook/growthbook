---
title: Safe Rollouts
og:description: Release features to a subset of users while monitoring guardrail metrics for regressions. Detect issues early and reduce risk in production.
...
<Frame>![Add a safe rollout rule](/static/images/features/safe-rollout-new-rule.webp)</Frame>
</MaxWidthImage>
...
<MaxWidthImage border>
<Frame>![Safe rollout configuration](/static/images/features/safe-rollout-create.webp)</Frame>
</MaxWidthImage>
...
<MaxWidthImage border>
<Frame>![Safe rollout rollback now warning message](/static/images/features/safe-rollout-rollback-now.webp)</Frame>
</MaxWidthImage>
