...
og:description: Validate JSON, string, and number feature flag values against a schema to prevent typos and costly mistakes.
...
<MaxWidthImage border>
  <Frame>![JSON Schema Validation](/static/images/features/json-schema/validation-banner.png)</Frame>
</MaxWidthImage>
...
<MaxWidthImage border>
  <Frame>![JSON Schema Editor](/static/images/features/json-schema/validation-form.png)</Frame>
</MaxWidthImage>
...
<MaxWidthImage border>
  <Frame>![Simplified editing UI for simple schemas](/static/images/features/json-schema/value-editor.png)</Frame>
</MaxWidthImage>
