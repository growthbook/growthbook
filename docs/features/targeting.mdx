...
og:description: Define who sees a feature using attributes, conditions, and saved groups.
...
<Frame>![Saved groups condition, showing how to add a US user on a mobile device](/static/images/features/saved-groups-condition.png)</Frame>
...
<Frame>![Saved Group UI, focusing on adding an ID list](/static/images/features/saved-groups-id-list.png)</Frame>
