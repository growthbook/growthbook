...
You can enable or disable a flag from the feature page, or automate it (for example, from a deploy script) with the [toggle feature endpoint](/api/features-v2/operation/toggleFeatureV2), which switches a flag on or off in one or more environments.
