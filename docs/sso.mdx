...
description: Configure Enterprise SSO on GrowthBook Cloud or self-hosted using OpenID Connect with Okta, Google, Azure AD, and other providers.
id: sso
slug: sso
sidebarTitle: SSO Instructions
---
...
- `logout_endpoint` (string, optional) - Only set this if you want logging out of GrowthBook to
  also end the user's session with your identity provider. By default, "Log out" only clears the
  GrowthBook session and the user stays signed in to your IdP.
    ...
    <ol>
      <li>
        <strong>Create an OIDC Web application:</strong> <br />
          <Frame>![Create an OIDC Web application](/static/images/guides/SSO-Okta-1.png)</Frame>
      ...
      <li>
        ...
        <Frame>![Okta settings](/static/images/guides/SSO-Okta-2.png)</Frame>
      </li>
      <li>
        <strong>Require PKCE as additional verification</strong>(optional)<br />
        <Frame>
          <img src="/static/images/guides/SSO-Okta-3.png" alt="Require PKCE" width="800" />
        </Frame>
        <div>
  ...
  <div>
    <ol>
      <li>
        ...
        <Frame>
          <img src="/static/images/guides/SSO-Azure-1.png" alt="Register an Application" width="800" />
        </Frame>
      </li>
      <li>
        Enter the redirect URL as APP_HOST/oauth/callback
        <Frame>
          <img src="/static/images/guides/SSO-Azure-2.png" alt="Redirect URL" width="800" />
        </Frame>
      </li>
      <li>
        Take note of your Application Id (CLIENT_ID) and Directory Id (TENANT_ID). You will need it later
        <Frame>
          <img src="/static/images/guides/SSO-Azure-3.png" alt="Application Id" width="800" />
        </Frame>
      </li>
      <li>
        Generate a new Client Secret<br />
       <Frame>
         <img src="/static/images/guides/SSO-Azure-4.png" alt="Client Secret" width="800" />
       </Frame>
      </li>
      <li>
      ...
      <li>
        Construct the JSON configuration for GrowthBook. Replace <pre>CLIENT_ID</pre>, CLIENT_SECRET, EMAIL_DOMAIN, and TENANT_ID in the JSON object above.
      </li>
      <li>
  ...
  <div>
    <ol>
      <li>
        ...
        <Frame>![Create a new OIDC Web application](/static/images/guides/SSO-Onelogin-1.png)</Frame>
      </li>
      <li>
        ...
        <Frame>![Select OpenID Connect](/static/images/guides/SSO-Onelogin-2.png)</Frame>
      </li>
      <li>
      ...
      <li>
        ...
        <Frame>![OneLogin settings](/static/images/guides/SSO-Onelogin-3.png)</Frame>
      ...
      <li>
        ...
        <Frame>![OneLogin SSO settings](/static/images/guides/SSO-Onelogin-4.png)</Frame>
      ...
      <li>
        For self-hosted instances: construct the JSON configuration for GrowthBook. Replace CLIENT_ID, CLIENT_SECRET, EMAIL_DOMAIN, and TENANT_ID in the JSON object above. The ONELOGIN_DOMAIN will be the same domain from your Issuer URL you recorded earlier.
      </li>
      <li>
        Pass the JSON string into the environment variable SSO_CONFIG of your GrowthBook container
      </li>
  ...
  <div>
    <ol>
      ...
      <li>
        ...
        <Frame>![JumpCloud custom application, page 1](/static/images/guides/SSO-jumpcloud-1.png)</Frame>
        <Frame>![JumpCloud custom application, page 2](/static/images/guides/SSO-jumpcloud-2.png)</Frame>
      </li>
      <li>
        ...
        <Frame>![JumpCloud SSO configuration](/static/images/guides/SSO-jumpcloud-3.png)</Frame>
      </li>
      <li>
        ...
        <Frame>![JumpCloud SSO configuration with general info fields](/static/images/guides/SSO-jumpcloud-4.png)</Frame>
        <Frame>![JumpCloud SSO configuration confirmation screen](/static/images/guides/SSO-jumpcloud-5.png)</Frame>
      </li>
      <li>
        ...
        <Frame>![JumpCloud SSO OpenID Connect](/static/images/guides/SSO-jumpcloud-6.png)</Frame>
      ...
      <li>
        ...
        <Frame>
          <img src="/static/images/guides/SSO-jumpcloud-7.png" alt="JumpCloud SSO client id and secret" width="600" />
        </Frame>
      </li>
      <li>
        For self-hosted instances, construct the JSON configuration for GrowthBook. Replace CLIENT_ID, CLIENT_SECRET, and EMAIL_DOMAIN in the JSON object above.
      </li>
      <li>
        Pass the JSON string into the environment variable SSO_CONFIG of your GrowthBook container
      </li>
