...
og:description: Configuring GrowthBook for SSO
id: sso
slug: sso
  ...
  <div>
    <ol>
      ...
      <li>
        ...
        <MaxWidthImage>
        <Frame>![Require PKCE](/static/images/guides/SSO-Okta-3.png)</Frame>
        </MaxWidthImage>
        <div>
  ...
  <div>
    <ol>
      <li>
        ...
        <MaxWidthImage><Frame>![Register an Application](/static/images/guides/SSO-Azure-1.png)</Frame></MaxWidthImage>
      </li>
      <li>
        Enter the redirect URL as APP_HOST/oauth/callback
        <MaxWidthImage><Frame>![Redirect URL](/static/images/guides/SSO-Azure-2.png)</Frame></MaxWidthImage>
      </li>
      <li>
        Take note of your Application Id (CLIENT_ID) and Directory Id (TENANT_ID). You will need it later
        <MaxWidthImage><Frame>![Application Id](/static/images/guides/SSO-Azure-3.png)</Frame></MaxWidthImage>
      </li>
      <li>
        Generate a new Client Secret<br />
       <MaxWidthImage> <Frame>![Client Secret](/static/images/guides/SSO-Azure-4.png)</Frame></MaxWidthImage>
      </li>
      <li>
  ...
  <div>
    <ol>
      ...
      <li>
        ...
        <MaxWidthImage maxWidth={600}><Frame>![JumpCloud SSO client id and secret](/static/images/guides/SSO-jumpcloud-7.png)</Frame></MaxWidthImage>
      </li>
      <li>
