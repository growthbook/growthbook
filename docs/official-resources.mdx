...
description: Mark metrics and other resources as official so only users with the right permissions can edit them.
sidebarTitle: Official Resources
...
<Frame>
  <img src="/static/images/metrics/official-metric.png" alt="Example of an official metric" width="800" />
</Frame>
...
<Note>
**Restrictions on creating Official Resources**
...
<Note>
**Limited support for marking Official Resources**
