...
og:description: Everything you need to know to quickly migrate existing features, experiments, SDKs, and more from Statsig to GrowthBook, the largest open source experimentation platform.
sidebarTitle: Migrate from Statsig to GrowthBook
---
...
<Frame>![GrowthBook Statsig importer](/static/images/guides/import-from-statsig-with-data.png)</Frame>
</MaxWidthImage>
