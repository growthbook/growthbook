...
description: Let content teams run A/B tests in Contentful with GrowthBook without a developer change for every test.
slug: contentful
...
<Frame>![Contentful entry with GrowthBook experiment variations](/static/images/guides/contentful-experiment.png)</Frame>
...
<Frame>![Contentful and GrowthBook flow diagram](/static/images/guides/contentful-growthbook-diagram.png)</Frame>
...
<Frame>![GrowthBook SDK connection](/static/images/guides/contentful-sdk-connection-data.png)</Frame>

### 2. Configure data source

A data source is the connection between GrowthBook and your analytics platform. This connection allows GrowthBook to analyze your experiment data and provide insights. It also informs Contentful which data source to use when creating experiments.
...
<Frame>![GrowthBook data source ID location](/static/images/guides/contentful-data-source-id.png)</Frame>
...
<Frame>![GrowthBook API test](/static/images/guides/contentful-api-keys.png)</Frame>
...
<video width="1280" height="720" controls style={{width: '100%', height: 'auto', aspectRatio: 16/9}}>
  <source src="/static/videos/guides/contentful-add-experiment.mp4" type="video/mp4"></source>
</video>
</Frame>
