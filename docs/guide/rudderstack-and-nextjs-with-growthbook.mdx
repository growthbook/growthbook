...
og:description: Learn how to use GrowthBook with Rudderstack to easily add A/B testing to your application running on Next.js
...
<MaxWidthImage border>
  <Frame>![Add Rudderstack JS source](/static/images/guides/rudderstack-7-create-source.png)</Frame>
</MaxWidthImage>
...
<MaxWidthImage border>
  <Frame>![Add BigQuery destination](/static/images/guides/rudderstack-8-source-w-destination.png)</Frame>
</MaxWidthImage>
...
<MaxWidthImage border>
  <Frame>![Rudderstack BigQuery connection](/static/images/guides/rudderstack-9-connected-js.png)</Frame>
</MaxWidthImage>
