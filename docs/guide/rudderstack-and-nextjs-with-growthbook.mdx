---
title: A/B Testing with Rudderstack and Next.js
description: Send Next.js experiment exposure through RudderStack and analyze the warehouse export in GrowthBook.
sidebarTitle: Rudderstack + Next.js
...
<Frame>
  <img src="/static/images/guides/rudderstack-7-create-source.png" alt="Add Rudderstack JS source" width="800" />
</Frame>
...
about how to [connect Rudderstack to your data destination](/guide/rudderstack).

<Frame>
  <img src="/static/images/guides/rudderstack-8-source-w-destination.png" alt="Add BigQuery destination" width="800" />
</Frame>
...
<Frame>
  <img src="/static/images/guides/rudderstack-9-connected-js.png" alt="Rudderstack BigQuery connection" width="800" />
</Frame>
...
This will allow you to add `rudder.track()` in your app anywhere you import rudder.js while sharing the same Rudderstack object.
...
This code adds the `id` within GrowthBook to the Rudderstack anonymous_id. If you want to load user_id as well as anonymous_id you'll have to add this id to the setAttribute, and also call the `rudder.identify()` with the user_id info.
