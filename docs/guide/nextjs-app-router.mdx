...
description: Add the GrowthBook SDK to a Next.js App Router app for server and client feature flags and experiments.
---
...
<Frame>
  <img src="/static/images/guides/nextjs-1-growthbook-signup-screen.jpeg" alt="GrowthBook Signup Screen" width="800" />
</Frame>
...
<Frame>
  <img src="/static/images/guides/nextjs-3-create-feature.png" alt="GrowthBook Create Feature" width="500" />
</Frame>
...
```bash Yarn
yarn add --save @growthbook/growthbook
```

```bash pnpm
pnpm add --save @growthbook/growthbook
```
...
<Frame>
  <img src="/static/images/guides/nextjs-4-employee-rule.png" alt="GrowthBook Targeting Rule" width="500" />
</Frame>
...
<Frame>
  <img src="/static/images/guides/nextjs-6-rollout-rule.png" alt="GrowthBook Rollout Rule" width="500" />
</Frame>
...
converts it to a float between 0 and 1. If that float is less than or equal to
