...
og:description: This guide walks you through using GrowthBook with Next.js App Router.
...
<MaxWidthImage border>
  <Frame>![GrowthBook Signup Screen](/static/images/guides/nextjs-1-growthbook-signup-screen.jpeg)</Frame>
</MaxWidthImage>
...
<MaxWidthImage maxWidth={500}>
  <Frame>![GrowthBook Create Feature](/static/images/guides/nextjs-3-create-feature.png)</Frame>
</MaxWidthImage>
...
<MaxWidthImage maxWidth={500}>
  <Frame>![GrowthBook Targeting Rule](/static/images/guides/nextjs-4-employee-rule.png)</Frame>
</MaxWidthImage>
...
<MaxWidthImage maxWidth={500}>
  <Frame>![GrowthBook Rollout Rule](/static/images/guides/nextjs-6-rollout-rule.png)</Frame>
</MaxWidthImage>
