...
<MaxWidthImage border>
 <Frame>![GA4 - BigQuery create project](/static/images/guides/GA4-1-project-list.png)</Frame>
</MaxWidthImage>

Click on **_Create new project_** from the right and give your project a name.

<MaxWidthImage border maxWidth={500}>
 <Frame>![GA4 - BigQuery create and name your project](/static/images/guides/GA4-2-create-project.png)</Frame>
</MaxWidthImage>

Once created, you'll be redirected to the BigQuery dashboard.

<MaxWidthImage border>
 <Frame>![GA4 - BigQuery new project dashboard](/static/images/guides/GA4-3-new-project.png)</Frame>
</MaxWidthImage>
...
<MaxWidthImage border>
  <Frame>![GA4 BigQuery new project dashboard](/static/images/guides/GA4-4-link-to-bigquery-1.png)</Frame>
</MaxWidthImage>
...
<MaxWidthImage border>
  <Frame>![GA4 BigQuery, choose a project](/static/images/guides/GA4-5-link-to-bigquery-2.png)</Frame>
</MaxWidthImage>

Select the project you wish to send your GA4 data to:

<MaxWidthImage border>
  <Frame>![GA4 BigQuery connect to project](/static/images/guides/GA4-5-link-to-bigquery-3.png)</Frame>
</MaxWidthImage>
...
<Frame>![GA4 BigQuery successfully connected](/static/images/guides/GA4-5-link-to-bigquery-7.png)</Frame>
</MaxWidthImage>
...
<MaxWidthImage border maxWidth={500}>
  <Frame>![GA4 GrowthBook connect to GA4](/static/images/guides/GA4-6-add-GA4-datasource.png)</Frame>
</MaxWidthImage>

<MaxWidthImage border maxWidth={500}>
  <Frame>![GA4 GrowthBook connect to GA4](/static/images/guides/GA4-6-add-GA4-datasource2.png)</Frame>
</MaxWidthImage>
