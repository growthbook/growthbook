---
title: A/B Testing with Google Analytics 4 and GrowthBook
description: Send GrowthBook experiment exposure to GA4, export events to BigQuery, and analyze results in GrowthBook.
...
GrowthBook connects to Google Analytics (GA4) via BigQuery. This process is straightforward, and outlined below.
You can also find [Google's documentation on creating this link](https://support.google.com/analytics/answer/9823238).
...
<Frame>
  <img src="/static/images/guides/GA4-1-project-list.png" alt="GA4 - BigQuery create project" width="800" />
</Frame>

Click on **_Create new project_** from the right and give your project a name.

<Frame>
  <img src="/static/images/guides/GA4-2-create-project.png" alt="GA4 - BigQuery create and name your project" width="500" />
</Frame>

Once created, you'll be redirected to the BigQuery dashboard.

<Frame>
  <img src="/static/images/guides/GA4-3-new-project.png" alt="GA4 - BigQuery new project dashboard" width="800" />
</Frame>
...
<Note>
**Using the BigQuery sandbox project**

If you are just testing GrowthBook with GA4 out, you can use the sandbox project that Google provides for free. When you create a new cloud project the sandbox should be automatically enabled. See the [BigQuery sandbox docs](https://cloud.google.com/bigquery/docs/sandbox).
...
<Frame>
  <img src="/static/images/guides/GA4-4-link-to-bigquery-1.png" alt="GA4 BigQuery new project dashboard" width="800" />
</Frame>
...
<Frame>
  <img src="/static/images/guides/GA4-5-link-to-bigquery-2.png" alt="GA4 BigQuery, choose a project" width="800" />
</Frame>

Select the project you wish to send your GA4 data to:

<Frame>
  <img src="/static/images/guides/GA4-5-link-to-bigquery-3.png" alt="GA4 BigQuery connect to project" width="800" />
</Frame>

Then click **Next**.

<Frame>![GA4 BigQuery connected to project](/static/images/guides/GA4-5-link-to-bigquery-4.png)</Frame>

On the next step you'll be presented with some options about the connection.

<Frame>![GA4 BigQuery link options](/static/images/guides/GA4-5-link-to-bigquery-5.png)</Frame>
...
<Frame>![GA4 BigQuery link created](/static/images/guides/GA4-5-link-to-bigquery-6.png)</Frame>

And then your BigQuery link will show up on the listing page:

<Frame>
  <img src="/static/images/guides/GA4-5-link-to-bigquery-7.png" alt="GA4 BigQuery successfully connected" width="1000" />
</Frame>

<Note>
**Loading Google Analytics via Google Tag Manager (GTM)**
...
You'll need to give GrowthBook permissions to your BigQuery project so that we can access the data. See the [BigQuery setup guide](/guide/bigquery).
...
<Frame>
  <img src="/static/images/guides/GA4-6-add-GA4-datasource.png" alt="GA4 GrowthBook connect to GA4" width="500" />
</Frame>

<Frame>
  <img src="/static/images/guides/GA4-6-add-GA4-datasource2.png" alt="GA4 GrowthBook connect to GA4" width="500" />
</Frame>
...
<Info>
**Visual editor for creating experiments**
...
Please see our [GA4 Troubleshooting Guide](/kb/google-analytics/google-analytics-ga4-troubleshooting) for help debugging GA4 integrations with GrowthBook. If relevant, see our [GTM Setup Guide](/guide/google-tag-manager-and-growthbook) and our [Google Tag Manager (GTM) Troubleshooting Guide](/kb/google-analytics/google-tag-manager-gtm-troubleshooting).
