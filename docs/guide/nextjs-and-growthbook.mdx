...
<MaxWidthImage border maxWidth={700}>
  <Frame>![GrowthBook Integration Code](/static/images/guides/nextjs-2-feature-flag-key.png)</Frame>
</MaxWidthImage>
...
<MaxWidthImage maxWidth={500} border>
  <Frame>![Next.js app with feature](/static/images/guides/nextjs-5-nextjs-title.png)</Frame>
</MaxWidthImage>
