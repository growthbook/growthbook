...
description: Create a BigQuery service account, grant read access, and connect it to GrowthBook as a data source.
...
Selecting an event tracker here will pre-populate the experiment exposure query which is needed to determine which user saw which experiment
