...
<MaxWidthImage border maxWidth={1000}>
  <Frame>![Create service account button in BigQuery](/static/images/guides/bigquery-1-addserviceaccount-for-gb-highlited.png)</Frame>
</MaxWidthImage>

<MaxWidthImage border maxWidth={500}>
  <Frame>![Create a new service account in BigQuery](/static/images/guides/bigquery-2-addserviceaccount-for-gb3.png)</Frame>
</MaxWidthImage>

Create a service account name and account ID. On the next page you need to add 3 specific roles:

<MaxWidthImage border maxWidth={500}>
  <Frame>![Grant roles for service account in BigQuery](/static/images/guides/bigquery-3-addserviceaccount-for-gb4-roles.png)</Frame>
</MaxWidthImage>
...
<MaxWidthImage border maxWidth={500}>
  <Frame>![Additional roles granted for service account](/static/images/guides/bigquery-4-addserviceaccount-for-gb5-roles.png)</Frame>
</MaxWidthImage>
...
<MaxWidthImage border maxWidth={1000}>
  <Frame>![New account listed](/static/images/guides/bigquery-5-getjson-key.png)</Frame>
</MaxWidthImage>
...
<MaxWidthImage border maxWidth={1000}>
  <Frame>![Create new key from dashboard](/static/images/guides/bigquery-6-getjson-key2.png)</Frame>
</MaxWidthImage>

<MaxWidthImage maxWidth={500}>
  <Frame>![Create private key for GrowthBook popup](/static/images/guides/bigquery-6-getjson-key3.png)</Frame>
</MaxWidthImage>
...
<MaxWidthImage maxWidth={500}>
  <Frame>![Add BigQuery to GrowthBook](/static/images/guides/bigquery-7-add-datasource1.png)</Frame>
</MaxWidthImage>

Select BigQuery as the data source type.

<MaxWidthImage maxWidth={500}>
  <Frame>![Selecting BigQuery as the data source type.](/static/images/guides/bigquery-7-add-datasource2.png)</Frame>
</MaxWidthImage>
...
<MaxWidthImage maxWidth={500} border>
  <Frame>![Get default project id and default dataset](/static/images/guides/bigquery-8-getdefault-names.png)</Frame>
</MaxWidthImage>
