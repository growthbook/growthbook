...
og:description: This guide shows how to integrate GrowthBook with Express.js to manage server-side feature flags.
slug: express-js
...
<Frame>![GrowthBook Create Feature](/static/images/guides/express-js-1-create-feature.png)</Frame>
</MaxWidthImage>
...
<Frame>![GrowthBook Targeting Rule](/static/images/guides/express-js-2-targeting-rule.png)</Frame>
</MaxWidthImage>
