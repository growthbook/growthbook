---
title: Feature Flags with Express.js and GrowthBook
description: Evaluate GrowthBook feature flags in Express.js middleware and route handlers on the server.
slug: express-js
sidebarTitle: Express.js and GrowthBook
---
...
Let's now modify the top of `index.js` file and create a **GrowthBookClient** instance:
...
Let's also add a middleware to `index.js` that creates a user-scoped instance for every request. Make sure to place this above the route handlers:
...
Let's re-start the Node process and make sure you see the "GrowthBook initialized" message in the console and the status is successful. Since we are using a `.env` file, we need to modify the command to tell Node.js to load it.
...
<Frame>
  <img src="/static/images/guides/express-js-1-create-feature.png" alt="GrowthBook Create Feature" width="500" />
</Frame>
...
<Frame>
  <img src="/static/images/guides/express-js-2-targeting-rule.png" alt="GrowthBook Targeting Rule" width="500" />
</Frame>
