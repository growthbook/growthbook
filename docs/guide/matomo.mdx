...
og:description: Configure GrowthBook to do A/B testing using Matomo Analytics
sidebarTitle: Matomo
slug: /guide/matomo
---
...
<MaxWidthImage maxWidth={500}>
  <Frame>![Add Matomo data source](/static/images/new-data-sources-modal.png)</Frame>
</MaxWidthImage>

After you select Matomo, you will be prompted to connect to your MySQL/Maria database.

<MaxWidthImage maxWidth={500}>
  <Frame>![Add MySQL/MariaDB data source](/static/images/guides/matomo-2-connect-to-db.png)</Frame>
</MaxWidthImage>
...
<MaxWidthImage maxWidth={500}>
  <Frame>![Setting Matomo options](/static/images/guides/matomo-3-matomo-options.png)</Frame>
</MaxWidthImage>

When you save, you'll have the experiment exposure queries for anonymous and user_id set for you.

<MaxWidthImage>
  <Frame>![Default Matomo experiment exposure query](/static/images/guides/matomo-4-matomo-anon.png)</Frame>
</MaxWidthImage>
