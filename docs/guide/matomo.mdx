---
title: Configuring GrowthBook to work with Matomo
description: Track experiment exposure in Matomo and analyze results in GrowthBook using your Matomo MySQL database.
sidebarTitle: Matomo
slug: /guide/matomo
---
...
<Frame>
  <img src="/static/images/new-data-sources-modal.png" alt="Add Matomo data source" width="500" />
</Frame>

After you select Matomo, you will be prompted to connect to your MySQL/Maria database.

<Frame>
  <img src="/static/images/guides/matomo-2-connect-to-db.png" alt="Add MySQL/MariaDB data source" width="500" />
</Frame>

Once you've completed the connection, GrowthBook will show the Matomo options, where you can adjust some settings specific to your instance and how you implemented the Matomo tracking code.

<Frame>
  <img src="/static/images/guides/matomo-3-matomo-options.png" alt="Setting Matomo options" width="500" />
</Frame>

When you save, you'll have the experiment exposure queries for anonymous and user_id set for you.

<Frame>
  <img src="/static/images/guides/matomo-4-matomo-anon.png" alt="Default Matomo experiment exposure query" width="800" />
</Frame>
