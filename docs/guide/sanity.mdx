...
description: "Set up Sanity with GrowthBook in Next.js to create CMS content variations and run them as feature-flag A/B tests."
---
...
<Frame>![Two variations of Camera World with different titles and images](/static/images/guides/sanity-ab.png)</Frame>
...
```bash Yarn
yarn dlx create-next-app@latest my-sanity-growthbook-app --typescript --tailwind --eslint --app
```

```bash pnpm
pnpm dlx create-next-app@latest my-sanity-growthbook-app --typescript --tailwind --eslint --app
```

```bash bun
bunx create-next-app@latest my-sanity-growthbook-app --typescript --tailwind --eslint --app
```
...
Sanity offers a plugin for personalization that includes a [direct integration with GrowthBook](https://github.com/sanity-io/sanity-plugin-personalization/blob/main/growthbook). This plugin allows you to create content variations within Sanity and use GrowthBook for feature flag experiments.
...
```bash Yarn
yarn add @sanity/personalization-plugin
```

```bash pnpm
pnpm add @sanity/personalization-plugin
```

```bash bun
bun add @sanity/personalization-plugin
```
...
```ts highlight="10,28,29,30,31,32"
"use client";
...
<Frame>![GrowthBook SDK Connection](/static/images/guides/sanity-sdk-connection.png)</Frame>
...
<Frame>![GrowthBook Feature Flag](/static/images/guides/sanity-feature-flag.png)</Frame>
...
<Frame>![GrowthBook Experiment](/static/images/guides/sanity-experiment.png)</Frame>
...
<Frame>![Sanity Experiment Field](/static/images/guides/sanity-add-experiment-field.png)</Frame>
<Frame>![Add flag to field](/static/images/guides/sanity-add-flag-to-field.png)</Frame>
<Frame>![Sanity experiment](/static/images/guides/sanity-experiment-set.png)</Frame>
...
To track experiment exposures, which variations a user saw, we'll need to create a tracking component. Create a new file, `lib/growthbookTracking.tsx`.
...
<Frame caption="Sanity experiment: Control">
  <img src="/static/images/guides/sanity-a.png" alt="Sanity experiment: a" width="800" />
</Frame>

<Frame caption="Sanity experiment: Variation">
  <img src="/static/images/guides/sanity-b.png" alt="Sanity experiment: b" width="800" />
</Frame>
...
```tsx highlight="111,112,113,114,115,116,117,118,119,120,121,122,123,124,157,158,159,177,178,179,180,181"
// app/[slug]/page.tsx
