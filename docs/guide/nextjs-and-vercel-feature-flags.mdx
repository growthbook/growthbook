...
og:description: Step-by-step guide to integrating GrowthBook feature flags into your Next.js application deployed on Vercel. Includes using Edge Config, the Vercel Toolbar, and best practices.
slug: nextjs-and-vercel-feature-flags
sidebarTitle: "How to Integrate GrowthBook with Next.js, Vercel Edge Config, and Vercel Feature Flags"
---
...
<Frame>![GrowthBook SDK Webhook](/static/images/guides/vercel-edge-sdk-connection.webp)</Frame>
...
<Frame>![Feature flags configured in GrowthBook](/static/images/guides/vercel-ff-features.webp)</Frame>
...
<Frame>![Vercel Toolbar](/static/images/guides/vercel-toolbar.webp)</Frame>
...
<Frame>
<iframe src="https://giphy.com/embed/BtEw37CXZti8yfq3Ke" width="100%" height="100%" frameBorder="0" className="giphy-embed" allowFullScreen></iframe>
</Frame>
