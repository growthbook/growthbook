---
title: Feature Flags and A/B Tests with Deno and Hono
sidebarTitle: Deno and Hono
description: Add GrowthBook to a Deno and Hono server to evaluate feature flags and run experiments in request handlers.
slug: deno-hono
---
...
<Frame>![Bayes Bank Homepage, example site for the Deno, Hono, GrowthBook demo](/static/images/guides/deno-homepage-demo.png)</Frame>
...
<Frame>![Diagram showing Deno, Hono, and GrowthBook](/static/images/guides/deno-diagram.png)</Frame>
...
<Frame>![Rendered footer component](/static/images/guides/deno-footer-component.png)</Frame>
...
<Frame>![GrowthBook feature flag configuration](/static/images/guides/deno-growthbook-feature-flag.png)</Frame>

Next, click **Add Rule** &rarr; **Experiment** to set up an A/B test.

<Frame>![GrowthBook A/B test configuration](/static/images/guides/deno-growthbook-abtest.png)</Frame>
...
<Frame>![Rendered A/B test control](/static/images/guides/deno-control.png)</Frame>

<Frame>![Rendered A/B test variation](/static/images/guides/deno-variation.png)</Frame>
