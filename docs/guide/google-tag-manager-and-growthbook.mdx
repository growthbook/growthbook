...
description: Load the GrowthBook SDK from Google Tag Manager and send experiment exposure to your analytics tags.
...
<Frame>![GrowthBook SDK Connection](/static/images/guides/gtm-sdk.webp)</Frame>
...
<Frame>![GTM Tag for GrowthBook](/static/images/guides/gtm-growthbook-sdk-custom-tag.webp)</Frame>
...
As seen in the image below, the control element shows the price, while the variation shows the original price with a strikethrough and the discounted price in red. We can run this entire experiment straight from GTM, without needing to touch the website code!

<Frame>![A control element with the image and name of a couch, showing just a price, and a variation element with the same image and name, showing the original price with a strikethrough and the discounted price in red](/static/images/guides/gtm-ab-test.webp)</Frame>
...
In this tutorial, we'll send this data to Google Analytics 4 (GA4), which allows you to analyze experiments and their impact on your organization's metrics in GrowthBook. (It's also possible to forward this event to your analytics tool of choice.)
...
<Frame>![DataLayer Variables](/static/images/guides/gtm-data-layer-variables.webp)</Frame>
...
<Frame>![Custom Event Trigger](/static/images/guides/gtm-custom-trigger.webp)</Frame>
...
<Frame>![GTM GA4 Configuration Tag](/static/images/guides/gtm-ga4-config.webp)</Frame>
...
<Frame>![GTM GA4 Event Tag](/static/images/guides/gtm-ga4-event.webp)</Frame>
...
<Frame>![GTM Preview Mode](/static/images/guides/gtm-preview.webp)</Frame>
