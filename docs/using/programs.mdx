...
- **De-risking** You can de-risk any product change you make with A/B testing. You can test any
  ...
  unexpectedly effect your metrics/organization, or the project has no bugs or errors, but still negatively
  effects your organization. A/B testing will catch all of these issues, and allows you to roll out to a
...
end, is to improve your organization by producing the best product.
