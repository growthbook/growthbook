...
description: "Scale your A/B testing program from crawl to fly: how teams mature experimentation volume, culture, and platform investment."
---
...
after, or they will say some variation of "We don't know". Once your team realizes that A/B testing
...
<Frame>
  <iframe src="https://www.youtube.com/embed/8rvprlnFpbg?si=6Duk_dyqB78UC6rn" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
</Frame>
...
- **De-risking** You can de-risk any product change you make with A/B testing. You can test any
  ...
  unexpectedly affect your metrics/organization, or the project has no bugs or errors, but still negatively
  affects your organization. A/B testing will catch all of these issues, and allows you to roll out to a
...
- **Limiting investment on bad ideas** As we discussed in our HAMM section - When you focus on
  ...
  spent on ideas that don't work or that will have a negative impact on your organization.
...
end, is to help your organization by producing the best product.
...
As awareness of the ease of experimentation, and the insights gained from it, grows, more teams may start
