...
description: Learn the basics of A/B testing, including control vs variation, hypotheses, statistical significance, and how to read experiment results.
---
...
## Anatomy of an A/B test {#anatomy-of-an-a-b-test}

<Frame>![Anatomy of an A/B test](/static/images/using/ab-test-diagram.png)</Frame>
...
### Hypothesis {#writing-a-hypothesis}
...
- **Measurable**: The hypothesis should include a metric or metrics that can be used to evaluate the
  outcome of the test.
- **Relevant**: The hypothesis should be relevant to your organization's goals and objectives.
...
relevant to your organization's goals.
