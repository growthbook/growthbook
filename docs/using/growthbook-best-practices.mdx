...
| is                  | supports searching on the feature status, results, and other current states. Supported fields <br /><br /><table><tbody><tr><td>archived</td><td>If the feature is archived</td></tr><tr><td>draft</td><td>The feature is in draft status</td></tr></tbody></table>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
| health              | Supports searching on the feature's staleness (Stale column) and cleanup signals (Health column). Supported fields <br /><br /><table><tbody><tr><td>stale</td><td>The feature is stale in every enabled environment</td></tr><tr><td>partially-stale</td><td>The feature is stale in some environments</td></tr><tr><td>temp-rollout</td><td>A rule serves a stopped experiment's released variation (includes old-temp-rollout)</td></tr><tr><td>old-temp-rollout</td><td>A rule serves the released variation of an experiment stopped more than 30 days ago</td></tr><tr><td>detection-off</td><td>Stale detection is disabled for the feature</td></tr></tbody></table>                                                                                                                                           |
