...
| is                  | supports searching on the feature status, results, and other current states. Supported fields <br /><br /><table><tbody><tr><td>archived</td><td>If the feature is archived</td></tr><tr><td>draft</td><td>The feature is in draft status</td></tr><tr><td>stale</td><td>The feature is stale in every enabled environment</td></tr><tr><td>partially-stale</td><td>The feature is stale in some environments</td></tr><tr><td>stale-detection-off</td><td>Stale detection is disabled for the feature</td></tr></tbody></table>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
...
| health              | Supports searching on the signals shown in the Health column, or by severity (<code>high</code>, <code>medium</code>, <code>low</code>). Supported fields <br /><br /><table><tbody><tr><td>temp-rollout</td><td>A rule serves a stopped experiment's released variation (includes old-temp-rollout)</td></tr><tr><td>old-temp-rollout</td><td>A rule serves the released variation of an experiment stopped more than 30 days ago</td></tr><tr><td>unreachable-rule</td><td>A rule can never run because an earlier rule always matches</td></tr><tr><td>missing-experiment</td><td>A rule references a deleted or archived experiment</td></tr><tr><td>invalid-value</td><td>A value fails the feature's type or JSON schema</td></tr><tr><td>ramp-paused</td><td>A ramp schedule is paused</td></tr><tr><td>ramp-needs-approval</td><td>A ramp schedule is waiting for approval</td></tr><tr><td>safe-rollout-rollback-now</td><td>A running safe rollout's guardrails are failing</td></tr><tr><td>safe-rollout-unhealthy</td><td>A running safe rollout has a traffic imbalance or multiple exposures</td></tr><tr><td>safe-rollout-no-data</td><td>A running safe rollout has received no data in over a day</td></tr></tbody></table> |
