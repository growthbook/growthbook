...
| health              | Supports searching on cleanup signals shown in the Health column. Supported fields <br /><br /><table><tbody><tr><td>temp-rollout</td><td>A rule serves a stopped experiment's released variation (includes old-temp-rollout)</td></tr><tr><td>old-temp-rollout</td><td>A rule serves the released variation of an experiment stopped more than 30 days ago</td></tr></tbody></table>                                                                                                                                                                                                                                                                                                                                                                                                                                  |
