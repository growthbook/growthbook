...
description: Shift product development from shipping features to measuring impact by integrating A/B tests into every change you release.
---

Experimentation-driven product development is a shift in product development from focusing on **shipping**
new products, to focus on shipping features that have an **impact** on your organization. The best way
...
effort, and cost in terms of actual money. You want to keep these as low as possible and make sure
...
- **Hypothesis**: What is the hypothesis you are testing? This should be a clear, falsifiable statement of what you are trying to learn. See our section on how to make good [hypothesis](/using/fundamentals#writing-a-hypothesis).
...
<div style={{display: 'flex', justifyContent: 'center', width: '100%'}}>
  ...
  <div style={{width: "180px", flex: "0 0 180px", marginLeft: "40px"}}><img src="/static/images/using/jon_hamm-cropped.png" alt="John Hamm"/></div>
</div>
