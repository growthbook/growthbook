...
description: Import experiments from your data source, set traffic splits, choose metrics, and analyze Bayesian or frequentist results.
---
...
percentage, as well as customize the split per variation. You can also target an experiment at just some
attribute values.
...
To solve this case, we recommend keeping the experiment splits equal, and adjusting the overall
...
<Frame>
  <img src="/static/images/using/metrics-modal.png" alt="GrowthBook Metric Selector" width="600" />
</Frame>
...
![Metric Windows](/static/images/metric-windows.png)
...
![Metric Windows (User 2)](/static/images/metric-windows-user-2.png)
...
![GrowthBook Results](/static/images/using/experiment-results-bayesian.png)
...
![GrowthBook Results](/static/images/using/experiment-results-bayesian-details2.png)
...
![GrowthBook Results - Frequentist](/static/images/using/experiment-results-frequentist.png)
...
<Frame>
  <img src="/static/images/using/health-page.png" alt="Experiment Health Page" width="600" />
</Frame>
...
<Frame>
  <img src="/static/images/using/srm-check-health-page.png" alt="Sample Ratio Mismatch" width="600" />
</Frame>
...
GrowthBook will show an alert. Large uplifts may indicate a bug - see [Twyman's Law](/using/experimentation-problems#twymans-law).
...
![Guardrail Results](/static/images/using/guardrail-metrics.png)
...
![Dimension Selector](/static/images/using/dimension-selector.png)
...
<Frame>
  <img src="/static/images/reports-share-report.webp" alt="Example Custom Reports" width="800" />
</Frame>
...
generally straightforward to declare a result. If you have a mix of up and down metrics, the decisions
are less clear.
