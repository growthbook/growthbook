...
description: Analyze A/B test results in GrowthBook: import experiments, set traffic splits, choose metrics, and interpret Bayesian or frequentist results.
---
...
<Frame>![GrowthBook Results](/static/images/using/experiment-results-bayesian.png)</Frame>
...
<Frame>![GrowthBook Results](/static/images/using/experiment-results-bayesian-details2.png)</Frame>
...
<Frame>![GrowthBook Results - Frequentist](/static/images/using/experiment-results-frequentist.png)</Frame>
...
<Frame>![Guardrail Results](/static/images/using/guardrail-metrics.png)</Frame>
...
<Frame>![Segments](/static/images/using/segments-page.png)</Frame>
...
<Frame>![Dimension Selector](/static/images/using/dimension-selector.png)</Frame>
...
<Frame caption="Example Custom Report">
