...
<MaxWidthImage maxWidth={600}>
  <Frame>![GrowthBook Metric Selector](/static/images/using/metrics-modal.png)</Frame>
</MaxWidthImage>
...
<MaxWidthImage maxWidth={600}>
  <Frame>![Experiment Health Page](/static/images/using/health-page.png)</Frame>
</MaxWidthImage>
...
<MaxWidthImage maxWidth={600}>
  <Frame>![Sample Ratio Mismatch](/static/images/using/srm-check-health-page.png)</Frame>
</MaxWidthImage>
...
<MaxWidthImage caption="Example Custom Report">
  <Frame>![Example Custom Reports](/static/images/reports-share-report.webp)</Frame>
</MaxWidthImage>
