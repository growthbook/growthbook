...
<Frame>![Configuring Bandit Hash Attributes and Number of Variations](/static/images/bandits/bandit-config-1.png)</Frame>
</MaxWidthImage>
...
<MaxWidthImage border>
  <Frame>![Configuring Bandit Decision Metric and Exploration Window](/static/images/bandits/bandit-config-2.png)</Frame>
</MaxWidthImage>
...
<MaxWidthImage border>
  <Frame>![Linking Bandit Changes](/static/images/bandits/bandit-config-3.png)</Frame>
</MaxWidthImage>
