...
<MaxWidthImage border>
  <Frame>![Bandit Leaderboard](/static/images/bandits/bandit_leaderboard_1.png)</Frame>
</MaxWidthImage>
...
<MaxWidthImage border maxWidth={600}>
  <Frame>![The leaderboard with a winner](/static/images/bandits/leaderboard-winner.png)</Frame>
</MaxWidthImage>
...
<MaxWidthImage maxWidth={600} border>
  <Frame>![Cumulative means](/static/images/bandits/cumulative_means.png)</Frame>
</MaxWidthImage>
...
<MaxWidthImage maxWidth={600} border>
  <Frame>![Probability of winning](/static/images/bandits/prob_of_winning.png)</Frame>
</MaxWidthImage>
...
<MaxWidthImage border>
  <Frame>![Variation weights](/static/images/bandits/variation_weights.png)</Frame>
</MaxWidthImage>
