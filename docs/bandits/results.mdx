...
description: Read bandit results in GrowthBook, including the leaderboard, traffic allocation, credible intervals, and when a variation is marked the winner.
---
...
<Frame>
  <img src="/static/images/bandits/bandit_leaderboard_1.png" alt="Bandit Leaderboard" width="800" />
</Frame>
...
<Frame>
  <img src="/static/images/bandits/leaderboard-winner.png" alt="The leaderboard with a winner" width="600" />
</Frame>
...
<Frame>
  <img src="/static/images/bandits/cumulative_means.png" alt="Cumulative means" width="600" />
</Frame>
...
<Frame>
  <img src="/static/images/bandits/prob_of_winning.png" alt="Probability of winning" width="600" />
</Frame>
...
<Frame>
  <img src="/static/images/bandits/variation_weights.png" alt="Variation weights" width="800" />
</Frame>
...
Sticky bucketing helps avoid multiple exposures, which can cause bias in the results as well as inconsistent user experiences. Evidence of multiple exposures likely indicates that your Sticky Bucketing is not set up at the same level as your randomization attribute for the Bandit. For more on this topic, see the section on [correctly set up sticky bucketing](/bandits/config#3-enable-or-disable-sticky-bucketing).
