...
- An **SDK that supports contextual bandits** — version 1.7.0+ of the JavaScript, React, or Node.js SDK, 3.1.0+ of the Python SDK, 0.5.0+ of the Go SDK, 8.0.0+ of the Kotlin (Android) SDK, or 1.2.3+ of the Swift (iOS) SDK.
