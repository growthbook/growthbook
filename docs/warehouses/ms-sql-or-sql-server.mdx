...
description: Connect SQL Server to GrowthBook with a read-only login, allowlist the Cloud IP if needed, and enter server, port, encryption, and timeout settings.
