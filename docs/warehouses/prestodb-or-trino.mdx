...
description: Connect PrestoDB or Trino to GrowthBook with host, port, catalog, schema, and a read-only user.
...
See the [presto-client npm package](https://www.npmjs.com/package/presto-client).
