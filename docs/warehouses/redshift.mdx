---
title: Setting Up Amazon Redshift as a Data Source
description: Connect Amazon Redshift to GrowthBook with a read-only user, security group access for the Cloud IP, and connection details.
...
<Frame>
  <img src="/static/images/guides/redshift-details.png" alt="Redshift details" width="800" />
</Frame>
...
7. Edit **Inbound Rules**:
   - Protocol: TCP
   - Port: 5439
   - Source: 52.70.79.40/32 ([GrowthBook Cloud's outbound IP](/ip-addresses))
8. Click **Save Changes**.

<Frame>
  <img src="/static/images/guides/redshift-inbound-rules.png" alt="Redshift Inbound Rules" width="800" />
</Frame>
