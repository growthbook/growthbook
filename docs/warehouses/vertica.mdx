...
og:description: This document outlines the steps needed to configure Vertica as a data source in GrowthBook.
...
<MaxWidthImage maxWidth={600} border>
  <Frame>![Vertica warehouse connection](/static/images/vertica.png)</Frame>
</MaxWidthImage>
