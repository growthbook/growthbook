...
description: Connect Databricks to GrowthBook with a SQL warehouse host, HTTP path, and OAuth or token credentials.
...
<Frame>
  <img src="/static/images/guides/databricks-connection.png" alt="Finding SQL Warehouse Connection Details in Databricks" width="600" />
</Frame>
