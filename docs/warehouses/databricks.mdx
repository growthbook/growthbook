...
og:description: This document outlines the steps needed to add your Databricks database to GrowthBook.
...
<MaxWidthImage maxWidth={600} border>
  <Frame>![Finding SQL Warehouse Connection Details in Databricks](/static/images/guides/databricks-connection.png)</Frame>
</MaxWidthImage>
