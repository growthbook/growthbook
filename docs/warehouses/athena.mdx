...
og:description: This document outlines the steps needed to add your Athena database to GrowthBook.
sidebarTitle: Athena
slug: athena
---
...
<Frame>![Athena permissions](/static/images/guides/athena-permissions.png)</Frame>
</MaxWidthImage>
...
<MaxWidthImage>
<Frame>![Athena access keys](/static/images/guides/athena-keys1.png)</Frame>
</MaxWidthImage>
...
<Frame>![Extra Fields in Growthbook for setting up Athena](/static/images/guides/athena-extra-fields.png)</Frame>
</MaxWidthImage>
