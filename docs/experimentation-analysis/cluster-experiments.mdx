...
<MaxWidthImage>
<Frame>![Diagram illustrating cluster-level assignment and user-level analysis in a cluster experiment. Organizations are grouped into treatment (purple) and control (teal) clusters. Each organization (e.g., Organization A, B, C, D) nests multiple users (e.g., User A1, A2, A3). Arrows show the hierarchical relationship between clusters (organizations) and individual users, with assignment occurring at the cluster level and analysis performed at the user level.](/static/images/cluster-experiments/cluster-diagram.png)</Frame>
</MaxWidthImage>
...
<MaxWidthImage>
<Frame>![Fact Table example with organization and user ids, along with timestamp, event, and value columns](/static/images/cluster-experiments/cluster-fact-table.png)</Frame>
</MaxWidthImage>
...
<MaxWidthImage>
<Frame>![An example ratio fact metric with the sum of purchase values in the numerator and the distinct count of user ids in the denominator.](/static/images/cluster-experiments/cluster-metric.png)</Frame>
</MaxWidthImage>
...
<Frame>![Setting organization_id as the hash attribute.](/static/images/cluster-experiments/cluster-hash.png)</Frame>
</MaxWidthImage>
...
<MaxWidthImage border>
<Frame>![Configuring the Experiment Assignment Table](/static/images/cluster-experiments/cluster-query.png)</Frame>
</MaxWidthImage>
