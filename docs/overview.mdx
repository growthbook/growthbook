...
description: What is GrowthBook and how does it work? Learn about the GrowthBook platform and how it can help you grow your organization.
...
<Frame>![GrowthBook: How it Works Diagram](/static/images/feature-flagging-experimentation-diagram-766.png)</Frame>
...
<Frame>![Data warehouses supported by GrowthBook](/static/images/GrowthBook-supported-DB-766.png)</Frame>
...
- **Funnel** - The percentage of experiment units who complete a series of steps, with a per-step breakdown of where units drop off (e.g. `signup funnel conversion`).
