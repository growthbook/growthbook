---
title: "Design to Variant: Import from Figma or Image"
description: Turn a Figma frame or a mockup image into a testable A/B variation that GrowthBook rebuilds and injects into the live page.
