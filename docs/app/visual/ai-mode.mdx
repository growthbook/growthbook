...
description: Generate A/B test variations with natural language in the Visual Editor. Preview the proposed edits, then accept or change them.
...
<video autoPlay loop muted playsInline aria-label="Adding element context to a prompt" style={{width: '100%', height: "auto", aspectRatio: 1420/1080, border: "1px solid var(--color-border)"}} width={1420} height={1080}>
  <source src="/static/videos/ve-select-el-ai-mode.mp4" type="video/mp4" />
  Adding element context to a prompt.
</video>
