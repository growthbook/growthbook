...
<Frame>
  <img src="/static/images/visual-editor/ve-tree-selector.png" alt="The Visual Editor tree selector, showing the selected element's parents, the current node, its siblings, and children" width="340" />
</Frame>
