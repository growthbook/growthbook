...
<MaxWidthImage maxWidth={300}>
  <Frame>![The GrowthBook Visual Editor detailed selector](/static/images/visual-editor/ve-detailed-selector.png)</Frame>
</MaxWidthImage>
...
<div style={{display: 'flex', gap: '16px', flexWrap: 'wrap'}}>
  <MaxWidthImage maxWidth={300}>
    <Frame>![The GrowthBook Visual Editor HTML options](/static/images/visual-editor/ve-text-editor.png)</Frame>
  </MaxWidthImage>
  <MaxWidthImage maxWidth={300}>
    <Frame>![The GrowthBook Visual Editor HTML editor](/static/images/visual-editor/ve-text-editor-html.png)</Frame>
  </MaxWidthImage>
</div>
...
<MaxWidthImage maxWidth={400}>
  <Frame>![The GrowthBook Visual Editor Link Editor](/static/images/visual-editor/ve-link-editor.png)</Frame>
</MaxWidthImage>
...
<MaxWidthImage maxWidth={400}>
  <Frame>![The GrowthBook Visual Editor Class Editor](/static/images/visual-editor/ve-class-editor.png)</Frame>
</MaxWidthImage>
...
<MaxWidthImage maxWidth={400}>
  <Frame>![The GrowthBook Visual Editor Typography editor](/static/images/visual-editor/ve-typeography.png)</Frame>
</MaxWidthImage>
...
<MaxWidthImage maxWidth={400}>
  <Frame>![The GrowthBook Visual Editor Background and Border](/static/images/visual-editor/ve-background-borders.png)</Frame>
</MaxWidthImage>
...
<MaxWidthImage maxWidth={400}>
  <Frame>![The GrowthBook Visual Editor Background Images](/static/images/visual-editor/ve-background-image.png)</Frame>
</MaxWidthImage>
...
<MaxWidthImage maxWidth={400}>
  <Frame>![The GrowthBook Visual Editor Layout](/static/images/visual-editor/ve-layout.png)</Frame>
</MaxWidthImage>
