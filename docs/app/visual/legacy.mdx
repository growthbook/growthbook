---
title: Visual Editor (Legacy) — In-Page Overlay
og:description: Reference docs for the original GrowthBook Visual Editor — the in-page overlay UI used before the side-panel editor.
sidebarTitle: Legacy (in-page) editor
slug: /app/visual/legacy
---
...
<Note>
**You're reading the legacy docs**

This page documents the **original in-page overlay** Visual Editor. The current Visual Editor is a Chrome side panel — see [Visual Editor](/app/visual) for the up-to-date docs.

These docs are kept as a reference for users still on older versions of the GrowthBook DevTools extension, and for the support team.
...
<Warning>
**Visual Editor may not work optimally on client-side rendered apps**
...
<Note>
**URL Targeting is required for the Visual Editor to work**
...
<Tip>
**Simple URL targeting is recommended**
...
<Frame>![The Visual Editor UI](/static/images/visual-editor-ui.png)</Frame>
</MaxWidthImage>
...
<Frame>![Visual Editor Drag and Drop Handle](/static/images/visual-editor-move-handle.png)</Frame>
...
<MaxWidthImage>
<Frame>![Visual Editor Drag and Drop Example](/static/images/visual-editor-drag-and-drop.gif)</Frame>
</MaxWidthImage>
...
<MaxWidthImage maxWidth={400}>
<Frame>![Debug Panel](/static/images/visual-editor-debug-panel.png)</Frame>
</MaxWidthImage>
...
<Frame>![Enable the Visual Editor in your SDK Connection](/static/images/sdk-connection-visual-editor.png)</Frame>
</MaxWidthImage>
...
<Note>
**Updating your SDK configuration**
...
<Note>
**Drafts require turning on the "Include Drafts" toggle for your SDK Connection in GrowthBook.**
