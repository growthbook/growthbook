---
title: Holdouts
description: Hold a percentage of users out of new features so you can measure long-term impact against a true baseline.
slug: /app/holdouts
---
...
<Frame>![Add Holdout](/static/images/holdouts-add-modal.png)</Frame>
...
<Frame>![Add Holdout to an experiment](/static/images/holdouts-experiment-with-holdout.png)</Frame>
...
You can manage the full holdout lifecycle from the [REST API](/app/api):

- [Create a holdout](/api/Holdouts/operation/createHoldout), then [list holdouts](/api/Holdouts/operation/listHoldouts), [get a holdout](/api/Holdouts/operation/getHoldout), or [update a holdout](/api/Holdouts/operation/updateHoldout).
- [Start the Active Period](/api/Holdouts/operation/startHoldout) to begin holding users out of new features and experiments.
- [Start the Analysis Period](/api/Holdouts/operation/startHoldoutAnalysis) once you stop adding new experiments and are ready to measure.
- [Stop the holdout](/api/Holdouts/operation/stopHoldout) when the analysis is complete.
