...
- [Create a holdout](/api/Holdouts/operation/createHoldout), then [list](/api/Holdouts/operation/listHoldouts), [get](/api/Holdouts/operation/getHoldout), or [update](/api/Holdouts/operation/updateHoldout) existing holdouts.
