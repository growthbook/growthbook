...
Simply add `data-tracking="growthbook"` to your script tag to enable. This forwards experiment view events that already fired. It does not enroll users or evaluate Feature Flags.
