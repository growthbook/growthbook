...
description: Receive one webhook whenever any SDK Connection payload changes, instead of attaching a webhook to each connection.
sidebarTitle: Global SDK Webhooks
