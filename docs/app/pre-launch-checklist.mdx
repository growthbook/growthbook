---
title: Customizable Pre-Launch Checklist
og:description: Use GrowthBook's customizable pre-launch checklists to ensure all requirements are met before running an experiment. This guide explains how to create and manage these checklists.
slug: /app/pre-launch-checklist
sidebarTitle: Customizable Pre-Launch Checklists
---
...
<Frame>![The prelaunch checklist menu with text explaining how to add a new task](/static/images/prelaunch-checklist.png)</Frame>

<Tip>
**Why pre-launch checklists are important**
