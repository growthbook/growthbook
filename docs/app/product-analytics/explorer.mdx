---
title: Explorer
og:description: Build ad-hoc charts from your metrics, fact tables, and raw warehouse data. Use AI Chat or configure explorations manually.
...
<Frame>![Explorer with chart and configuration sidebar](/static/images/product-analytics/explorer-overview.png)</Frame>
</MaxWidthImage>
...
<Frame>![Row filters on a value card](/static/images/product-analytics/explorer-filter.png)</Frame>
</MaxWidthImage>
...
<MaxWidthImage maxWidth={1200} border>
<Frame>![AI Chat with conversation history and an embedded chart](/static/images/product-analytics/explorer-ai-chat.png)</Frame>
</MaxWidthImage>
