...
To manage these metrics as code, use the Fact Metrics REST API: [create a fact metric](/api/fact-metrics/operation/postFactMetric) or [list existing fact metrics](/api/fact-metrics/operation/listFactMetrics).
