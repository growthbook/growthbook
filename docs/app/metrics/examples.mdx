...
description: Examples of binomial, count, duration, and revenue metrics you can define on Fact Tables in GrowthBook.
sidebarTitle: Metric Examples and Use Cases
---

import {AddMetricButton} from "/snippets/AddMetricButton.jsx";
import {HostSelector} from "/snippets/HostSelector.jsx";
...
When creating metrics, you will almost always want to filter on the Event Type. To make this easier, you can edit the column representing Event Type and check the “Prompt metrics to filter on this column” box (after creating your Fact Table). This helps GrowthBook better streamline the UI when creating metrics.

<Frame>![Event Type Filter](/static/images/metrics/inline-filter.png)</Frame>
