...
- If you're using something other than GrowthBook for experiment assignment, there are many possible reasons for this issue:
  ...
  - A mistake in your Experiment Assignment Query that is returning the wrong `variation_id` or identifier type for a given experiment.
