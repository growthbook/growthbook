...
description: "Analyze A/B test results in GrowthBook: statistical analysis, health checks, custom reports, and how to interpret the data."
slug: /app/experiment-results
sidebarTitle: Understanding Experiment Results
---
...
<Frame>![Results Table (Frequentist)](/static/images/results-table-frequentist.png)</Frame>
...
<Frame>
  <img src="/static/images/experiment-results/metric-drilldown-overview.png" alt="Metric Drilldown modal - Overview tab" width="800" />
</Frame>

<Frame>
  <img src="/static/images/experiment-results/metric-drilldown-debug.png" alt="Metric Drilldown modal - Debug tab" width="800" />
</Frame>
...
<Frame>
  <img src="/static/images/experiment-date-results.png" alt="Experiment Date Results" width="600" />
</Frame>
...
The **Custom** group in the dimension selector lets you build a dimension without adding anything to your data source:

- **First exposed after...** splits units into two slices based on whether they were first exposed before or after a datetime you pick within the experiment phase.
- **Combination of dimensions...** breaks results down by the intersection of two Experiment or Unit Dimensions.

See [Custom dimensions](/app/dimensions#custom-dimensions) for details.
...
<Frame>![SRM Warning](/static/images/srm.png)</Frame>
...
<Frame>
  <img src="/static/images/health-tab.png" alt="Experiment Health Tab" width="800" />
</Frame>
...
If you want to refresh your dimension slices or change your dimension definitions, you should do so via the Data Source page for the related data source. See [experiment dimensions](/app/dimensions#experiment-dimensions).
...
<Frame>![Overflow menu with sharing options highlighted](/static/images/reports-share-menu.webp)</Frame>
...
<Frame>![Share experiment modal](/static/images/reports-share-modal.webp)</Frame>
...
<Frame>![Manage custom reports via the Results tab](/static/images/reports-list.webp)</Frame>
...
To pull results into your own dashboards or data pipeline instead of sharing them from the app, call the [Get results for an experiment](/api/experiments/operation/getExperimentResults) endpoint. It returns the latest analysis for the experiment, including per-variation metric results.
