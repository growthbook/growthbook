...
og:description: Learn how to analyze A/B test results, share insights, and make data-driven decisions. Includes statistical analysis, health checks, custom reports, and best practices for interpreting experiment data.
...
<MaxWidthImage maxWidth={800} border>
  <Frame>![Metric Drilldown modal - Overview tab](/static/images/experiment-results/metric-drilldown-overview.png)</Frame>
</MaxWidthImage>

<MaxWidthImage maxWidth={800} border>
  <Frame>![Metric Drilldown modal - Debug tab](/static/images/experiment-results/metric-drilldown-debug.png)</Frame>
</MaxWidthImage>
...
<MaxWidthImage border maxWidth={600}>
  <Frame>![Experiment Date Results](/static/images/experiment-date-results.png)</Frame>
</MaxWidthImage>
...
<MaxWidthImage>
  <Frame>![Experiment Health Tab](/static/images/health-tab.png)</Frame>
</MaxWidthImage>
