...
<MaxWidthImage maxWidth={600} border={true}>
  <Frame>![Example Decision Criteria](/static/images/experiment-decision-framework/decision-criteria.png)</Frame>
</MaxWidthImage>
...
<MaxWidthImage maxWidth={700} border={true}>
  <Frame>![Example Rendered Decision](/static/images/experiment-decision-framework/experiment-decision.png)</Frame>
</MaxWidthImage>
...
<MaxWidthImage maxWidth={700} border={true}>
  <Frame>![Experiment Decision Framework Organization Settings](/static/images/experiment-decision-framework/organization-settings.png)</Frame>
</MaxWidthImage>
...
<MaxWidthImage maxWidth={700} border={true}>
  <Frame>![Experiment Decision Framework Settings](/static/images/experiment-decision-framework/experiment-decision-framework-settings.png)</Frame>
</MaxWidthImage>
