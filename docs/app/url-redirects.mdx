...
description: A/B test alternate URLs without writing assignment code by serving redirects through the GrowthBook SDK.
...
### Node.js <Badge color="purple">BETA</Badge>
