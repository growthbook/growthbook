...
const config = {
  ...
  themeConfig:
    /** @type {import('@docusaurus/preset-classic').ThemeConfig} */
    {
      ...
      //   id: "announcement-bar",
      //   content:
      //     '<p>Office Hours: Live demo of GrowthBook's MCP server. <a href="https://us06web.zoom.us/webinar/register/8217678192715/WN_s9WmhALhTneHZyJFKs0jpg" target="_blank">Register Now →</a></p>',
