---
title: FAQ
description: Answers to common GrowthBook questions on experiment assignment, Cloud vs self-hosting, debugging SDKs, and analyzing results.
sidebarTitle: FAQ
slug: faq
---
...
You can now easily set up URL Redirect experiments within GrowthBook and customize navigation depending on your application. Read more about running a [URL Redirect experiment](/app/url-redirects).
...
GrowthBook only deals with aggregate data and the bulk of the processing is offloaded to your data source. Because of this, you can easily analyze terabytes of data from your laptop or a small container in the cloud.
...
- Make sure the S3 bucket is publicly accessible
...
![Setting to update experiment data refresh](/static/images/experiment-refresh.png)
...
<Note>
**Pipeline Mode writes to your data warehouse**
