...
og:description: GrowthBook's User & Team Permissions
...
<Frame>![Inviting members modal](/static/images/using/invite-member-modal.png)</Frame>
...
<Frame>![Environment Specific Limits](/static/images/user-permissions-env-specific.png)</Frame>
...
<Frame>![Self-registering and Automatic Approvals Toggle](/static/images/using/auto-approve-members.png)</Frame>
</MaxWidthImage>
...
|                                 | FeaturesBypassApprovals     | Bypass required approval checks for feature flag and saved group changes                                                                          | readData, manageFeatureDrafts, manageFeatures, canReview, bypassApprovalChecks |
