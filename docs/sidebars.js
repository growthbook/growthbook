    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          id: "lib/react",
          label: "React",
          className: "sidebar-icon-react",
        },
        {
          type: "doc",
          id: "lib/vue",
          label: "Vue.js",
          className: "sidebar-icon-vue",
        },
        {
          type: "doc",
          id: "lib/kotlin",
          label: "Kotlin (Android)",
          className: "sidebar-icon-kotlin",
        },
        {
          type: "doc",
          id: "lib/flutter",
          label: "Flutter",
          className: "sidebar-icon-flutter",
        },
        {
          type: "doc",
          id: "lib/swift",
          label: "Swift (iOS)",
          className: "sidebar-icon-swift",
        },
        {
          type: "doc",
          id: "lib/react-native",
          label: "React Native",
          className: "sidebar-icon-react-native",
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          id: "lib/edge/cloudflare",
          label: "Cloudflare Workers",
          className: "sidebar-icon-edge-cloudflare",
        },
        {
          type: "doc",
          id: "lib/edge/fastly",
          label: "Fastly Compute",
          className: "sidebar-icon-edge-fastly",
        },
        {
          type: "doc",
          id: "lib/edge/lambda",
          label: "Lambda@Edge",
          className: "sidebar-icon-edge-lambda",
        },
        {
          type: "doc",
          id: "lib/edge/other",
          label: "Other edge providers",
          className: "sidebar-icon-edge-other",
        },
      ],
    },
    { type: "doc", id: "lib/build-your-own", label: "Build Your Own" },
