...
If you would like to build feature rules around date and time, you need to do two things.
...
2). If you're using an SDK other than the JS or React SDKs, you will need to pass in a `current_datetime` attribute when setting attributes. This date needs to be a string in the simplified extended ISO format (ISO 8601).
...
**Note**: The timezone will be set automatically by your browser.
