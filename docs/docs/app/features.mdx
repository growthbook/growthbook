...
**Note**: The timezone displayed in the app is automatically set by your browser. The rules are evaluated independently of timezones. Meaning, if you want a feature flag enabled on 01/01/2023 at 11:59PM EST and someone in PST views your site at 11:30 PM PST, the feature will be enabled, since 11:30PM PST is after 11:59PM EST.
