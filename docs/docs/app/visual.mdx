...
If you have the `script-src` directive defined in your website's CSP, you'll need to enable `'unsafe-inline'` in order to leverage the Global JavaScript injection feature of the Visual Editor:
