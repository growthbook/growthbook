...
Visual editor features may not work optimally on client-side rendered apps (e.g., React.js, Vue.js). Consider using our [Feature Flags](/app/features) feature for smoother integration. Contact support for further assistance.
