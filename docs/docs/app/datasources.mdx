...
- **Experiment Duration** counts all conversions that happen between viewing the experiment the first time and the experiment end date. This model ignores metric conversion windows.
