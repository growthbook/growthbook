...
- **experimentId** - Either a specific experiment Key OR `%` if you should include all experiments
...
- Experiments
  ...
  - **Experiment Key Property** - The property name that stores the experiment tracking key
