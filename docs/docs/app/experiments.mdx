...
Currently, all analyses will use the "First Exposure" model by default. The _Experiment Duration_ model replaced _All Exposures_ as of GrowthBook 2.0. You can read more about why TODO BLOG POST.
