...
- get more units into the best variations, which can identify the best variation faster than in traditional experimentation
...
[Get started with our Bandit set-up guide!](/bandits/config#prerequisite)
...
Our Bandit uses Thompson sampling, a Bayesian algorithm that balances exploration and exploitation that is commonly used for Bandits in online experimentation.
...
2. **I usually use the frequentist engine, and I want to translate my frequentist p-value threshold into a success criteria for the Bayesian engine. What should I do?**<br />
