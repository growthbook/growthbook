...
<img src="/images/visual-editor/ve-select-el-ai-mode.gif" alt="Adding element context to a prompt" />
...
If a prompt needs a new image, AI mode opens the same upload/generate/library flow as [Manual mode → Images](/app/visual/images). See that page for models and reference-image support.
