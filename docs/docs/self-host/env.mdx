...
`/usr/local/src/experimentation-analysis/packages/back-end/uploads`. In production, you should mount a volume here to persist uploads across container restarts.
