...
When you have a license key, it should be set to the environment variable `LICENSE_KEY`. The key will be a long string, and should be set to the variable without any spaces or newlines.

## Enterprise SSO

To enable SSO on your self hosted GrowthBook instance, you will need a license key added to your environment variables, and then add
