...
If you want to use the AI features in GrowthBook, you will need to set the `OPENAI_API_KEY` environment variable to your
OpenAI API key. This is required for the AI features to work, such as generating experiment descriptions, checking
hypothesis validity, and detecting similar experiments. See more on the [AI Integrations page](/integrations/ai).
