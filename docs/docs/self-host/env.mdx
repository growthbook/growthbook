...
Some features in self-hosted GrowthBook are only available with an Enterprise license key. Reach out to [sales@growthbook.io](mailto:sales@growthbook.io) to learn more.
