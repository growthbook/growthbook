...
Only required if using Slack notification integrations. In your Slack app, add
`{APP_ORIGIN}/integrations/slack` as an OAuth redirect URL and enable Incoming
Webhooks.
