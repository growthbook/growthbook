...
Using Sticky Bucketing with our [HTML Script Tag](https://docs.growthbook.io/lib/script-tag) is simple. Simply add either of these properties to your script tag:

- `data-use-sticky-bucket-service="cookie"` or
- `data-use-sticky-bucket-service="localStorage"`

The sticky bucket assignments will be store in either Cookies or browser LocalStorage, respectively.
