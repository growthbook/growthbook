...
<div style={{"max-width": "500px", "margin": "auto"}}>
  <div style={{ "position": "relative", "padding-bottom": "56.25%", "height": 0, "max-height": "300px"}} >
    <iframe style={{"position": "absolute", "top": 0, "left": 0, width: "100%", "height": "100%"}} src="https://www.youtube.com/watch?v=8rvprlnFpbg" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
  </div>
</div>
