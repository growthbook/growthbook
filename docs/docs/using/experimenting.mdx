...
Amber indicates that your risk is between the two thresholds. Green indicates that risk is below the low-risk threshold, and it may be safe to call the experiment. You can use the dropdown to see the risk of choosing a different winner if you have multiple variations.
