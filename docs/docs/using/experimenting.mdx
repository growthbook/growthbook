...
<figure>
  <img src="/images/reports-share-report.webp" alt="Example Custom Report" style={{marginBlockEnd: 0}}/>
  <figcaption style={{textAlign: "center", fontSize: "small"}}>Example Custom Report</figcaption>
</figure>
