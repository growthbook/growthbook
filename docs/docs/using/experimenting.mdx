...
being worse- if there is a significant chance that the guardrail metric is worse, it will be shown in red,
...
Before you begin a test, you should have selected a primary metric or set of metrics that you are
trying to improve. These metrics are often called the OEC (Overall Evaluation Criterion). It is
...
to stop, and how to interpret results may not be straightforward.
...
make sure you haven’t broken anything on your product, you can use the risk or guardrail approach.
