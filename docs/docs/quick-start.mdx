...
## Step 2. [Feature Flags] Add an SDK endpoint
...
## Step 3. [Feature Flags] Integrate GrowthBook with your application
...
## Step 4. [Feature Flags] Add an additional event to track experimentation
...
## Step 5. [Feature Flags] Add attributes to GrowthBook
...
## Step 6. [Experiment Analysis] Connect to your data warehouse
...
## Step 7. [Experiment Analysis] Add a metric or two
...
You are now ready to create [features](/app/features) and [add experiment rules](/features/rules), or use the visual experiment editor.
