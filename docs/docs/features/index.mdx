...
You are able to require draft feature flags to undergo a review before publishing.
The only exception to this rule is if you are an admin, you can override the review process from the request review modal.

To set your organization to require reviews:

1. Go to [General Settings](/settings) in GrowthBook.
2. Under the Features section, toggle on **Require approval to publish changes**.
3. All draft features will now require a review before publishing.
