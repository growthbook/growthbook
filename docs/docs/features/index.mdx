...
1. Create an [SDK Connection](#sdk-connection) in GrowthBook
...
5. Learn about [Scheduling](/features/rules) features and different feature [Environments](/features/environments)
