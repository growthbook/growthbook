...
Approval flows can be enabled for your organization on the settings page. You are able to select the environments. If you woulld like all environments turned on you can leave the environments field blank.
If you would like to force reset the review when a change is made after it is approved toggle on the `Reset review on changes`
