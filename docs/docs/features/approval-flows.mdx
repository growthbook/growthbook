...
Approval flows can be enabled for your organization on the settings page. Once turned on, every role besides `Admin` will need to request approval for a feature flag.
