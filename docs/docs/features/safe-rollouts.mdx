---
title: Safe Rollouts
description: Releasing a new feature always carries risk. Even small changes can introduce regressions. Safe Rollouts reduce this risk by allowing you to gradually enable a feature while monitoring for issues.
---

import MaxWidthImage from "@site/src/components/MaxWidthImage";

Releasing a new feature always carries risk. Even small changes can introduce regressions. Safe Rollouts reduce this risk by allowing you to gradually enable a feature while monitoring for issues.
