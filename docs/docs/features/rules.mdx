...
form that will allow you to adjust user attributes and see in real time how the rules will be applied, and what value they'll get.
You can also expand the results to see more debug information about why each rule was or wasn't applied.
