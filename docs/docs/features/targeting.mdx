...
#### String Data Type: Versioning

In version 2.2, we introduced support for semantic version targeting. Using the string data type and defining a format, you can leverage semantic versioninng comparisons in your targeting definitions.

To create a version formatted string attribute, navigate to **SDK Configurations > Attributes** and either create or edit a String attribute. In the format dropdown, select: **Version string.**
