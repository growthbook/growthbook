...
- **Inline Saved Groups** - Define targeting rules and values directly in the GrowthBook UI. For example, you can make an `Admin` group and add the `userId` of all of your admins.
