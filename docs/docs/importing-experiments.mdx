...
If this is your first time importing any experiments, you need to [connect your data warehouse](/app/warehouses) and set up your [experiment assignment queries](/app/datasources#experiment-assignment-queries) which will tell GrowthBook where to find the experiment data.
