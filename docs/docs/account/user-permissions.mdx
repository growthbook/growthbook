...
| **Feature Flags, Configs, and Constants** | FlagsFullAccess             | Create, edit, review, publish, revert, and delete Feature Flags, Constants, and Configs                                                                                                                       | readData, createFlags, deleteFlags, editFlagDrafts, reviewFlags, publishFlags, revertFlags                                     |
|                                           | FlagsBypassApprovals        | Publish without the required draft review, force-merge an out-of-date draft, and unlock a locked Config. Applies to Feature Flags, Configs, and Constants. Does not bypass schema validation or custom hooks. | readData, bypassApprovalFlags                                                                                                  |
|                                           | ArchetypesFullAccess        | Create, edit, and delete saved User Archetypes for Feature Flag debugging                                                                                                                                     | readData, manageArchetype                                                                                                      |
| **Saved Groups**                          | SavedGroupsFullAccess       | Create, edit, review, publish, revert, and delete Saved Groups                                                                                                                                                | readData, createSavedGroups, deleteSavedGroups, editSavedGroupDrafts, reviewSavedGroups, publishSavedGroups, revertSavedGroups |
|                                           | SavedGroupsBypassApprovals  | Publish without the required draft review, and force-merge an out-of-date draft                                                                                                                               | readData, bypassApprovalSavedGroups                                                                                            |
...
|                                           | ManageOfficialResources     | Create, edit, and delete official resources. For example: Manage resources like Fact Tables, Metrics, Segments, etc that have been marked as 'Official'.                                                      | readData, manageOfficialResources, runQueries                                                                                  |
...
|                                           | CustomHooksFullAccess       | Create, edit, and delete custom hooks                                                                                                                                                                         | readData, manageCustomHooks                                                                                                    |

#### Composing a Policy

Some policies bundle several permissions. Expand one in the role editor to grant
only part of it — for example `editFlagDrafts` without `publishFlags`, so a role
can prepare changes but not put them in front of users.

| Permission                | Description                                                                                                                                                                                                   |
| ------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| createFlags               | Create new Feature Flags, Constants, and Configs (environment-scoped)                                                                                                                                         |
| deleteFlags               | Archive (environment-scoped) or delete Feature Flags, Constants, and Configs. Deleting is not environment-scoped — an archived flag already serves nowhere.                                                   |
| editFlagDrafts            | Create, edit, and discard drafts, and request review. Drafts reach no one until published.                                                                                                                    |
| reviewFlags               | Approve or request changes on revisions                                                                                                                                                                       |
| publishFlags              | Put changes in front of users: publish a revision, save directly, unarchive, or toggle an environment (environment-scoped)                                                                                    |
| revertFlags               | Revert to a previously published revision (environment-scoped)                                                                                                                                                |
| bypassApprovalFlags       | Publish without the required draft review, force-merge an out-of-date draft, and unlock a locked Config. Applies to Feature Flags, Configs, and Constants. Does not bypass schema validation or custom hooks. |
| manageArchetype           | Create, edit, and delete saved user archetypes                                                                                                                                                                |
| createSavedGroups         | Create new Saved Groups                                                                                                                                                                                       |
| deleteSavedGroups         | Archive or delete Saved Groups                                                                                                                                                                                |
| editSavedGroupDrafts      | Create, edit, and discard Saved Group drafts, and request review. Drafts reach no one until published.                                                                                                        |
| reviewSavedGroups         | Approve or request changes on revisions                                                                                                                                                                       |
| publishSavedGroups        | Put changes in front of users: publish a revision, save directly, or unarchive                                                                                                                                |
| revertSavedGroups         | Revert to a previously published revision                                                                                                                                                                     |
| bypassApprovalSavedGroups | Publish without the required draft review, and force-merge an out-of-date draft                                                                                                                               |
| bypassSavedGroupSizeLimit | Exceed the organization's size limits for a Saved Group                                                                                                                                                       |

Feature Flags, Configs, and Constants share one set of permissions. `createFlags`,
`deleteFlags`, `publishFlags`, and `revertFlags` are environment-scoped, so a role
restricted to specific environments holds them only there. Archiving is
environment-scoped; deleting an already-archived flag is not.
