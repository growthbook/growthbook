...
|                       | ManageOfficialResources    | Create, edit, and delete official resources. E.G Fact Tables, Metrics, Segments, etc that have been marked as 'Official'.                         | readData, createSegments, createMetrics, runQueries, manageFactTables, manageFactMetrics, manageFactFilters, createDimensions, manageOfficialResources | readData, createSegments, runQueries |
