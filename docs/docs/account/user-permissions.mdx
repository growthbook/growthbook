...
|                   | No Access (_Enterprise Only_) |    Read Only     |         Collaborator          |                   Engineer                    |                              Analyst                              |                           Experimenter                            |                               Admin                               |
| :---------------: | :---------------------------: | :--------------: | :---------------------------: | :-------------------------------------------: | :---------------------------------------------------------------: | :---------------------------------------------------------------: | :---------------------------------------------------------------: |
|   Feature Flags   |          Cannot View          |       View       |     View<br></br>Comment      | View<br></br>Comment<br></br>Add<br></br>Edit |                       View<br></br>Comment                        |           View<br></br>Comment<br></br>Add<br></br>Edit           |           View<br></br>Comment<br></br>Add<br></br>Edit           |
|    Experiments    |          Cannot View          |       View       |     View<br></br>Comment      |       View<br></br>Comment<br></br>Edit       | View<br></br>Comment<br></br>Add<br></br>Edit<br></br>Run Queries | View<br></br>Comment<br></br>Add<br></br>Edit<br></br>Run Queries | View<br></br>Comment<br></br>Add<br></br>Edit<br></br>Run Queries |
|      Metrics      |          Cannot View          |       View       |             View              |                     View                      |                   View<br></br>Add<br></br>Edit                   |                   View<br></br>Add<br></br>Edit                   |                   View<br></br>Add<br></br>Edit                   |
|    Dimensions     |          Cannot View          |       View       |             View              |                     View                      |                   View<br></br>Add<br></br>Edit                   |                   View<br></br>Add<br></br>Edit                   |                   View<br></br>Add<br></br>Edit                   |
|     Segments      |          Cannot View          |       View       |             View              |                     View                      |                   View<br></br>Add<br></br>Edit                   |                   View<br></br>Add<br></br>Edit                   |                   View<br></br>Add<br></br>Edit                   |
|    Datasources    |          Cannot View          |       View       |             View              |                     View                      |                               View                                |                               View                                |                   View<br></br>Add<br></br>Edit                   |
|       Ideas       |          Cannot View          |       View       | View<br></br>Add<br></br>Edit |         View<br></br>Add<br></br>Edit         |                   View<br></br>Add<br></br>Edit                   |                   View<br></br>Add<br></br>Edit                   |                   View<br></br>Add<br></br>Edit                   |
|  SDK Connections  |          Cannot View          | View<br></br>Add |       View<br></br>Add        |         View<br></br>Add<br></br>Edit         |                   View<br></br>Add<br></br>Edit                   |                   View<br></br>Add<br></br>Edit                   |                   View<br></br>Add<br></br>Edit                   |
|    Attributes     |          Cannot View          |       View       |             View              |         View<br></br>Add<br></br>Edit         |                               View                                |                   View<br></br>Add<br></br>Edit                   |                   View<br></br>Add<br></br>Edit                   |
|    Namespaces     |          Cannot View          |       View       |             View              |         View<br></br>Add<br></br>Edit         |                               View                                |                   View<br></br>Add<br></br>Edit                   |                   View<br></br>Add<br></br>Edit                   |
|   Environments    |          Cannot View          |       View       |             View              |         View<br></br>Add<br></br>Edit         |                               View                                |                   View<br></br>Add<br></br>Edit                   |                   View<br></br>Add<br></br>Edit                   |
|   Saved Groups    |          Cannot View          |       View       |             View              |         View<br></br>Add<br></br>Edit         |                               View                                |                   View<br></br>Add<br></br>Edit                   |                   View<br></br>Add<br></br>Edit                   |
|       Tags        |          Cannot View          |        -         |               -               |         View<br></br>Add<br></br>Edit         |                   View<br></br>Add<br></br>Edit                   |                   View<br></br>Add<br></br>Edit                   |                   View<br></br>Add<br></br>Edit                   |
| Slack Integration |          Cannot View          |        -         |               -               |                       -                       |                                 -                                 |                                 -                                 |                   View<br></br>Add<br></br>Edit                   |
|  Manage Projects  |          Cannot View          |        -         |               -               |                       -                       |                                 -                                 |                                 -                                 |                                Yes                                |
|    Manage Team    |          Cannot View          |        -         |               -               |                       -                       |                                 -                                 |                                 -                                 |                                Yes                                |
|    Manage Plan    |          Cannot View          |        -         |               -               |                       -                       |                                 -                                 |                                 -                                 |                                Yes                                |
|  Manage Billing   |          Cannot View          |        -         |               -               |                       -                       |                                 -                                 |                                 -                                 |                                Yes                                |
...
In the event you want to a user to have access to a subset of projects, you can give them a global role of `No Access` and then give project-specific permissions for the projects you want them to be able to view.
...
If you need to apply these rules to many users as once, you can create a Team with the permissions needed, and then add users to that team. But, keep in mind, the user's permissions will be a merger of their user permissions, and the permissions of any team their on, so after adding the user to a team, you may want to reduce their user-level permissions to ensure their previous user-level permissions don't override the permissions inherited by the team(s) they're on.

:::note

The `No Access` role is only available to organizations with an Enterprise account.
