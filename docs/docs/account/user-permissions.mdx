...
Within GrowthBook, not all resources are project-specific. For example, `Namespaces`, and `Presentations` all live at the organization level. This means that all users, regardless of role, will be able to view these resources.
