...
|                                 | ManageOfficialResources     | Create, edit, and delete official resources. E.G Fact Tables, Metrics, Segments, etc that have been marked as 'Official' via the UI.              | readData, runQueries, manageOfficialResources                                  |
