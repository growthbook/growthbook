---
title: How to Securely Connect Amazon Redshift to GrowthBook
...
This tutorial walks through focuses on Redshift Serverless, but the steps are similar for provisioned Redshift instances.
