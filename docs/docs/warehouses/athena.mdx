...
<img
  src="/images/guides/athena-permissions.png"
  alt="Athena permissions"
  style={{ margin: "0 auto" }}
/>
...
<img
  src="/images/guides/athena-keys1.png"
  alt="Athena permissions"
  style={{  margin: "0 auto" }}
/>
...
<img
  src="/images/guides/athena-extra-fields.png"
  alt="Extra Fields in Growthbook for setting up Athena"
  style={{  margin: "0 auto" }}
/>

`S3 Results URL` - This is the s3 URL where the results to Athena queries get saved. When setting up Athena for the S3 results url, we recommend naming your bucket with the prefix `aws-athena-query-results-`. If you have already set it up you can find it by clicking on the settings tab:

<img
  src="/images/guides/athena-results-url.png"
  alt="Athena S3 Results Url"
