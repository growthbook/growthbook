...
To **create visual experiments**, all you need is the following:

- The [GrowthBook Chrome Extension](https://chrome.google.com/webstore/detail/growthbook-devtools/opemhndcehfgipokneipaafbglcecjia) installed on your Chrome Browser.
...
Before you start your first experiment, you need to integrate GrowthBook into your website.
