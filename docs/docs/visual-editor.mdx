...
The Visual Editor may not work optimally on client-side rendered apps (e.g. React.js, Vue.js). Consider using [Feature Flags](/features) instead for smoother integration. Contact support@growthbook.io if you have any questions.
