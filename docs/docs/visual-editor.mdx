...
**The Visual Editor will still work as intended and save you changes.** However these warnings are to help alert you to issues that may occur when running the visual experiment for your customers.
...
This message is indicating that your GrowthBook SDK is working but not up todate. You may encounter unexpected behavior as a result.
...
The Visual Editor now comes with a Debug Panel to help diagnose any issues with your SDK configuration and URL Targeting rules. Use this to help diagnose your own errors, or provide a screenshot to support when reaching out to help provide context.
