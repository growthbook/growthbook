...
These [Agent Skills](/integrations/ai-agents/agent-skills) take an A/B test from idea to decision, all from your AI agent. Install the plugin and run [`/growthbook:setup`](/integrations/ai-agents/agent-skills#installation) first.
