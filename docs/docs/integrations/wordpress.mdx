...
### Step 2: Install the Headers and Footers Plugin

Install and activate the popular . This will let you easily add code snippets to your site. If you are comfortable editing your theme directly, you can skip this step.
...
The easiest way to do this is with the popular [Insert Headers and Footers Plugin](https://wordpress.org/plugins/.insert-headers-and-footers/) by WPCode. Install and activate this plugin.

After installing and activating the plugin, on the left-hand side of your dashboard, navigate to Code Snippets → Header & Footer.
