...
![Screenshot showing error rates between feature flag variations in DataDog's RUM interface](../../static/images/integrations/datadog/1-view-feature-flags-error-rates-in-data-dog.png)
