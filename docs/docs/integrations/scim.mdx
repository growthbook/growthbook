...
3. Here, you can select + Create your own application, add your name, and select the "Integrate any other application you don't find in the gallery (Non-gallery)" option.
...
::: note
Syncing groups is optional. When a group is synced with GrowthBook, it will create a team in your GrowthBook organization and add any members in the group to the team. This is handy as you can give a team a global role, and each user will inherti that role.
:::
...
If a user is a member of a group and the group is added to the Enterprise application in Entra, all members will be provisioned in Growthbook.
