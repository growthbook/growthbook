...
If self-hosting GrowthBook on a VPN or behind a firewall, you will need to make sure to whitelist Okta's IP addresses to ensure the SCIM API calls can hit GrowthBook's SCIM server.
...
5. Then, you can select **Automatic** provisioning before adding the Base URL and your OAUTH Bearer Token
