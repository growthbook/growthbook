...
[https://vercel.com/integrations/growthbook](https://vercel.com/integrations/growthbook)
...
<MaxWidthImage maxWidth={700} border>
  ![Add vercel integration](/images/integrations/vercel-add-integration.png)
</MaxWidthImage>
...
<MaxWidthImage maxWidth={400} border>
  ![Choose account](/images/integrations/vercel-choose-account.png)
</MaxWidthImage>

## 4. Choose which projects you want GrowthBook to be enabled for

<MaxWidthImage maxWidth={400} border>
  ![Choose project](/images/integrations/vercel-choose-project.png)
</MaxWidthImage>
...
<MaxWidthImage maxWidth={400} border>
  ![Add environments](/images/integrations/vercel-environments.png)
</MaxWidthImage>
...
<MaxWidthImage maxWidth={400} border>
  ![Configure button](/images/integrations/vercel-configure.png)
</MaxWidthImage>

You can also look at your keys from GrowthBook & Vercel:

GrowthBook Keys are located [here](https://app.growthbook.io/settings/keys)  
