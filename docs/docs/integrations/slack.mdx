...
Next step is to login to the GrowthBook app and visit the **Webhooks** tab under **Settionss**, also available [here](https://app.growthbook.io/settings/webhooks). You will need privileges to manage webhooks in order for this menu item to be available.
