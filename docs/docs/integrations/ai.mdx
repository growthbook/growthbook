...
Almost all prompts used in our AI integrations in GrowthBook can be adjusted from the AI settings page. You can customize the prompts to better suit your needs and the context of your experiment program.
...
3. **Configure GrowthBook**: In your GrowthBook settings, navigate to the AI settings tab and enable AI OpenAI integration, and add your API key and configure any additional prompts as desired.
