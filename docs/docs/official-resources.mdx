...
At this time, only `Legacy Metrics` and `Fact Metrics` can be marked or unmarked as "Official" in the app. We are actively working on adding this feature to other resource types.
