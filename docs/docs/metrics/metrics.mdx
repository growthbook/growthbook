...
6. If there are custom slices you want run for a single experiment (e.g., "For this experiment, I want to see how treatment will affect apparel revenue in EU"), please continue reading, otherwise, skip to the next step.  
   ...
   Finally, custom slices can be created using any string column in your Fact Table that is not an identifier; they are not limited to just the auto-slices columns.
