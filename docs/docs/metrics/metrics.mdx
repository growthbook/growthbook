...
Custom slices can be created using any string or boolean column in your Fact Table which is not an identifier; custom slicing is not limited to auto-slices columns.
