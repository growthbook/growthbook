...
Fact Tables work great for raw event streams, modeled tables, and pre-aggregated tables. Check out [Metric Examples and Use Cases](/app/metrics/examples) for more info on supporting these different data schemas.
