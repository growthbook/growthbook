...
GrowthBook is a modular platform, and you can use any custom assignment code, or other experimentation system to do the
randomization and assignment of users into a variation. As long as the exposure/assignment information is available from
