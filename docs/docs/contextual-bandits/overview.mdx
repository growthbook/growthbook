...
[Get started with our Contextual Bandit setup guide!](/contextual-bandits/config)
...
See [Setting up a Contextual Bandit](/contextual-bandits/config) for the full walkthrough, or [Driving a Contextual Bandit via API](/contextual-bandits/contextual-bandit-via-api) to run the entire lifecycle from the REST API.
