...
the signature is a HMAC SHA-256 hash of the payload using the secret as the key. the secret is the secret key that is generated when you create a webhook. you can find the secret key in the GrowthBook app under SDK Connections.
