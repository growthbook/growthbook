...
You can use SQL template variables in dimension queries just like you can with metrics. See the [SQL Template Variables](/experimentation-analysis/metrics#sql-template-variables) page for more details.
