...
description: Learn about GrowthBook Cloud's Managed ClickHouse service
sidebar_label: Managed ClickHouse
slug: /app/managed-clickhouse
---

# Managed ClickHouse

GrowthBook Cloud offers a fully managed ClickHouse database and event tracking pipeline. This is primarily intended for users who want to use GrowthBook's experimentation and analysis features without needing to set up their own data warehouse.
...
There are 2 ways to send events to GrowthBook Cloud's Managed ClickHouse:
