...
Each data point in the time series represents the cumulative results of the experiment as of a historical experiment update. There will be as many data points as there have been experiment updates, although we do some coarsening to one result per day when there are multiple results per day and many days in the experiment.
