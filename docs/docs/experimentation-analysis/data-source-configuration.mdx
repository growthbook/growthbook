...
- **camelcase** - ex. `{{camelcase "My database"}}` compiles to `myDatabase`.
- **dotcase** - ex. `{{dotcase "My database"}}` compiles to `my.database`.
- **kebabcase** - ex. `{{kebabcase "My database"}}` compiles to `my-database`.
- **lowercase** - ex. `{{lowercase "My database"}}` compiles to `my database`.
- **pascalcase** - ex. `{{pascalcase "My database"}}` compiles to `MyDatabase`.
- **uppercase** - ex. `{{uppercase "My database"}}` compiles to `MY DATABASE`.
  <a id="dateformat"/>
