...
(We have a complete guide on how to do this here: [Setting up BigQuery as a data source](/experimentation-analysis/connecting-to-your-data-warehouse/bigquery))
