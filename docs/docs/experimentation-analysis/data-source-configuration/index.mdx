...
- [Amplitude](/experimentation-analysis/data-source-configuration/amplitude)
- [CleverTap](/experimentation-analysis/data-source-configuration/clevertap)
- [Firebase](/experimentation-analysis/data-source-configuration/firebase)
- [Freshpaint](/experimentation-analysis/data-source-configuration/freshpaint)
- [Fullstory](/experimentation-analysis/data-source-configuration/fullstory)
- [Google Analytics 4 (BigQuery only)](/experimentation-analysis/data-source-configuration/GA4-google-analytics)
- [Heap Analytics](/experimentation-analysis/data-source-configuration/heap)
- [Jitsu](/experimentation-analysis/data-source-configuration/jitsu)
- [Keen IO](/experimentation-analysis/data-source-configuration/keenio)
- [Matomo](/experimentation-analysis/data-source-configuration/matomo)
- [Mixpanel](/experimentation-analysis/data-source-configuration/mixpanel)
- [MParticle](/experimentation-analysis/data-source-configuration/mparticle)
- [RudderStack](/experimentation-analysis/data-source-configuration/rudderstack)
- [Segment](/experimentation-analysis/data-source-configuration/segment)
- [Snowplow](/experimentation-analysis/data-source-configuration/snowplow)

If you do not use any of those you choose [Custom Data Source](/experimentation-analysis/data-source-configuration/custom) and define some of the sql yourself.
