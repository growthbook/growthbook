...
Managed Warehouse pricing is based on your GrowthBook plan:

| Plan         | Included events/month | Overage rate       |
| ------------ | --------------------- | ------------------ |
| **Starter**  | 1 million             | $0.03 per 1K events |
| **Pro**      | 2 million             | $0.03 per 1K events |
| **Enterprise** | Custom              | Custom             |

If you bring your own warehouse instead, there are no managed warehouse charges from GrowthBook. You only pay your warehouse provider directly.

## FAQ

### Can I use the Managed Warehouse alongside my own warehouse?

Yes. You can add a separate data source for your own warehouse at any time and use both simultaneously.
...
You'll see a notification in GrowthBook when you're approaching your limit. Overage events are charged at the rate shown in [Pricing](#pricing). You can upgrade your plan or contact us for custom volume pricing.
