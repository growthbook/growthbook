...
First, you have to write SQL that transforms your event data into a format that GrowthBook understands. We expect you to have a few pre-defined columns with specific names, but you can select as many additional columns as you need to build out metrics.
...
The only required columns you must select are:
