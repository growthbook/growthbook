...
relative percent change; you can reduce variance (via [CUPED](/experimentation-analysis/statistics/cuped)) and you can enable
[sequential testing](/experimentation-analysis/statistics/sequential) to mitigate concerns with peeking.
