...
GrowthBook Cloud offers a fully managed event ingestion pipeline. Use our SDKs to track events in your app and we will enrich and forward them to your data warehouse in near real-time.
...
There are 2 ways to send events to GrowthBook Cloud:
