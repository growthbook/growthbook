...
See the [GrowthBook CLI](/tools/cli) documentation for more information on generating type definitions and [JavaScript &rarr; TypeScript &rarr; Script Typing](/lib/js#strict-typing) for how to use them.
