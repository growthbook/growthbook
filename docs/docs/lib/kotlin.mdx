...
dependencies {
    implementation 'io.growthbook.sdk:GrowthBook:1.1.34'
}
```
...
In 1.1.34 version of the library named parameters for GBSDKBuilder are available.
