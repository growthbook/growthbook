...
- You can see an [example features JSON here](/experimentation-analysis/api#the-sdk-endpoint)
...
As of version 0.3.0, the Java SDK supports decrypting encrypted features. You can learn more about [SDK Connection Endpoint Encryption](/experimentation-analysis/api#encryption).
