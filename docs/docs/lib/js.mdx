...
The JS SDK contains a built-in method `setEncryptedFeatures` that makes decrypting simple. Note: If you're in a NodeJS environment, you will need to pass in a SubtleCrpyto implementation as the 3rd argument when calling this method.
