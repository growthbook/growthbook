...
fetch("https://cdn.growthbook.io/api/features/<your api key>")
  .then((res) => res.json())
  .then((json) => growthbook.setEncryptedFeatures(json.encryptedFeatures, <your encryption key>))
...
growthbook.setEncryptedFeatures(encryptedString, encryptionKey, subtle);
  ...
  fetch("https://cdn.growthbook.io/api/features/<your api key>")
    .then((res) => res.json())
    .then((json) => growthbook.setEncryptedFeatures(json.encryptedFeatures, <your encryption key>, subtle))
    .catch((e) => console.log("Failed to set GrowthBook feature definitions", e));
```
