...
- **v0.7.1** 2025-02-13
  - New test cases for pre-requisite edge cases
  - Add feature rule id to `FeatureResult` object and updated test cases
  - New test case to make sure only known properties are copied from feature rules to experiments
