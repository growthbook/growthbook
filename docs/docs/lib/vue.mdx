...
You likely already know which API your Vue app uses, but if you aren't sure, you can use the following guidelines to help you choose an implementation:

- If you're using Vue 3, go with the [Vue 3 Composition](#vue-3--composition-api) example
- If you're using Vue 2.6, go with the [Vue 2 Options](#vue-2--options-api) example
- If you're using Vue 2.7, find out if your application supports the composition API. In either case, you could opt for either implementation.
