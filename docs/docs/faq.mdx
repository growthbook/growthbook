...
## How can I tell which version of GrowthBook I'm running?

Sometimes for debugging we'll ask which version of GrowthBook you're using. When you're logged in to GrowthBook, you can head to [app.growthbook.io](https://app.growthbook.io) and check the lower left corner to see "Build:" and the date of your version.
