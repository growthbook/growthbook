...
You can download this from PyPI [here](https://pypi.org/project/gbstats/0.4.0/) using `pip install gbstats==0.4.0` and ensure that your kernel uses that version of `gbstats`.
