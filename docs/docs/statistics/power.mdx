...
Each engine arrives at these values differently. Below we describe high-level technical details of our implementation. All technical details for can be found [here](/statistics/power-technical).
