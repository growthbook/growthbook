...
Sequential testing provides estimators for the second option; it allows us peeking at your results without fear of inflating the false positive rate beyond your specified $alpha$.
