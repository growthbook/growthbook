...
If the metric is analyzed with regression adjustment, you will additionally see the following fields:

- `covariate_metric_type` - the metric type of the main metric
- `covariate_sum` - the summed value of the user-level metric in the pre-exposure period
- `covriate_sum_squares` - the sum of the squared values of the user-level metric in the pre-exposure period
- `main_covariate_sum_product` - the sum of the product of the user-level main metric and pre-exposure main metric
