...
<MaxWidthImage maxWidth={800}>
  ![Experiment Results with CUPED toggle](/images/statistics/cuped-results.png)
</MaxWidthImage>
...
<MaxWidthImage maxWidth={300} border>
  ![Metric Icon showing CUPED Disabled Reason](/images/statistics/cuped-icon.png)
</MaxWidthImage>

If you mouse over the metric name itself, you get the final CUPED status for each metric (on/off, number of lookback days).

<MaxWidthImage maxWidth={300} border>
  ![Metric Tooltip with CUPED status](/images/statistics/cuped-tooltip.png)
</MaxWidthImage>
