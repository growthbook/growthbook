...
When creating your experiment, most of the fields are the same as those described in [setup of a standard A/B test](/app/experiments-setup). We list key differences below.
