...
- Set up [webhooks](/app/webhooks) to keep a cached copy of features in your database
- Use the [useFeature](/lib/react#usefeature-hook) React hook for more control in your code
