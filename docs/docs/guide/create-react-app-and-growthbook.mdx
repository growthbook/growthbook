...
trackingCallback in `src/index.js`, instead of doing a `console.log`, you could use [Mixpanel](/experimentation-analysis/connecting-to-your-data-warehouse/mixpanel), Rudderstack, Jitsu,
...
- Read about the [powerful statistics engine](/experimentation-analysis/statistics/overview) that is used to analyze experiment results.
