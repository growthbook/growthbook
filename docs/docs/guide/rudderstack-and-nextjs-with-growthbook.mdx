...
about how to connect to your data destination [here](/experimentation-analysis/data-source-configuration/rudderstack).
...
Once you have data flowing into Rudderstack, you can set it up to work with GrowthBook by following the [Rudderstack guide](/experimentation-analysis/data-source-configuration/rudderstack)
