...
about how to connect to your data destination [here](/app/event-trackers/rudderstack).
...
Once you have data flowing into Rudderstack, you can set it up to work with GrowthBook by following the [Rudderstack guide](/app/event-trackers/rudderstack)
