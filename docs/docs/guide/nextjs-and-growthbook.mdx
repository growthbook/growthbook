...
Note: If you are using the newer Next.js App Router instead, check out our [Example App](https://github.com/growthbook/examples/tree/main/next-js).
...
For Server components, you'll need to use the [Growthbook JS SDK](/lib/js).
