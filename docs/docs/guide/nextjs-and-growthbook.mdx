...
This document is a guide on how to add GrowthBook feature flags to your Next.js application. It assumes you are starting from scratch, so if you already have a NextJS application, you can skip to step 2.
...
<iframe
  ...
  title="Feature flagging and A/B testing with NextJS and GrowthBook"
  frameborder="0"
