...
From the Analysis -> Data source section of the GrowthBook Platform, you can add a data source, and then choose Mixpanel avaliable options.
...
With that selected, you'll be asked to enter your Mixpanel connection information:
