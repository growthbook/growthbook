...
<img
  src="/images/guides/bigquery-7-addtogb.png"
...
<img
  src="/images/guides/bigquery-9-import-datastructure.png"
  alt="Import from known event sources"
  style={{ width: 450, margin: "0 auto" }}
/>

This will pre-populate the experiment exposure query which is need to determine which user saw which experiment
