...
# URL Redirect Testing <Pill>new</Pill>
...
URL Redirect tests require you to integrate one of our [SDKs](/lib) into your application. Currently, URL Redirect tests are only supported in our [Script Tag](/lib/script-tag), [Javascript/NodeJS](/lib/js), and [ReactJS](/lib/js) SDKs. Support for other SDKs are coming soon.
