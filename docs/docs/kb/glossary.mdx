...
[Forced Value](/features/rules#forced-value): A Forced Value in GrowthBook is a type of override rule that assigns a specific value to a feature for a subset of users based on targeting attributes, useful for testing or targeting specific user groups.
