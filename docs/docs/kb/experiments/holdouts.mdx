...
Now, for any future feature or experiment, you can add the "Global Holdout Q1 2024" feature as a [prerequisite](/features/prerequisites) to hold out the **`holdout control`** group. This can be done in one of two ways.
