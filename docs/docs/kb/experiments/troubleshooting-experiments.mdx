...
2. **The Hash Attribute doesn't match the "Identifier Type" in your data source.**
3. **You made a change to the experiment targeting after it started, or created a new phase without re-randomizing.**
...
### Solution 2: Ensure the Hash Attribute and Identifier Type match
...
### Solution 3: Minimize Experiment targeting changes while running
