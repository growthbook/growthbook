...
You can schedule this rule to be enabled or disabled at a specific time. You can read more about scheduling [here](/features/scheduling).
...
a link to view experiment results on the bottom of each experiment override rule. Read more about [experiment results](app/experiments#experiment-results-table-bayesian-engine).
