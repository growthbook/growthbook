...
Before you can use namespaces, you must configure them under _Experimentation → Namespaces_. It's essential to ensure that all experiments within a given namespace use the same hash attribute (assignment attribute).
