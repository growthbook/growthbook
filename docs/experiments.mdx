...
og:description: Understanding the ways to run experiments with GrowthBook
...
<a href="/static/open-guide-to-ab-testing.v1.0.pdf" target="_blank" className="btn btn-primary border-0 hover:border-b-0" style={{margin: "-20px 0 -5px 20px", float: "right"}}>
  <Frame>
