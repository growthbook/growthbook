...
description: Run A/B tests with feature flags, the Visual Editor, URL redirects, or your own assignment, then analyze results in GrowthBook.
sidebarTitle: Running Experiments
slug: experiments
---
...
development and web applications to test and measure the impact of any code changes or new features. The changes may impact
...
GrowthBook's SDKs work well with anywhere code can run, and as such you can use it in the API or when running machine
...
<Tip>
**Get our official guide to A/B Testing**

<a href="/static/open-guide-to-ab-testing.v1.0.pdf" target="_blank" class="btn btn-primary" style={{margin: "-20px 0 -5px 20px", float: "right"}}>
  <img src="/static/images/guides/open-guide-to-ab-testing.png" alt="open guide book" style={{width:"200px"}} />
</a>

This is a subset of some of the information you can find about running experiments in our [Open Guide to AB Testing](/static/open-guide-to-ab-testing.v1.0.pdf).
...
We suggest that you first run an A/A test to validate your experimentation implementation is correctly splitting traffic, and
...
experiment unchanged for the duration, and this may limit your team's velocity towards potentially higher
impact changes.
...
may interact and affect the other results. For example you may want to test a change in the CTA
