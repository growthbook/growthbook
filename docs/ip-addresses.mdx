...
<Warning>
Do not build this list from the addresses in your warehouse's error messages. Each rejected connection reveals only the single address that attempted it, so you will always be one failure behind a complete list.
</Warning>
