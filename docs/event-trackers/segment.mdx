...
og:description: This document outlines the steps needed to add your Segment to GrowthBook.
...
<MaxWidthImage maxWidth={500}>
  <Frame>![Choose Segment data schema](/static/images/new-data-sources-modal.png)</Frame>
</MaxWidthImage>
...
<MaxWidthImage maxWidth={500}>
  <Frame>![Edit metrics modal](/static/images/guides/metrics-addmetric.png)</Frame>
</MaxWidthImage>
