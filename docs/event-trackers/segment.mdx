...
description: Send experiment exposure through Segment, land events in a warehouse, then connect that warehouse to GrowthBook.
...
<Frame>
  <img src="/static/images/new-data-sources-modal.png" alt="Choose Segment data schema" width="500" />
</Frame>
...
will automatically create the experiment exposure query which is needed to determine which user saw which experiment variation.
...
<Frame>
  <img src="/static/images/guides/metrics-addmetric.png" alt="Edit metrics modal" width="500" />
</Frame>

<Frame>![Metrics overview in GrowthBook](/static/images/guides/metrics-metricoverview.png)</Frame>
