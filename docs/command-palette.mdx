...
description: Open the GrowthBook command palette with Cmd+K or Ctrl+K to jump to features, experiments, metrics, docs, or API endpoints.
...
<Frame>
  <img src="/static/images/command-palette/command-palette-light.png" alt="GrowthBook command palette open with a query and grouped results across pages, features, experiments, and metrics" width="800" />
</Frame>
