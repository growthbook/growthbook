...
When running the [official MCP Docker image](/integrations/mcp#option-b-official-docker-image-http--oauth) against your API, set `OAUTH_AS_ENABLED=1` on the API so clients can complete the OAuth consent flow.
