...
When using GrowthBook in production, it is important to change the
  ...
  <code>NODE_ENV</code> to "production" and change the
...
then you may add the SSO settings for your provider. You can find the instructions on how to set up SSO for GrowthBook
