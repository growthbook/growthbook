---
title: FerretDB
description: Run GrowthBook on FerretDB instead of MongoDB for a fully open-source, Postgres-backed document store.
---
...
Follow the [FerretDB installation guide](https://docs.ferretdb.io/installation/ferretdb/docker/) to install FerretDB. Make sure your FerretDB instance is running and accessible before proceeding.
