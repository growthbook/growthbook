---
title: Using a CDN
description: Put a CDN in front of the GrowthBook features API to cache SDK payloads and scale flag delivery.
sidebarTitle: Using a CDN
slug: cdn
---
...
When you make changes within GrowthBook, the CDN will not pick up the changes until it refreshes its cache (default 30 seconds).
