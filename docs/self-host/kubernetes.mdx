...
description: Deploy GrowthBook on Kubernetes with the sample manifests for the app, API, MongoDB, and optional proxy.
sidebarTitle: Deploying with Kubernetes
---
