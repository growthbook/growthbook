---
title: Ruby
description: Install the GrowthBook Ruby SDK to evaluate feature flags and run A/B tests in Ruby and Rails apps, including targeting and tracking callbacks.
sidebarTitle: Ruby
slug: ruby
---
