---
title: Go SDK
description: Install the GrowthBook Go SDK to evaluate feature flags and run A/B tests in Go services, including targeting attributes and tracking callbacks.
sidebarTitle: Go
slug: go
