---
title: Kotlin (JVM)
description: Install the GrowthBook Kotlin JVM SDK to evaluate feature flags and run A/B tests in Kotlin backend services and workers.
sidebarTitle: Kotlin (JVM)
slug: kotlin-jvm
---
...
- [GrowthBook API Reference](/api/introduction) - REST API documentation
