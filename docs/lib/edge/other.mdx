---
title: "GrowthBook Edge App for other providers"
description: Use the GrowthBook Edge App pattern on other CDN or edge providers to evaluate flags and rewrite HTML before it reaches the browser.
sidebarTitle: Other edge providers
slug: other
...
```bash Yarn
yarn add --save @growthbook/edge-utils
```

```bash pnpm
pnpm add --save @growthbook/edge-utils
```
