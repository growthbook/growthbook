---
title: Rust SDK
description: Install the GrowthBook Rust SDK to evaluate feature flags and run A/B tests in Rust applications, including targeting attributes and tracking callbacks.
sidebarTitle: Rust
slug: rust
