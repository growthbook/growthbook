---
title: "C#"
description: Install the GrowthBook C# SDK to evaluate feature flags and run A/B tests in .NET applications, including targeting attributes and tracking callbacks.
sidebarTitle: C#
slug: csharp
---
