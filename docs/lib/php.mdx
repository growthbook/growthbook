---
title: PHP SDK
description: Install the GrowthBook PHP SDK to evaluate feature flags and run A/B tests in PHP applications, including targeting attributes and tracking callbacks.
sidebarTitle: PHP
slug: php
---
