...
description: Point GrowthBook at your warehouse with a read-only user so experiment analysis runs where your events already live.
...
Try our [Managed Warehouse](/app/managed-warehouse). One-click setup, built-in event tracking, and auto-created metrics. No infrastructure setup required.
