---
title: GrowthBook and Google BigQuery (BQ)
description: Fix common BigQuery issues when GrowthBook queries GA4 or other event tables, including permissions and missing datasets.
sidebarTitle: BigQuery Troubleshooting
