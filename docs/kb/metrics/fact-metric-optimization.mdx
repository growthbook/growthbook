...
<Frame>![Analysis Without Fact Tables](/static/images/metrics/fact-metric-before-optimization.png)</Frame>
</MaxWidthImage>
...
<MaxWidthImage maxWidth={650}>
<Frame>![Analysis With Fact Tables](/static/images/metrics/fact-metric-after-optimization.png)</Frame>
</MaxWidthImage>
