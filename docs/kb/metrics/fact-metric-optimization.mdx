...
description: How Fact Tables cut warehouse scan costs by computing multiple experiment metrics from one shared table instead of one query per metric.
---
...
<Frame>
  <img src="/static/images/metrics/fact-metric-before-optimization.png" alt="Analysis Without Fact Tables" width="650" />
</Frame>
...
<Frame>
  <img src="/static/images/metrics/fact-metric-after-optimization.png" alt="Analysis With Fact Tables" width="650" />
</Frame>
