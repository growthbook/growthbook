...
description: What carryover bias is, why restarting an experiment without re-randomizing contaminates later results, and how to avoid it in GrowthBook.
sidebarTitle: Carryover Bias
slug: carryover-bias
---
...
Then, your experiment has 150 users in A and 110 users in B! This imbalance is caused because the effects of the first phase of the experiment are _carrying over_ to the second phase of the experiment.
