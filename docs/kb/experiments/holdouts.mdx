...
sidebarTitle: Holdout Experiments
slug: holdouts
description: Measure the long-term impact of shipped features with holdout experiments that keep a control group from receiving new functionality.
---
