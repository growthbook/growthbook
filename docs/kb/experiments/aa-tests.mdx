...
description: Run an A/A test in GrowthBook to validate SDK integration, traffic splitting, and metric definitions before a real A/B test.
sidebarTitle: A/A Testing
slug: aa-tests
---
...
<Frame>![A/A Feature Rule](/static/images/aa-feature-rule.png)</Frame>
...
<Frame>![New Phase](/static/images/new-phase.png)</Frame>
<Frame>![New Phase, Re-Randomize](/static/images/new-phase-rerandomize.png)</Frame>
