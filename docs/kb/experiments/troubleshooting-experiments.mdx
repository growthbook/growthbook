...
description: "Fix common GrowthBook experiment issues: no traffic, missing results, sample ratio mismatch warnings, and SDK tracking problems."
sidebarTitle: Troubleshooting Experiments
...
![No Data Banner](/static/images/no-data-banner.png)
...
![SRM Warning](/static/images/srm.png)
...
![Reasonable Metric Averages](/static/images/reasonable-metric-averages.png)
...
![No Metric Values](/static/images/no-metric-values.png)
...
![View Queries Button](/static/images/view-queries-button.png)
