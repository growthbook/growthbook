...
2. **OpenAPI regen** (`pnpm --filter back-end generate-openapi`) — still pending; the ~20 `bypassApprovalChecks` doc strings are unaffected (atom kept), but regen to be safe.
