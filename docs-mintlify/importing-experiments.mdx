...
If this is your first time importing any experiments, you need to [connect your data warehouse](/experimentation-analysis/connecting-to-your-data-warehouse) and set up your [experiment assignment queries](/experimentation-analysis/data-source-configuration#experiment-assignment-queries) which will tell GrowthBook where to find the experiment data.
