---
title: "Deploying GrowthBook with Kubernetes"
...
For a more realistic development setup, you can use [mkcert](https://github.com/FiloSottile/mkcert) to issue locally-trusted TLS certificates within Minikube. This allows you to work with HTTPS without browser warnings.
