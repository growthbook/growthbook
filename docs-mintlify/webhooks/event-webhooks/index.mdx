...
See the [full list of events](/webhooks/event-webhooks/events).
...
Follow our instructions on [setting up a Slack integration](https://docs.growthbook.io/integrations/slack) to create a Slack application and connect it to GrowthBook events.

## Discord notifications

Discord notifications work the same way as Slack notifications. The only difference is that you need to follow our instructions on [setting up a Discord integration](https://docs.growthbook.io/integrations/discord).
