...
<Frame>
![Finding SQL Warehouse Connection Details in Databricks](https://docs.growthbook.io/assets/images/databricks-connection-69462c611e78777eb1d86e4b9fa4a295.png)
</Frame>
...
Follow these instructions to [create a service principal and access token](https://docs.databricks.com/en/dev-tools/service-principals.html).

Alternatively, you can [create a personal access token](https://docs.databricks.com/en/dev-tools/auth.html#pat) for a Databricks workspace user.
