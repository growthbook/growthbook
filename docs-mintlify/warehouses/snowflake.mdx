...
Enterprise**Pipeline Mode** is available on Enterprise plans. Pipeline mode can reduce query costs if you grant the GrowthBook service account write permissions in your data warehouse.
