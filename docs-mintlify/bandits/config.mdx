...
sidebarTitle: "Configuring Bandits"
description: "Bandits are run similarly to Experiments in GrowthBook. Key differences include:"
---
...
<Frame>
![Configuring Bandit Hash Attributes and Number of Variations](https://docs.growthbook.io/assets/images/bandit-config-1-211b80b585025510add2b5c1d034ba7f.png)
</Frame>
...
Follow the instructions in the [Sticky Bucketing](/sticky-bucketing) guide to set up Sticky Bucketing in your SDK and enable it in GrowthBook.

<Frame>
![Configuring Bandit Decision Metric and Exploration Window](https://docs.growthbook.io/assets/images/bandit-config-2-72582412a1acbcb4de0210787061cdb2.png)
</Frame>
...
<Frame>
![Linking Bandit Changes](https://docs.growthbook.io/assets/images/bandit-config-3-aaf4925cf2306344d1aed8f97bc25f75.png)
</Frame>
