...
To start, go to [app.growthbook.io](https://app.growthbook.io) and register a new account. Then there are a couple steps required before you
...
trackingCallback in `src/index.js`, instead of doing a `console.log`, you could use [Mixpanel](https://docs.growthbook.io/guide/mixpanel), Rudderstack, Jitsu,
