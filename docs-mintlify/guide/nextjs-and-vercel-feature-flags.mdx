---
title: "Integrating GrowthBook with Next.js and Vercel Feature Flags"
...
- **Performance**: [Vercel Edge Config](https://vercel.com/docs/storage/edge-config)  is a global data store that provides near-instantaneous access to your data, making it perfect for handling feature flags.
...
3. Navigate to **Account Settings** → **Tokens** and create a Vercel API Token. Save the value to use in the next step.
...
<Frame>
![GrowthBook SDK Webhook](https://docs.growthbook.io/assets/images/vercel-edge-sdk-connection-a47457df75d078eff64978e286b5a266.webp)
</Frame>
...
Vercel limits the [size of your Edge Config store](https://vercel.com/docs/storage/edge-config/edge-config-limits#limits-by-plan) depending on your plan. You can either reduce the number of flags or upgrade your Vercel plan.
</Note>
...
```bash
bun add @growthbook/growthbook @vercel/flags @vercel/edge-config
```
...
<Frame>
![Feature flags configured in GrowthBook](https://docs.growthbook.io/assets/images/vercel-ff-features-b0e759812a8b62b1cd4f7742a8ee0707.webp)
</Frame>
...
<Frame>
![Vercel Toolbar](https://docs.growthbook.io/assets/images/vercel-toolbar-c05cbe827ae2b6d03e5186066514e2ab.webp)
</Frame>
### Enable the Toolbar
...
See [Vercel's docs](https://vercel.com/docs/workflow-collaboration/feature-flags/supporting-feature-flags#flags_secret-environment-variable) for more info.
