...
<Frame>
![Two variations of Camera World with different titles and images](https://docs.growthbook.io/assets/images/sanity-ab-1703df19dab72e3f34470ca8add3dcc1.png)
</Frame>
## Prerequisites
...
```bash
bun x create-next-app@latest my-sanity-growthbook-app --typescript --tailwind --eslint --app
```
...
<Frame>
![GrowthBook SDK Connection](https://docs.growthbook.io/assets/images/sanity-sdk-connection-e8ebcb1913af29778ab6182e37ac8da4.png)
</Frame>
1. In GrowthBook, go to **SDK Configuration** → **SDK Connections** and click **Add SDK Connection**.
...
<Frame>
![GrowthBook Feature Flag](https://docs.growthbook.io/assets/images/sanity-feature-flag-48f8baa9b80eacb5380a9bc9707ff070.png)
</Frame>
...
<Frame>
![GrowthBook Experiment](https://docs.growthbook.io/assets/images/sanity-experiment-fbafddb883bd7247f23a8eed81498923.png)
</Frame>
...
<Frame>
![Sanity Experiment Field](https://docs.growthbook.io/assets/images/sanity-add-experiment-field-30e48f809d3cf64adc7358732edb8ed1.png)
</Frame>
<Frame>
![Add flag to field](https://docs.growthbook.io/assets/images/sanity-add-flag-to-field-46c9a390e64d278fb58016ac655891bf.png)
</Frame>
<Frame>
![Sanity experiment](https://docs.growthbook.io/assets/images/sanity-experiment-set-eb79e9ea1502f2e8210de7605d2d0ee5.png)
</Frame>
...
Note the `TODO` comment. You'll need to replace the `console.log` with your own [event tracking](/experimentation-analysis/data-source-configuration). Popular event tracking tools include Google Analytics, Segment, and Jitsu.
...
<Frame>
![Sanity experiment: a](https://docs.growthbook.io/assets/images/sanity-a-77058c7a61d40fae3d3b82875ebd5611.png)
</Frame>
Sanity experiment: Control

<Frame>
![Sanity experiment: b](https://docs.growthbook.io/assets/images/sanity-b-86aa34ab50566720d702fdee42107f1f.png)
</Frame>
