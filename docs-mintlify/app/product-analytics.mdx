...
<Callout icon="rectangle-pro" color="#f7b119">
**Product Analytics Dashboards** is available on Pro and Enterprise plans. Pro organizations can create unlimited private dashboards, while Enterprise organizations gain access to the full suite of sharing and collaboration options.
</Callout>
...
<Steps>
    ...
    <Step>
        Click **Create Dashboard** to start building
    </Step>
    <Step>
        Give your dashboard a descriptive name and configure sharing settings
    </Step>
</Steps>
