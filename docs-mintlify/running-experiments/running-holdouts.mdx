...
Learn more about holdouts in our [Knowledge Base](https://docs.growthbook.io/kb/experiments/holdouts).
...
<Frame>
![Add Holdout](https://docs.growthbook.io/images/holdouts-add-modal.png)
</Frame>
...
<Frame>
![Add Holdout to an experiment](https://docs.growthbook.io/images/holdouts-experiment-with-holdout.png)
</Frame>
...
1. **Stop adding new experiments**: The holdout enters analysis mode where no new experiments or features can be added but users are still held out from previously added experiments and features.
...
- Continues to split traffic on features and experiments into your holdout and general population groups if the holdout was already applied.
