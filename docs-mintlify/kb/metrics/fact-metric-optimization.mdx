...
description: "Fact Tables can dramatically reduce the number of rows scanned by an experiment analysis in GrowthBook. This article explains how Fact Tables work and how they can optimize your queries."
---
...
[Fact Tables](/metrics/metrics) are one of the best tools for controlling query runtime and costs in GrowthBook for Enterprise customers.
...
<Frame>
![Analysis Without Fact Tables](https://docs.growthbook.io/assets/images/fact-metric-before-optimization-9633df23766061dd8164649e687cb72f.png)
</Frame>
...
<Frame>
![Analysis With Fact Tables](https://docs.growthbook.io/assets/images/fact-metric-after-optimization-839d9dfda0948cd43dac625cd39715e9.png)
</Frame>
...
Read more about [Fact Tables in our docs](/metrics/metrics).
