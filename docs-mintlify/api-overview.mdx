...
In **GrowthBook Cloud**, the SDK Connection Endpoints are served from our global CDN: `https://cdn.growthbook.io/api/features/...`. If you are self-hosting, you can use [your own CDN](https://docs.growthbook.io/self-host/cdn) or run the [GrowthBook Proxy server](https://docs.growthbook.io/self-host/proxy), which provides built-in caching and performance optimizations.
