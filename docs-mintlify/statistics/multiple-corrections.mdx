...
We can write both as follows, where VVV is the number of tests that are statistically significant but are false positives and RRR are the number of tests that are statistically significant.

$$\text{False Discovery Rate} = \text{FDR} = \mathbb{E}\left[\frac{V}{R}\right]$$

$$\text{Family-wise Error Rate} = \text{FWER} = \Pr(V \geq 1)$$
...
<Frame>
![Org-level Multiple Testing Correction Settings](https://docs.growthbook.io/assets/images/pvals-adjustment-org-0e9a0a4c811a0b241c7620bb1d2945bf.png)
</Frame>
...
<Frame>
![Demonstrating Correction in Results](https://docs.growthbook.io/assets/images/pvals-adjusted-0fc3fce513db25c20344d0547daae251.png)
</Frame>
