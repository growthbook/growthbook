...
<Frame>
![Select a Fact Table population and a binomial metric in the power calculator.](https://docs.growthbook.io/assets/images/power_1-995eb5b1583002431a4e6b418b384acc.png)
</Frame>
...
<Frame>
![Selecting expected effect sizes and reviewing the power query results.](https://docs.growthbook.io/assets/images/power_2-207bbb0bdf0872921ee0c0a5efa7697c.png)
</Frame>
...
<Frame>
![metric and users input](https://docs.growthbook.io/assets/images/power_3-0e3e04bb5092aca443356c9adca2c3a3.png)
</Frame>
...
For Bayesian power analysis, you specify the prior distribution of the treatment effect (see [here](/statistics/details#bayesian-engine)) for guidance regarding prior selection). We then estimate Bayesian power, which is the probability that the (1−α)(1 - \alpha)(1−α) credible interval does not contain 0.
...
1. the false positive rate as $\alpha$ (GrowthBook default is $0.05$).
2. the critical values $Z_{1-\alpha/2} = \Phi^{-1}(1-\alpha/2)$ and $Z_{1-\alpha} = \Phi^{-1}(1-\alpha)$, where $\Phi^{-1}$ is the inverse cumulative distribution function of the standard normal distribution.
...
Let HWHWHW be the interval halfwidth.
...
For Bayesian power analysis, we let users specify the prior distribution of the treatment effect (see [here](/statistics/details#bayesian-engine) for guidance regarding prior selection). We then estimate Bayesian power, which is the probability that the (1−α)(1 - \alpha)(1−α) credible interval does not contain 0.
