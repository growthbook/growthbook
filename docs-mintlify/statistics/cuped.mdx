---
title: "CUPED + post-stratification"
description: "Regression Adjustment (CUPED) + post-stratification"
---

Pro**CUPED** is available on Pro and Enterprise plans.

Enterprise**Post Stratification** is available on Enterprise plans.
...
<Frame>
![Variance Reduction by Correlation](https://docs.growthbook.io/assets/images/cuped-corr-e904a637de7e92a473fcc8248f0557fc.png)
</Frame>
...
<Frame>
![Organization-level CUPED Setting](https://docs.growthbook.io/assets/images/cuped-org-670b2566527a4ab6eb5643798789ceea.png)
</Frame>
...
<Frame>
![Metric-level CUPED Setting](https://docs.growthbook.io/assets/images/cuped-metric-c3b69b8f5dcaa978962f895ba7b159a6.png)
</Frame>
...
<Frame>
![Experiment Results with CUPED toggle](https://docs.growthbook.io/assets/images/cuped-results-ratio-b14d57fab1f8d3003733bdacd0ed72be.png)
</Frame>
...
<Frame>
![Experiment Results with CUPED toggle](https://docs.growthbook.io/assets/images/cuped-results-ratio-off-5d7836d94b928f99dc30dd7c28636c94.png)
</Frame>
...
Yˉadjusted=Yˉ−θ∗Xˉ\bar{Y}\_{adjusted} = \bar{Y} - \theta \* \bar{X}Yˉadjusted=Yˉ−θ∗Xˉ

where Yˉ\bar{Y}Yˉ is the post-exposure metric average, Xˉ\bar{X}Xˉ is the pre-exposure metric average, and $\theta$ is essentially a regression coefficient from a regression of the post-experiment data on the pre-experiment data (pooled across both the control and treatment variation of interest), θ=Cov(Y,X)/Var(X)\theta = \text{Cov}(Y, X) / \text{Var}(X)θ=Cov(Y,X)/Var(X). We describe CUPED for ratio metrics and how to estimate uncertainty [here](/statistics/cuped-technical).
