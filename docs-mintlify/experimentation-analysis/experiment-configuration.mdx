...
Before [analyzing results](/experimentation-analysis/experiment-results), you need to actually run the experiment. This can be done in several ways:
...
- [URL Redirects](/running-experiments/url-redirects)
- Our [Visual Editor](/visual-editor)
...
Navigate to the Feature of interest and click "View results" in the Experiment Rule of the Feature. Read more about running feature experiments [here](https://docs.growthbook.io/feature-flag-experiments).

**Importing an Experiment Analysis from your Data Source**

You can also import an analysis directly from your Data Source using your configured Experiment Assignment Source. We have dedicated docs for [importing existing experiments](/importing-experiments).
...
Read our dedicated guide on [making changes to running experiments](/running-experiments/making-changes).
