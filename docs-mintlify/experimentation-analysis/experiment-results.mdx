...
<Frame>
![Results Table](https://docs.growthbook.io/images/results-table.png)
</Frame>
...
<Frame>
![Results Table (Frequentist)](https://docs.growthbook.io/images/results-table-frequentist.png)
</Frame>
...
- **Overview** - Metric details and [time series](/experimentation-analysis/experiment-time-series) for the metric, a link to the metric page, a results table for that metric with analysis controls (baseline, variation filter, difference type), and a metric card showing key information.
...
- **Debug** - Debug information for power users to show the impact of: CUPED, Post-Stratification, Capping, and informative priors (Bayesian engine only).
  ...
  ![Metric Drilldown modal - Overview tab](https://docs.growthbook.io/images/experiment-results/metric-drilldown-overview.png)

  ![Metric Drilldown modal - Debug tab](https://docs.growthbook.io/images/experiment-results/metric-drilldown-debug.png)

For more information on how metric slices are defined, see [Metric Slices](/metrics/metrics#metric-slices), an Enterprise-only feature.

## Guardrails

Guardrail metrics are treated much like regular metrics, but they are placed in a separate part of the results view and are not part of any p-value corrections in the frequentist engine (in other words, even with p-value corrections applied, these results will be more sensitive to negative or positive trends). They also can be used differently from regular metrics in the [Experiment Decision Framework](/experimentation-analysis/decision-framework).
...
<Frame>
![SRM Warning](https://docs.growthbook.io/images/srm.png)
</Frame>
...
If you want to refresh your dimension slices or change your dimension definitions, you should do so via the Data Source page for the related data source. You can read more about that [here](/experimentation-analysis/dimensions#experiment-dimensions).
...
<Frame>
![Overflow menu with sharing options highlighted](https://docs.growthbook.io/images/reports-share-menu.webp)
</Frame>
...
<Frame>
![Share experiment modal](https://docs.growthbook.io/images/reports-share-modal.webp)
</Frame>
...
<Frame>
![Manage custom reports via the Results tab](https://docs.growthbook.io/images/reports-list.webp)
</Frame>
From here you can:
