...
<Info>
See [Choose Your Data Path](/experimentation-analysis/choose-your-data-path) for a side-by-side comparison with connecting your own warehouse.
</Info>
...
You can edit these or create your own. Read more about [metrics and fact tables](/metrics/metrics).
...
Read more about [metric types and configuration](/metrics/metrics).
...
For a detailed walkthrough, see our [guide to running Feature Flag Experiments](https://docs.growthbook.io/feature-flag-experiments).
...
The Managed Warehouse is only available on GrowthBook Cloud. Self-hosted instances should [connect their own data warehouse](/experimentation-analysis/connecting-to-your-data-warehouse).
