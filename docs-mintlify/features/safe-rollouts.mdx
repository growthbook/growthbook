...
<Frame>
![Add a safe rollout rule](https://docs.growthbook.io/assets/images/safe-rollout-new-rule-c9a570bf7a5b53c91639fdd4bd0fd265.webp)
</Frame>
...
<Frame>
![Safe rollout configuration](https://docs.growthbook.io/assets/images/safe-rollout-create-786fd09372b0f09cacbeb1eb8f32c4c6.webp)
</Frame>
...
<Frame>
![Safe rollout rollback now warning message](https://docs.growthbook.io/assets/images/safe-rollout-rollback-now-ee01024a07f4edcf06486bcc50dc4124.webp)
</Frame>
...
If you need a custom ramp shape, approval gates between steps, or a hard cutoff date, use a [Ramp Schedule](/features/ramp-schedules) instead — it's the same engine with full control over each step.
