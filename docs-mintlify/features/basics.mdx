...
<Frame>
![Create Feature modal in GrowthBook](https://docs.growthbook.io/assets/images/feature-create-feature-2-2e195a9e75096257598e113c3f1c1381.png)
</Frame>
<Note>
...
Enterprise**JSON Validation** is available on Enterprise plans.
...
Default values can be overridden by [**Rules**](/features/rules), which let you target specific users, roll out to a percentage of traffic, or run A/B experiments.
...
- **[Rules](/features/rules)** — Override default values by targeting specific users, rolling out to a percentage of traffic, or running A/B experiments. See [Choosing a Rule Type](/features/rules#choosing-a-rule-type) for help picking the right approach.
