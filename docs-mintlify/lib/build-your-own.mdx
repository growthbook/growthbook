...
There is a language-agnostic test suite stored as a JSON file ([cases.json](https://github.com/growthbook/growthbook/blob/main/packages/sdk-js/test/cases.json)) with more than 400 unit tests. This extensively tests all of the public methods mentioned above.
