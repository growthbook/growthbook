...
**Ruby SDK Resources** · `v1.3.0`

- [growthbook-ruby](https://github.com/growthbook/growthbook-ruby)
- [RubyGems](https://rubygems.org/gems/growthbook)
- [Rails example app](https://github.com/growthbook/examples/tree/main/acme_donuts_rails)
...
You can learn more about [SDK Connection Endpoint Encryption](/api-overview#encryption).
...
Sticky Bucketing≥ v1.3.0

SemVer Targeting≥ v1.2.2

Encrypted Features≥ v1.1.0
