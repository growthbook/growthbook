...
[growthbook-ruby](https://github.com/growthbook/growthbook-ruby)[RubyGems](https://rubygems.org/gems/growthbook)[Rails example app](https://github.com/growthbook/examples/tree/main/acme_donuts_rails)[Get help on Slack](https://join.slack.com/t/growthbookusers/shared_invite/zt-2xw8fu279-Y~hwnfCEf7WrEI9qScHURQ)
