...
**C# SDK Resources** · `v1.1.3`

- [growthbook-c-sharp](https://github.com/growthbook/growthbook-c-sharp)
- [NuGet](https://www.nuget.org/packages/growthbook-c-sharp)
- [C# example app](https://github.com/growthbook/examples/tree/main/csharp-example/GrowthBookCSharpExamples)
