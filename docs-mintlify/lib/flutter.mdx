...
[growthbook-flutter](https://github.com/growthbook/growthbook-flutter)[pub.dev](https://pub.dev/packages/growthbook_sdk_flutter)[Get help on Slack](https://join.slack.com/t/growthbookusers/shared_invite/zt-2xw8fu279-Y~hwnfCEf7WrEI9qScHURQ)
...
Sticky bucketing ensures users see the same experiment variant across sessions. Read more about [Sticky Bucketing Feature](/sticky-bucketing)
