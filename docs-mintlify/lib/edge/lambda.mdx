...
Lambda@Edge App & SDK Resources

v0.0.28

[edge-lambda](https://github.com/growthbook/growthbook-proxy/tree/main/packages/lib/edge-lambda)[npm](https://www.npmjs.com/package/@growthbook/edge-lambda)[Get help on Slack](https://join.slack.com/t/growthbookusers/shared_invite/zt-2xw8fu279-Y~hwnfCEf7WrEI9qScHURQ)
