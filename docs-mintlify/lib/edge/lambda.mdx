---
title: "Lambda@Edge Edge App & SDK beta"
description: "GrowthBook SDK for Lambda@Edge"
---

**Lambda@Edge App & SDK Resources** · `v0.0.28`

- [edge-lambda](https://github.com/growthbook/growthbook-proxy/tree/main/packages/lib/edge-lambda)
- [npm](https://www.npmjs.com/package/@growthbook/edge-lambda)
...
Case Insensitive Regex≥ v0.0.27

Case Insensitive Membership≥ v0.0.27

Saved Group References≥ v0.0.7

Encrypted Features≥ v0.0.6

Streaming≥ v0.0.6

v2 Hashing≥ v0.0.6

Visual Editor≥ v0.0.6

SemVer Targeting≥ v0.0.6

Visual Editor (JS)≥ v0.0.6

Visual Editor Drag & Drop≥ v0.0.6

Prerequisites≥ v0.0.6

URL Redirects≥ v0.0.6

Sticky Bucketing≥ v0.0.6
