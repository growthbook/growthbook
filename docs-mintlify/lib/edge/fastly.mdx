...
Fastly Compute App & SDK Resources

v0.2.8

[edge-fastly](https://github.com/growthbook/growthbook-proxy/tree/main/packages/lib/edge-fastly)[npm](https://www.npmjs.com/package/@growthbook/edge-fastly)[Example compute worker](https://github.com/growthbook/growthbook-proxy/tree/main/packages/lib/edge-fastly/example)[Get help on Slack](https://join.slack.com/t/growthbookusers/shared_invite/zt-2xw8fu279-Y~hwnfCEf7WrEI9qScHURQ)
