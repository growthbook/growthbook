...
**Fastly Compute App & SDK Resources** · `v0.2.8`

- [edge-fastly](https://github.com/growthbook/growthbook-proxy/tree/main/packages/lib/edge-fastly)
- [npm](https://www.npmjs.com/package/@growthbook/edge-fastly)
- [Example compute worker](https://github.com/growthbook/growthbook-proxy/tree/main/packages/lib/edge-fastly/example)
...
Saved Group References≥ v0.1.6

Encrypted Features≥ v0.1.5

Streaming≥ v0.1.5

v2 Hashing≥ v0.1.5

Visual Editor≥ v0.1.5

SemVer Targeting≥ v0.1.5

Visual Editor (JS)≥ v0.1.5

Visual Editor Drag & Drop≥ v0.1.5

Prerequisites≥ v0.1.5

URL Redirects≥ v0.1.5

Sticky Bucketing≥ v0.1.5
