---
title: "GrowthBook Edge App for other providers beta"
description: "GrowthBook SDK for other edge providers"
---

**Edge Utils Resources** · `v0.2.8`

- [edge-utils](https://github.com/growthbook/growthbook-proxy/tree/main/packages/lib/edge-utils)
- [npm](https://www.npmjs.com/package/@growthbook/edge-utils)
...
```bash Yarn
yarn add @growthbook/edge-utils
```

```bash pnpm
pnpm add @growthbook/edge-utils
```

```bash Bun
bun add @growthbook/edge-utils
```
...
1. Create an [SDK Webhook](/webhooks/sdk-webhooks) on the same SDK Connection that you are using for edge integration.
...
Visual Editor≥ v0.1.4

SemVer Targeting≥ v0.1.4

Visual Editor (JS)≥ v0.1.4

Visual Editor Drag & Drop≥ v0.1.4

Prerequisites≥ v0.1.4

URL Redirects≥ v0.1.4

Sticky Bucketing≥ v0.1.4
