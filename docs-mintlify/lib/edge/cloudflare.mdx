...
Cloudflare Workers App & SDK Resources

v0.2.8

[edge-cloudflare](https://github.com/growthbook/growthbook-proxy/tree/main/packages/lib/edge-cloudflare)[npm](https://www.npmjs.com/package/@growthbook/edge-cloudflare)[Example worker](https://github.com/growthbook/growthbook-proxy/tree/main/packages/lib/edge-cloudflare/example)[Get help on Slack](https://join.slack.com/t/growthbookusers/shared_invite/zt-2xw8fu279-Y~hwnfCEf7WrEI9qScHURQ)
