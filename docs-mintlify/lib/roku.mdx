...
[growthbook-roku](https://github.com/growthbook/growthbook-roku)[Roku examples](https://github.com/growthbook/growthbook-roku/tree/main/examples)[npm package](https://www.npmjs.com/package/growthbook-roku)[Get help on Slack](https://join.slack.com/t/growthbookusers/shared_invite/zt-2xw8fu279-Y~hwnfCEf7WrEI9qScHURQ)
...
- **Runtime Memory:** Less than 500 KB total footprint
- **Feature Evaluation:** Less than 1ms per check
