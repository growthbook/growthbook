...
**Go SDK Resources** · `v0.2.6`

- [growthbook-golang](https://github.com/growthbook/growthbook-golang)
- [Go Modules](https://pkg.go.dev/github.com/growthbook/growthbook-golang)
- [Go example app](https://github.com/growthbook/examples/tree/main/go-example)
...
A full list of experiment fields can be found in the [documentation](https://pkg.go.dev/github.com/growthbook/growthbook-golang#Experiment) .
