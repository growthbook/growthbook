...
**Next.js SDK Resources** · `v0.1.0`

- [adapter-growthbook](https://github.com/vercel/flags/tree/main/packages/adapter-growthbook)
- [npm](https://www.npmjs.com/package/@flags-sdk/growthbook)
- [Next.js Flags SDK example app](https://github.com/vercel/examples/tree/main/flags-sdk/growthbook)
