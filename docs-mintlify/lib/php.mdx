...
[growthbook-php](https://github.com/growthbook/growthbook-php)[Packagist (Composer)](https://packagist.org/packages/growthbook/growthbook)[Get help on Slack](https://join.slack.com/t/growthbookusers/shared_invite/zt-2xw8fu279-Y~hwnfCEf7WrEI9qScHURQ)
...
Saved Group References≥ v1.7.0

Prerequisites≥ v1.6.0

Sticky Bucketing≥ v1.6.0

SemVer Targeting≥ v1.5.0

v2 Hashing≥ v1.2.0

Encrypted Features≥ v1.2.0
