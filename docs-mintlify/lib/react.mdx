...
**React SDK Resources** · `v1.6.5`

- [sdk-react](https://github.com/growthbook/growthbook/tree/main/packages/sdk-react)
- [npm](https://www.npmjs.com/package/@growthbook/growthbook-react)
- [Next.js example app](https://github.com/growthbook/examples/tree/main/next-js)
- [Next.js pages example app](https://github.com/growthbook/examples/tree/main/next-js-pages)
- [Create React App guide](/guide/create-react-app-and-growthbook)
- [Get help on Slack](https://join.slack.com/t/growthbookusers/shared_invite/zt-2xw8fu279-Y~hwnfCEf7WrEI9qScHURQ)
...
Sticky bucketing ensures that users see the same experiment variant, even when user session, user login status, or experiment parameters change. See the [Sticky Bucketing docs](/sticky-bucketing) for more information. If your organization and experiment supports sticky bucketing, you must implement an instance of the `StickyBucketService` to use Sticky Bucketing. The JS SDK exports several implementations of this service for common use cases, or you may build your own:
...
The example below is using CryptoJS ([crypto-js](https://www.npmjs.com/package/crypto-js)), which provides a synchronous API.
...
See the [GrowthBook CLI](/tools/cli) documentation for more information on generating type definitions and [JavaScript → TypeScript → Strict Typing](/lib/js#strict-typing) for how to use them.
...
Case Insensitive Membership≥ v1.6.4

Case Insensitive Regex≥ v1.6.3

Saved Group References≥ v1.1.0

URL Redirects≥ v0.26.0

Prerequisites≥ v0.24.0

Sticky Bucketing≥ v0.22.0

Visual Editor Drag & Drop≥ v0.20.0

Remote Evaluation≥ v0.19.0

SemVer Targeting≥ v0.17.0

Visual Editor (JS)≥ v0.17.0

Visual Editor≥ v0.14.0

v2 Hashing≥ v0.13.0

Streaming≥ v0.11.0

Encrypted Features≥ v0.10.1
