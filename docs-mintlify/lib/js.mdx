...
**JS SDK Resources** · `v1.6.5`

- [sdk-js](https://github.com/growthbook/growthbook/tree/main/packages/sdk-js)
- [npm](https://www.npmjs.com/package/@growthbook/growthbook)
- [Typescript example app](https://github.com/growthbook/examples/tree/main/vanilla-typescript)
...
URL Redirects≥ v0.36.0

Prerequisites≥ v0.34.0

Sticky Bucketing≥ v0.32.0

Visual Editor Drag & Drop≥ v0.30.0

Remote Evaluation≥ v0.29.0

SemVer Targeting≥ v0.27.0

Visual Editor (JS)≥ v0.27.0

Visual Editor≥ v0.24.0

v2 Hashing≥ v0.23.0

Streaming≥ v0.21.0

Encrypted Features≥ v0.20.0
