...
[growthbook-sdk-java](https://github.com/growthbook/growthbook-sdk-java)[JitPack](https://jitpack.io/#growthbook/growthbook-sdk-java)[JVM with Spring Web example app](https://github.com/growthbook/examples/tree/main/jvm-spring-web)[JVM with Kotlin Ktor example app](https://github.com/growthbook/examples/tree/main/jvm-kotlin-ktor-example)[Android example app](https://github.com/growthbook/examples/tree/main/android-example)[JavaDoc class docs](https://growthbook.github.io/growthbook-sdk-java/)[Get help on Slack](https://join.slack.com/t/growthbookusers/shared_invite/zt-2xw8fu279-Y~hwnfCEf7WrEI9qScHURQ)
