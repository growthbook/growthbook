...
**Java SDK Resources** · `v0.10.6`

- [growthbook-sdk-java](https://github.com/growthbook/growthbook-sdk-java)
- [JitPack](https://jitpack.io/#growthbook/growthbook-sdk-java)
- [JVM with Spring Web example app](https://github.com/growthbook/examples/tree/main/jvm-spring-web)
- [JVM with Kotlin Ktor example app](https://github.com/growthbook/examples/tree/main/jvm-kotlin-ktor-example)
- [Android example app](https://github.com/growthbook/examples/tree/main/android-example)
- [JavaDoc class docs](https://growthbook.github.io/growthbook-sdk-java/)
...
- You can read more [about features here](/features)
- You can see an [example features JSON here](/api-overview#sdk-connection-endpoints)
...
As of version 0.3.0, the Java SDK supports decrypting encrypted features. You can learn more about [SDK Connection Endpoint Encryption](/api-overview#encryption).
...
If you're using [GrowthBook Cloud](https://app.growthbook.io) , this is ready for you to use. If you are self-hosting, you will need to set up the [GrowthBook Proxy](/self-host/proxy) to enable it.
...
Case Insensitive Regex≥ v0.10.6
