...
[growthbook-python](https://github.com/growthbook/growthbook-python)[PyPi](https://pypi.org/project/growthbook/)[Get help on Slack](https://join.slack.com/t/growthbookusers/shared_invite/zt-2xw8fu279-Y~hwnfCEf7WrEI9qScHURQ)
...
Case Insensitive Membership≥ v2.1.1

Case Insensitive Regex≥ v2.1.0
