...
Growthbook will modify its default sql settings to work as seamlessly as possible with Fullstory. After choosing Fullstory as your data source and filling in the connection info, you can proceed with any modifications of your [configuration settings.](/experimentation-analysis/data-source-configuration)
