---
title: "Use GitHub to Version Control Metric Definitions"
...
For this guide, you can either use GrowthBook Cloud at [app.growthbook.io](https://app.growthbook.io) or your own self-hosted deployment.
