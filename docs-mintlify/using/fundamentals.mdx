...
sidebarTitle: "Fundamentals of AB testing"
...
|  |  |  |  |  |
| --- | --- | --- | --- | --- |
| **Hypothesis**  Come up with an idea you want to test | **Assignment**  Randomly split your audience into persistent groups | **Variations**  Create and show different experiences to each group | **Tracking**  Record events and behaviors of the two groups | **Results**  Use statistics to determine if the differences in behavior are significant |
