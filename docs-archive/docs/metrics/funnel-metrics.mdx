...
A funnel metric is a [Fact Table](/app/metrics) metric like any other. You define an ordered list of steps and GrowthBook turns each step into its own conversion rate.

:::note Two things named "funnel"
This page covers the **funnel metric type** built on Fact Tables. It is unrelated to the [legacy denominator behavior](/app/metrics/legacy#funnel-metrics), where a binomial denominator metric acted as a filter on the numerator. Those legacy metrics should be replaced by these funnel metrics, although there are some slight differences in behavior.
...
| ------------------------------------------ | --------- | --------- |
| Users assigned                             | 1,000     | 1,000     |
| Added to cart                              | 200 (20%) | 400 (40%) |
| Purchased                                  | 100       | 140       |
